...
내려받아 압축을 풀면 끝입니다. **.NET을 설치하지 않아도 됩니다** — 런타임이 실행 파일 안에
들어 있습니다.
...
> **릴리즈는 아직 하나도 없습니다.** 저장소가 비공개인 동안 Actions가 실행되지 않아 릴리즈
> 워크플로가 돌지 못합니다. 아래 「내려받기」는 릴리즈가 선 뒤의 절차이고, 그때까지는
> [소스에서 빌드하기](#소스에서-빌드하기)로 갑니다.
...
개발·테스트 절차는 [아키텍처와 개발](architecture.md#개발--테스트)에 있습니다.

## 다음

- [시트에 무엇을 적을 수 있나](concepts.md)
- [CLI](cli.md) — 실행하는 법과 명령줄 옵션
- [Recipe 파일](recipe.md) — 무엇을 어디서 읽어 어디로 내보낼지
