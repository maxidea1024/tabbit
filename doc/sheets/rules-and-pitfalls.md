...
|--|--|
|마커 열|보통의 데이터 행|
|**기본 인덱스 칸**|**오류** — 그 행을 가리킬 것이 없습니다. 예외는 멀티 로우 표이고, 거기서는 연장 행의 신호입니다|
...
**레이아웃 규칙과 실제 적용 기록은 [`sprout` 샘플](../../samples/sprout/readme.md)에 따로
있습니다.** 기존 시트를 가져올 일이 없다면 읽지 않아도 됩니다.
