...
public final class TemplateTable: Sequence {
    ...
    public func makeIterator() -> Array<TemplateRecord>.Iterator {
    ...
    public subscript(_ key: Int32) -> TemplateRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[TemplateRecord], (key: Int32, row: TemplateRecord)> {
