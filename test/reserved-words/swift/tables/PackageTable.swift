...
public final class PackageRecord {
    ...
    /// 예약어 라벨을 쓰는 enum 필드
    public var kind: Keyword = Keyword.of(0)
}

/// Every row of Package.
public final class PackageTable: Sequence {
    ...
    public func makeIterator() -> Array<PackageRecord>.Iterator {
    ...
    private var byIndex: [Int32: PackageRecord] = [:]

    /// The row with this Index, or nil when the table has none.
    ///
    /// The lookup to reach for when a missing row is an ordinary answer - an optional
    /// reference, a key that came from user input.
    public func findByIndex(_ key: Int32) -> PackageRecord? {
        byIndex[key]
    }
    ...
    public func getByIndexOrThrow(_ key: Int32) throws -> PackageRecord {
    ...
    public subscript(_ key: Int32) -> PackageRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[PackageRecord], (key: Int32, row: PackageRecord)> {
    ...
    public func read(
        ...
        var loaded = [PackageRecord]()
        loaded.reserveCapacity(count)

        for _ in 0 ..< count { loaded.append(PackageRecord()) }
        var loadedByIndex = [Int32: PackageRecord](
        ...
        for column in header.columns {
            ...
            case 3:
                ...
                while at < count {
                    ...
                    while n > 0 {
                        let i = at
                        loaded[i].kind = Keyword.of(cursor.runSameValue)
                        at += 1
                        n -= 1
                    }
                }
