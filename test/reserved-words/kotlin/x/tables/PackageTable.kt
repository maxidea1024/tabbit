...
class PackageRecord {
    ...
    var label: String = ""
    /** 예약어 라벨을 쓰는 enum 필드 */
    var kind: Keyword = Keyword.of(0)

}

/** Every row of Package. */
class PackageTable : Iterable<PackageRecord> {
     ...
     */
    override fun iterator(): Iterator<PackageRecord> = records.iterator()

    private var byIndex: HashMap<Int, PackageRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): PackageRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): PackageRecord =
     ...
     */
    operator fun get(key: Int): PackageRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, PackageRecord>>
    ...
    fun read(filename: String) {
        ...
        val loadedByIndex = HashMap<Int, PackageRecord>(count * 2)
