...
class TemplateTable : Iterable<TemplateRecord> {
     ...
     */
    override fun iterator(): Iterator<TemplateRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): TemplateRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, TemplateRecord>>
