...
final class PackageTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, PackageRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?PackageRecord
    {
    ...
    {
        throw new \LogicException('PackageTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PackageRecord>
     */
