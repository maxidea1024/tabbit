...
impl PackageTable {
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&PackageRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&PackageRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &PackageRecord)> + '_ {
            ...
            match column.tag {
                ...
                3 => {
                    ...
                    while at < records.len() {
                        let (n, value) = cursor.next_same_i32((records.len() - at) as i32)?;
                        for _ in 0..n {
                            records[at].kind = Keyword::from_value(value).unwrap_or_default();
                            at += 1;
                        }
                    }
                }
...
impl<'a> IntoIterator for &'a PackageTable {
    type Item = &'a PackageRecord;
    type IntoIter = std::slice::Iter<'a, PackageRecord>;
