...
namespace X
{
    ...
    public partial class PackageRecord
    {
        ...
        /// 예약어 라벨을 쓰는 enum 필드
        /// </summary>
        public global::X.Keyword Kind => _kind;
        #endregion

        #region Storage
        internal int _index;
        internal string _label = "";
        internal global::X.Keyword _kind;
        #endregion
    ...
    public partial class PackageTable : IEnumerable<PackageRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Label", "Kind" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Label, r.Kind });
        ...
        public Dictionary<int, PackageRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, PackageRecord> _recordsByIndex = new Dictionary<int, PackageRecord>();
        ...
        public PackageRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out PackageRecord record) ? record : null;
        ...
        {
            if (!_recordsByIndex.TryGetValue(key, out PackageRecord record))
                throw new TabbitException($"There is no record in table `Package` that corresponds to field `Index` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, PackageRecord Row) Current
        ...
        /// </remarks>
        public PackageRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Package.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Package.Label", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Package.Kind", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._kind = (global::X.Keyword)value;
                            } while (--n > 0);
                        }
                        break;
            ...
            var recordsByIndex = new Dictionary<int, PackageRecord>(count);
