...
public final class PackageTable implements Iterable<PackageRecord> {
     ...
     */
    @Override
    public Iterator<PackageRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, PackageRecord>> entries() {
        final List<PackageRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, PackageRecord>>() {
            private final Iterator<PackageRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, PackageRecord> next() {
                final PackageRecord row = source.next();
