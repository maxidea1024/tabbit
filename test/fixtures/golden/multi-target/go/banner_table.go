...
func (t *BannerTable) Read(filename string) error {
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "Banner.Index", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "Banner.Name", tabbit.KindScalar, false, tabbit.ElementString) {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "Banner.Note", tabbit.KindScalar, false, tabbit.ElementString) {
