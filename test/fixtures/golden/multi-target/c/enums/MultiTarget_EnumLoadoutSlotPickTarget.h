...
typedef enum MultiTarget_LoadoutSlotPickTarget_t {
  ...
  MULTI_TARGET_LOADOUT_SLOT_PICK_TARGET_NONE = 0,
  /* A row of `Weapon`. */
  MULTI_TARGET_LOADOUT_SLOT_PICK_TARGET_WEAPON = 1,
  /* A row of `Armour`. */
  MULTI_TARGET_LOADOUT_SLOT_PICK_TARGET_ARMOUR = 2,
} MultiTarget_LoadoutSlotPickTarget_t;

#endif /* MULTI_TARGET_ENUM_LOADOUT_SLOT_PICK_TARGET_H */
