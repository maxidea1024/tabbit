 ...
 */
typedef enum MultiTarget_FittingMainPickTarget_t {
  /* No row of any of them. */
  MULTI_TARGET_FITTING_MAIN_PICK_TARGET_NONE = 0,
  /* A row of `Weapon`. */
  MULTI_TARGET_FITTING_MAIN_PICK_TARGET_WEAPON = 1,
  /* A row of `Armour`. */
  MULTI_TARGET_FITTING_MAIN_PICK_TARGET_ARMOUR = 2,
} MultiTarget_FittingMainPickTarget_t;

#endif /* MULTI_TARGET_ENUM_FITTING_MAIN_PICK_TARGET_H */
