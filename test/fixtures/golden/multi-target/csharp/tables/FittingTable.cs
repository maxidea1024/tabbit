...
namespace Tabbit.Fixtures.MultiTarget
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class FittingTable
    {
        #region Record
        [System.Serializable]
        public partial class Record
        {
            ...
            public struct MainEntry
            {
                ...
                public FittingMainPickTarget Pick_target;
                /// an ordinary member beside it
                public int Count;
                /// <summary>
                /// <c>Pick</c> as a <c>WeaponTable.Record</c>, or null
                /// when it is a row of one of the others.
                /// </summary>
                public WeaponTable.Record WeaponByPick
                    => Pick_target == FittingMainPickTarget.Weapon
                        ? (WeaponTable.Record)Pick_row
                        : null;
                /// <summary>
                /// <c>Pick</c> as a <c>ArmourTable.Record</c>, or null
                /// when it is a row of one of the others.
                /// </summary>
                public ArmourTable.Record ArmourByPick
                    => Pick_target == FittingMainPickTarget.Armour
                        ? (ArmourTable.Record)Pick_row
                        : null;
        ...
        public Record GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out Record record))
                throw new TabbitException($"There is no record in table `Fitting` that corresponds to field `Index` value {key}");
