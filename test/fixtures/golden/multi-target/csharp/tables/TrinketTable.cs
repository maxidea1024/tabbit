...
namespace Tabbit.Fixtures.MultiTarget
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class TrinketTable
    {
        #region Record
        [System.Serializable]
        ...
        public Record GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out Record record))
                throw new TabbitException($"There is no record in table `Trinket` that corresponds to field `Index` value {key}");
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Trinket.Index", TcbTable.KindScalar, 1, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Trinket.Name", TcbTable.KindScalar, 1, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Trinket.Note", TcbTable.KindScalar, 1, false, TcbTable.ElementString);
