...
class BannerTable {
     ...
     */
    var records: MutableList<BannerRecord> = ArrayList()
        private set

    private var byIndex: HashMap<Int, BannerRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): BannerRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): BannerRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<BannerRecord>(count)
        val loadedByIndex = HashMap<Int, BannerRecord>(count * 2)

        repeat(count) { loaded.add(BannerRecord()) }
