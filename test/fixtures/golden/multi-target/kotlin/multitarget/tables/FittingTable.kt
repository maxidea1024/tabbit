...
class FittingTable {
     ...
     */
    var records: MutableList<FittingRecord> = ArrayList()
        private set

    private var byIndex: HashMap<Int, FittingRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): FittingRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): FittingRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<FittingRecord>(count)
        val loadedByIndex = HashMap<Int, FittingRecord>(count * 2)

        repeat(count) { loaded.add(FittingRecord()) }
