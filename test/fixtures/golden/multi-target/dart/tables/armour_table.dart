...
class ArmourTable {
  ...
  List<ArmourRecord> get records => _records;
  List<ArmourRecord> _records = [];

  Map<int, ArmourRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ArmourRecord? findByIndex(int key) => _byIndex[key];
  ...
  ArmourRecord getByIndexOrThrow(int key) {
  ...
  void read(String filename) {
    ...
    final loaded = <ArmourRecord>[];
    final loadedByIndex = <int, ArmourRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ArmourRecord());
    }
