...
class TrinketTable {
  ...
  List<TrinketRecord> get records => _records;
  List<TrinketRecord> _records = [];

  Map<int, TrinketRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  TrinketRecord? findByIndex(int key) => _byIndex[key];
  ...
  TrinketRecord getByIndexOrThrow(int key) {
  ...
  void read(String filename) {
    ...
    final loaded = <TrinketRecord>[];
    final loadedByIndex = <int, TrinketRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(TrinketRecord());
    }
