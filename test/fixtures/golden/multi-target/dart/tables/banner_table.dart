...
class BannerTable {
  ...
  List<BannerRecord> get records => _records;
  List<BannerRecord> _records = [];

  Map<int, BannerRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  BannerRecord? findByIndex(int key) => _byIndex[key];
  ...
  BannerRecord getByIndexOrThrow(int key) {
  ...
  void read(String filename) {
    ...
    final loaded = <BannerRecord>[];
    final loadedByIndex = <int, BannerRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(BannerRecord());
    }
