...
enum HolderWideTarget {
  ...
  const HolderWideTarget(this.value);
  ...
  static HolderWideTarget of(int value) {
    for (final candidate in HolderWideTarget.values) {
      if (candidate.value == value) return candidate;
    }

    return HolderWideTarget.none;
  }
}
