        ...
        for column in &header.columns {
            ...
            match column.tag {
                ...
                5 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Holder.Maybe")?;
                    let mut at = 0usize;
                    while at < records.len() {
                        let (n, value) = cursor.next_same_i32((records.len() - at) as i32)?;
                        for _ in 0..n {
                            records[at].maybe = value;
                            at += 1;
                        }
                    }
