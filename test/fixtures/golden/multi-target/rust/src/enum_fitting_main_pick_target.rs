...
#[repr(i32)]
pub enum FittingMainPickTarget {
...
impl FittingMainPickTarget {
    /// The label with this value, or None when the sheet declared no such label.
    pub fn from_value(value: i32) -> Option<Self> {
        match value {
            0 => Some(FittingMainPickTarget::None),
            1 => Some(FittingMainPickTarget::Weapon),
            2 => Some(FittingMainPickTarget::Armour),
            _ => None,
        }
    }
