...
#[derive(Clone, Debug, Default)]
pub struct FittingRecord {
    /// primary index
    pub index: i32,
    /// the member, in a record of one
    pub main: FittingMainEntry,
...
pub struct FittingTable {
    records: Vec<FittingRecord>,
    by_index: HashMap<i32, usize>,
}

impl FittingTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[FittingRecord] {
        &self.records
    }
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&FittingRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&FittingRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![FittingRecord::default(); count];
