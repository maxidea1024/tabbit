...
#[derive(Clone, Debug, Default)]
pub struct TrinketTable {
    records: Vec<TrinketRecord>,
    by_index: HashMap<i32, usize>,
}

impl TrinketTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[TrinketRecord] {
        &self.records
    }
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&TrinketRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&TrinketRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![TrinketRecord::default(); count];
