...
impl MountTable {
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&MountRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&MountRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![MountRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                ...
                2 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Mount.Name")?;
                    let mut at = 0usize;
                    while at < records.len() {
                ...
                3 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Mount.Note")?;
                    let mut at = 0usize;
                    while at < records.len() {
                        let (n, value) = cursor.next_same_string((records.len() - at) as i32)?;
                        for _ in 0..n {
