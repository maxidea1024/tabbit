...
impl WeaponTable {
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&WeaponRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&WeaponRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![WeaponRecord::default(); count];
