...
pub struct RackTable {
    records: Vec<RackRecord>,
    by_index: HashMap<i32, usize>,
}

impl RackTable {
    /// Every row, in the order the sheet declared them.
    pub fn records(&self) -> &[RackRecord] {
        &self.records
    }
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&RackRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&RackRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![RackRecord::default(); count];
