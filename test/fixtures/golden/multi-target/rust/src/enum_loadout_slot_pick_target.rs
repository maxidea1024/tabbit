...
#[repr(i32)]
pub enum LoadoutSlotPickTarget {
...
impl LoadoutSlotPickTarget {
    /// The label with this value, or None when the sheet declared no such label.
    pub fn from_value(value: i32) -> Option<Self> {
        match value {
            0 => Some(LoadoutSlotPickTarget::None),
            1 => Some(LoadoutSlotPickTarget::Weapon),
            2 => Some(LoadoutSlotPickTarget::Armour),
            _ => None,
        }
    }
