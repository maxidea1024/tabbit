...
class WeaponRecord:
    ...
    def __repr__(self):
        return "WeaponRecord(index=%r, name=%r, note=%r)" % (self.index, self.name, self.note)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Weapon.Name")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Weapon.Note")
                at = 0
                while at < count:
                    n, value = cursor.next_same_string(count - at)
                    for i in range(at, at + n):
