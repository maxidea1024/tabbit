...
class FittingRecord:
    ...
    def __init__(self):
        self.index = 0
        self.main = FittingMainEntry()
        self.pad = 0
        self.pad2 = 0

    def __repr__(self):
        return "FittingRecord(index=%r, main=%r, pad=%r, pad2=%r)" % (self.index, self.main, self.pad, self.pad2)
...
class FittingTable:
    ...
    def read(self, filename):
        ...
        records = [FittingRecord() for _ in range(count)]
