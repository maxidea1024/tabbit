...
export class WeaponTable {
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Weapon.Index', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Weapon.Name', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_STRING])
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Weapon.Note', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_STRING])
