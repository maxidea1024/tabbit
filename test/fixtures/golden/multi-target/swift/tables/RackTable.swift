...
public final class RackTable {
    ...
    public private(set) var records: [RackRecord] = []

    private var byIndex: [Int32: RackRecord] = [:]

    /// The row with this Index, or nil when the table has none.
    ///
    /// The lookup to reach for when a missing row is an ordinary answer - an optional
    /// reference, a key that came from user input.
    public func findByIndex(_ key: Int32) -> RackRecord? {
        byIndex[key]
    }
    ...
    public func getByIndexOrThrow(_ key: Int32) throws -> RackRecord {
    ...
    public func read(
        ...
        var loaded = [RackRecord]()
        loaded.reserveCapacity(count)

        for _ in 0 ..< count { loaded.append(RackRecord()) }
        var loadedByIndex = [Int32: RackRecord](
