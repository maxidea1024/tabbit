...
public enum HolderMaybeTarget: Int32, CaseIterable, Sendable {
    ...
    public static func of(_ value: Int32) -> HolderMaybeTarget {
        HolderMaybeTarget(rawValue: value) ?? HolderMaybeTarget.none
    }
