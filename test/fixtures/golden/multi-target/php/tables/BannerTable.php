...
{
    /** @var list<BannerRecord> */
    public array $records = [];

    /** @var array<int, BannerRecord> */
     ...
     */
    public function findByIndex(int $key): ?BannerRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): BannerRecord
    {
