...
/** Every row of Weapon. */
final class WeaponTable
{
    /** @var list<WeaponRecord> */
    public array $records = [];

    /** @var array<int, WeaponRecord> */
     ...
     */
    public function findByIndex(int $key): ?WeaponRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): WeaponRecord
    {
