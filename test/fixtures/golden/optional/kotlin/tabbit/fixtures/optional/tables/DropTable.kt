...
/** Every row of Drop. */
class DropTable : Iterable<DropRecord> {
     ...
     */
    override fun iterator(): Iterator<DropRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): DropRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, DropRecord>>
