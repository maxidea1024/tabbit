...
namespace Tabbit.Fixtures.Text
{
    ...
    public partial class ItemRecord
    {
        ...
        /// <summary>
        /// gathers under this table's name
        /// </summary>
        public string Name => _name;

        /// <summary>
        /// shared with the other table
        /// </summary>
        public string Category => _category;

        /// <summary>
        /// group named in detail-type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Flavour\":"); ToStringHelper.ToString(Flavour, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    /// <summary>
    /// A second table gathering into the same shared group.
    /// </summary>
    [System.Serializable]
    public partial class ItemTable : IEnumerable<ItemRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Category", "Flavour" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Category, r.Flavour });
        ...
        {
            var bytes = await TextAccessor.ReadAllBytesAsync(filename);

            // Unconditionally, and with whatever `TextAccessor.EncryptionKey` and `TextAccessor.MacKey`
