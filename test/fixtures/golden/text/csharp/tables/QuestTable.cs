...
namespace Tabbit.Fixtures.Text
{
    ...
    public partial class QuestTable : IEnumerable<QuestRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Title", "Category", "ScriptId", "Hint", "Lines" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Title, r.Category, r.ScriptId, r.Hint, r.Lines });
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            records[i]._hintHasValue = TcbTable.IsPresent(presence, i);
                    ...
                    case 6:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._lines = new string[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._lines[j] = cursor.NextString();
                            }
                        }
                        break;
