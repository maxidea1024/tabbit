...
export class BoonRecord {
  ...
  public _name: string = ''
  public _effect: EffectEntry = { type: 0, chance: 0, damage: 0, pierces: false, amount: 0, elementByElementId: undefined, elementId: 0, band: 0 as Band }

  /** Populate field values. */
  public populateFieldValues(dataRow: IDataRow): void {
    this._index = dataRow.index
    this._name = dataRow.name
    this._effect = ((e: any) => ({ type: e.type, chance: e.chance, damage: e.damage, pierces: e.pierces, amount: e.amount, elementByElementId: undefined, elementId: e.elementId, band: e.band }))(dataRow.effect)
  }
  ...
  public populateFieldValuesCompact(dataRow: any[]): void {
    ...
    this._effect = { type: dataRow[offset++], chance: dataRow[offset++], damage: dataRow[offset++], pierces: dataRow[offset++], amount: dataRow[offset++], elementByElementId: undefined, elementId: dataRow[offset++], band: dataRow[offset++] }
  }
}

// Generated from test/fixtures/xlsx/polymorphism/polymorphism.xlsx : PolymorphicSubset : B2
/** Blessings whose effect is one of several shapes, written without the columns no row uses. */
export class BoonTable {
  /** Default constructor. */
  constructor() {
  }

  /** All records. */
  public get records(): BoonRecord[] { return this._records }
  private _records: BoonRecord[] = []
   ...
   */
  public [Symbol.iterator](): IterableIterator<BoonRecord> {
    return this._records[Symbol.iterator]()
  }

  // Indexing by 'index'
  public get recordsByIndex(): Map<number, BoonRecord> { return this._recordsByIndex }
  private _recordsByIndex: Map<number, BoonRecord> = new Map<number, BoonRecord>()
   ...
   */
  public findByIndex(key: number): BoonRecord | undefined {
   ...
   */
  public getByIndexOrThrow(key: number): BoonRecord {
    const found = this._recordsByIndex.get(key)
    if (!found)
      throw new Error(`There is no record in table "Boon" that corresponds to field "index" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, BoonRecord]> {
  ...
  public readJsonFrom(json: string): void {
    ...
    const records: BoonRecord[] = []

    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new BoonRecord()
  ...
  public readBinaryFrom(fileBytes: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Boon.Index', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Index')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Boon.Name', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Name')
          for (let i = 0; i < rowCount; ) {
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Boon.Effect.Type', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Type')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 4:
          tabbit.checkColumn(column, 'Boon.Effect.Chance', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Chance')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'Boon.Effect.Damage', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Damage')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 6:
          tabbit.checkColumn(column, 'Boon.Effect.Pierces', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_BOOL])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Pierces')
          for (let i = 0; i < rowCount; ++i) {
          ...
          break
        case 7:
          tabbit.checkColumn(column, 'Boon.Effect.Amount', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Amount')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 8:
          tabbit.checkColumn(column, 'Boon.Effect.ElementId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.ElementId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 9:
          tabbit.checkColumn(column, 'Boon.Effect.Band', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Boon.Effect.Band')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
   ...
   */
  private publish(records: BoonRecord[]): void {
    const recordsByIndex = new Map<number, BoonRecord>()
