...
class BoonRecord {
  ...
  String name = '';
  /// which shape this row's effect is
  BoonEffectEntry effect = BoonEffectEntry();
...
/// Every row of Boon.
class BoonTable extends Iterable<BoonRecord> {
  ...
  List<BoonRecord> get records => _records;
  List<BoonRecord> _records = [];
  ...
  @override
  Iterator<BoonRecord> get iterator => _records.iterator;

  Map<int, BoonRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  BoonRecord? findByIndex(int key) => _byIndex[key];
  ...
  BoonRecord getByIndexOrThrow(int key) {
  ...
  BoonRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, BoonRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <BoonRecord>[];
    final loadedByIndex = <int, BoonRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(BoonRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Boon.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Boon.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Name');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Boon.Effect.Type', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'Boon.Effect.Chance', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Chance');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'Boon.Effect.Damage', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Damage');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 6:
          checkColumn(column, 'Boon.Effect.Pierces', kindScalar, false, [elementBool]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Pierces');
          for (final record in loaded) {
            record.effect.pierces = cursor.nextBool();
          }
          break;
        case 7:
          checkColumn(column, 'Boon.Effect.Amount', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Amount');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 8:
          checkColumn(column, 'Boon.Effect.ElementId', kindScalar, false, [elementI32]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.ElementId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 9:
          checkColumn(column, 'Boon.Effect.Band', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Boon.Effect.Band');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
