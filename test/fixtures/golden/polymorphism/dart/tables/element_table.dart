...
class ElementTable extends Iterable<ElementRecord> {
  ...
  @override
  Iterator<ElementRecord> get iterator => _records.iterator;
  ...
  /// The row with this Code, or null when the table has none.
  ///
  /// `findByCode` under the spelling Dart uses for a keyed collection. It
  ...
  ElementRecord? operator [](int key) => findByCode(key);
  ...
  Iterable<MapEntry<int, ElementRecord>> get entries =>
      _records.map((record) => MapEntry(record.code, record));
