...
module GameData
  ...
  class CurseEffectEntry
    attr_accessor :type, :chance, :damage, :pierces, :element_id, :element_by_element_id, :band, :amount
  ...
  class CurseTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { CurseRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Name')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Type')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Chance')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Damage')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 6
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Pierces')
        ...
        when 7
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.ElementId')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 8
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Band')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 9
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Curse.Effect.Amount')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
