...
impl SkillTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, SkillRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &SkillRecord)> + '_ {
...
impl<'a> IntoIterator for &'a SkillTable {
    type Item = &'a SkillRecord;
    type IntoIter = std::slice::Iter<'a, SkillRecord>;
