...
final class CurseRecord
{
    ...
    public string $name = '';
    /** which shape this row's effect is */
    public CurseEffectEntry $effect;
    ...
    {
        $this->effect = new CurseEffectEntry();
    }
}

/** Every row of Curse. */
final class CurseTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<CurseRecord> */
     ...
     *
     * @return \Traversable<int, CurseRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?CurseRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): CurseRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?CurseRecord
    {
    ...
    {
        throw new \LogicException('CurseTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, CurseRecord>
     */
