...
/** Every row of Boon. */
class BoonTable : Iterable<BoonRecord> {
     ...
     */
    var records: MutableList<BoonRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<BoonRecord> = records.iterator()

    private var byIndex: HashMap<Int, BoonRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): BoonRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): BoonRecord =
     ...
     */
    operator fun get(key: Int): BoonRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, BoonRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<BoonRecord>(count)
        val loadedByIndex = HashMap<Int, BoonRecord>(count * 2)

        repeat(count) { loaded.add(BoonRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Boon.Index", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Index")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Boon.Name", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Name")
                    var at = 0
                    while (at < count) {
                ...
                3 -> {
                    checkColumn(column, "Boon.Effect.Type", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Type")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "Boon.Effect.Chance", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Chance")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Boon.Effect.Damage", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Damage")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "Boon.Effect.Pierces", KIND_SCALAR, false, ELEMENT_BOOL)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Pierces")
                    for (record in loaded) {
                        record.effect.pierces = cursor.nextBool()
                    }
                }
                7 -> {
                    checkColumn(column, "Boon.Effect.Amount", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Amount")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                8 -> {
                    checkColumn(column, "Boon.Effect.ElementId", KIND_SCALAR, false, ELEMENT_I32)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.ElementId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                9 -> {
                    checkColumn(column, "Boon.Effect.Band", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Boon.Effect.Band")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
