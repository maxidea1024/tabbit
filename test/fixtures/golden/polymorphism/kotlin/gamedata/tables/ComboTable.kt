...
/** Every row of Combo. */
class ComboTable : Iterable<ComboRecord> {
     ...
     */
    override fun iterator(): Iterator<ComboRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): ComboRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, ComboRecord>>
