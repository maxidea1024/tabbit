...
func (t *ComboTable) All() iter.Seq[*ComboRecord] {
	records := t.records

	return func(yield func(*ComboRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *ComboTable) Entries() iter.Seq2[int32, *ComboRecord] {
	records := t.records

	return func(yield func(int32, *ComboRecord) bool) {
		for i := range records {
