...
using Tabbit.Binary;
[System.Serializable]
public partial class CurseRecord
{
    #region Values
    /// <summary>
    /// primary index
...
/// </summary>
[System.Serializable]
public partial class CurseTable : IEnumerable<CurseRecord>
{
    /// <summary>
    /// Field names.
    /// </summary>
    ...
    /// </remarks>
    public List<CurseRecord> Records => _records;
    private List<CurseRecord> _records = new List<CurseRecord>();
    ...
    /// </remarks>
    public List<CurseRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

    IEnumerator<CurseRecord> IEnumerable<CurseRecord>.GetEnumerator() => _records.GetEnumerator();

    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
        => _records.GetEnumerator();

    #region Indexing by 'Index'
    public Dictionary<int, CurseRecord> RecordsByIndex => _recordsByIndex;
    private Dictionary<int, CurseRecord> _recordsByIndex = new Dictionary<int, CurseRecord>();
    ...
    /// </remarks>
    public CurseRecord FindByIndex(int key)
        => _recordsByIndex.TryGetValue(key, out CurseRecord record) ? record : null;
    ...
    /// </remarks>
    public CurseRecord GetByIndexOrThrow(int key)
    {
        if (!_recordsByIndex.TryGetValue(key, out CurseRecord record))
            throw new TabbitException($"There is no record in table `Curse` that corresponds to field `Index` value {key}");
    ...
    {
        private readonly List<CurseRecord> _rows;
        private int _at;

        internal EntryEnumerator(List<CurseRecord> rows)
        {
            _rows = rows;
            _at = -1;
        }
        ...
        public (int Key, CurseRecord Row) Current
    ...
    /// </remarks>
    public CurseRecord this[int key] => GetByIndexOrThrow(key);
    ...
    public Task ReadAsync(TcbReader reader)
    {
        ...
        var records = new List<CurseRecord>(count);

        for (int i = 0; i < count; i++)
            records.Add(new CurseRecord());
        ...
        foreach (var column in columns)
        {
            ...
            {
                case 1:
                    TcbTable.CheckColumn(column, "Curse.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Index");
                    for (int i = 0; i < count; )
                    {
                ...
                case 2:
                    TcbTable.CheckColumn(column, "Curse.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Name");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 3:
                    TcbTable.CheckColumn(column, "Curse.Effect.Type", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Type");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 4:
                    TcbTable.CheckColumn(column, "Curse.Effect.Chance", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Chance");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 5:
                    TcbTable.CheckColumn(column, "Curse.Effect.Damage", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Damage");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 6:
                    TcbTable.CheckColumn(column, "Curse.Effect.Pierces", TcbTable.KindScalar, false, TcbTable.ElementBool);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Pierces");
                    for (int i = 0; i < count; i++)
                    {
                        var record = records[i];
                ...
                case 7:
                    TcbTable.CheckColumn(column, "Curse.Effect.ElementId", TcbTable.KindScalar, false, TcbTable.ElementI32);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.ElementId");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 8:
                    TcbTable.CheckColumn(column, "Curse.Effect.Band", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Band");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
                ...
                case 9:
                    TcbTable.CheckColumn(column, "Curse.Effect.Amount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    cursor = new TcbColumnCursor(reader, column, count, "Curse.Effect.Amount");
                    for (int i = 0; i < count; )
                    {
                        // One call per run of equal values, not one per row - over a
                        // run-length encoded column this is most of the decode.
        ...
        var recordsByIndex = new Dictionary<int, CurseRecord>(count);
