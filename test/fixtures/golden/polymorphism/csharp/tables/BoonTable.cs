...
using Tabbit.Binary;
[System.Serializable]
public partial class BoonRecord
{
    #region Values
    /// <summary>
    /// primary index
...
/// </summary>
[System.Serializable]
public partial class BoonTable : IEnumerable<BoonRecord>
{
    /// <summary>
    /// Field names.
    /// </summary>
    ...
    /// </remarks>
    public List<BoonRecord> Records => _records;
    private List<BoonRecord> _records = new List<BoonRecord>();
    ...
    /// </remarks>
    public List<BoonRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

    IEnumerator<BoonRecord> IEnumerable<BoonRecord>.GetEnumerator() => _records.GetEnumerator();

    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
        => _records.GetEnumerator();

    #region Indexing by 'Index'
    public Dictionary<int, BoonRecord> RecordsByIndex => _recordsByIndex;
    private Dictionary<int, BoonRecord> _recordsByIndex = new Dictionary<int, BoonRecord>();
    ...
    /// </remarks>
    public BoonRecord FindByIndex(int key)
        => _recordsByIndex.TryGetValue(key, out BoonRecord record) ? record : null;
    ...
    /// </remarks>
    public BoonRecord GetByIndexOrThrow(int key)
    {
        if (!_recordsByIndex.TryGetValue(key, out BoonRecord record))
            throw new TabbitException($"There is no record in table `Boon` that corresponds to field `Index` value {key}");
    ...
    {
        private readonly List<BoonRecord> _rows;
        private int _at;

        internal EntryEnumerator(List<BoonRecord> rows)
        {
            _rows = rows;
            _at = -1;
        }
        ...
        public (int Key, BoonRecord Row) Current
    ...
    /// </remarks>
    public BoonRecord this[int key] => GetByIndexOrThrow(key);
    ...
    public Task ReadAsync(TcbReader reader)
    {
        ...
        var records = new List<BoonRecord>(count);

        for (int i = 0; i < count; i++)
            records.Add(new BoonRecord());
        ...
        foreach (var column in columns)
        {
            ...
            {
                case 1:
                    TcbTable.CheckColumn(column, "Boon.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 2:
                    TcbTable.CheckColumn(column, "Boon.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                ...
                case 3:
                    TcbTable.CheckColumn(column, "Boon.Effect.Type", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 4:
                    TcbTable.CheckColumn(column, "Boon.Effect.Chance", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 5:
                    TcbTable.CheckColumn(column, "Boon.Effect.Damage", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 6:
                    TcbTable.CheckColumn(column, "Boon.Effect.Pierces", TcbTable.KindScalar, false, TcbTable.ElementBool);
                ...
                case 7:
                    TcbTable.CheckColumn(column, "Boon.Effect.Amount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 8:
                    TcbTable.CheckColumn(column, "Boon.Effect.ElementId", TcbTable.KindScalar, false, TcbTable.ElementI32);
                ...
                case 9:
                    TcbTable.CheckColumn(column, "Boon.Effect.Band", TcbTable.KindScalar, false, TcbTable.ElementVarint);
        ...
        var recordsByIndex = new Dictionary<int, BoonRecord>(count);
