...
public partial class ElementTable : IEnumerable<ElementTable.Record>
{
    ...
    /// Field names.
    /// </summary>
    public static readonly string[] FieldNames = { "Code", "Name" };
    ...
    public List<object[]> BuildObjectValueMap()
    {
        ...
        foreach (var r in _records)
            result.Add(new object[] { r.Code, r.Name });
    ...
    public bool ContainsCode(int key) => _recordsByCode.ContainsKey(key);
    #endregion // Indexing by `Code`

    /// <summary>Each row with the `Code` it is keyed by.</summary>
    /// <remarks>
    ...
    /// `Code` here, something else in the next table.
    ///
    ...
    /// </summary>
    /// <remarks>
    /// `GetByCodeOrThrow` under the spelling the language uses for a
    ...
    /// `Code` is 0, not the first row - the rows in order are
    ...
    public Task ReadAsync(TcbReader reader)
    {
        ...
        foreach (var column in columns)
        {
            ...
            {
                case 1:
                    TcbTable.CheckColumn(column, "Element.Code", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                ...
                case 2:
                    TcbTable.CheckColumn(column, "Element.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
