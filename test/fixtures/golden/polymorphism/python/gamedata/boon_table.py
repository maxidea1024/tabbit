...
class BoonEffectEntry:
    ...
    __slots__ = ("type_", "chance", "damage", "pierces", "amount", "element_id", "element_by_element_id", "band")
    ...
    def __repr__(self):
        return "BoonEffectEntry(type_=%r, chance=%r, damage=%r, pierces=%r, amount=%r, element_id=%r, band=%r)" % (self.type_, self.chance, self.damage, self.pierces, self.amount, self.element_id, self.band)
...
class BoonRecord:
    ...
    def __repr__(self):
        return "BoonRecord(index=%r, name=%r, effect=%r)" % (self.index, self.name, self.effect)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Name")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Type")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Chance")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Damage")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Pierces")
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Amount")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.ElementId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Boon.Effect.Band")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
