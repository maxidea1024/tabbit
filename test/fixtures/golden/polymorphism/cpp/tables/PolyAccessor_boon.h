...
#ifndef TABBIT_GENERATED_POLYACCESSOR_BOON_H
#define TABBIT_GENERATED_POLYACCESSOR_BOON_H
...
struct BoonRecord_effect_entry {
...
struct BoonRecord {
  ...
  std::string name;
  /// which shape this row's effect is
  BoonRecord_effect_entry effect;
  ...
  static std::unique_ptr<Effect> effect_element(
      const BoonRecord_effect_entry& entry) {
    switch (entry.type) {
      case 1: {
...
class BoonTable {
 public:
  const std::vector<BoonRecord>& records() const { return records_; }
  ...
  typename std::vector<BoonRecord>::const_iterator begin() const {
    return records_.begin();
  }

  typename std::vector<BoonRecord>::const_iterator end() const {
    return records_.end();
  }
  ...
  const BoonRecord* find_by_index(std::int32_t key) const {
  ...
  const BoonRecord& get_by_index_or_throw(std::int32_t key) const {
    const BoonRecord* found = find_by_index(key);

    if (found == nullptr) {
      throw tabbit::RecordNotFound(
        std::string("there is no record in table `Boon` that corresponds to "
  ...
  void read(const std::string& filename) {
    ...
    for (const tabbit::Column& column : header.columns) {
      ...
      switch (column.tag) {
        case 1: {
          tabbit::check_column(column, "Boon.Index", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Index");
          std::int32_t value{};
        ...
        case 2: {
          tabbit::check_column(column, "Boon.Name", tabbit::kKindScalar, false, {tabbit::kElementString});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Name");
          std::string value{};
          for (std::size_t i = 0; i < row_count; ) {
        ...
        case 3: {
          tabbit::check_column(column, "Boon.Effect.Type", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Type");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 4: {
          tabbit::check_column(column, "Boon.Effect.Chance", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Chance");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 5: {
          tabbit::check_column(column, "Boon.Effect.Damage", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Damage");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 6: {
          tabbit::check_column(column, "Boon.Effect.Pierces", tabbit::kKindScalar, false, {tabbit::kElementBool});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Pierces");
        ...
        case 7: {
          tabbit::check_column(column, "Boon.Effect.Amount", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Amount");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 8: {
          tabbit::check_column(column, "Boon.Effect.ElementId", tabbit::kKindScalar, false, {tabbit::kElementI32});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.ElementId");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 9: {
          tabbit::check_column(column, "Boon.Effect.Band", tabbit::kKindScalar, false, {tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Boon.Effect.Band");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
 ...
 private:
  ...
  void publish(std::vector<BoonRecord>&& records) {
  ...
  std::vector<BoonRecord> records_;
  std::unordered_map<std::int32_t, std::size_t> by_index_;
};

#endif  // TABBIT_GENERATED_POLYACCESSOR_BOON_H
