...
#ifndef TABBIT_GENERATED_POLYACCESSOR_SKILL_H
#define TABBIT_GENERATED_POLYACCESSOR_SKILL_H
...
class SkillTable {
 public:
  ...
  const SkillRecord* find_by_index(std::int32_t key) const {
  ...
  const SkillRecord& get_by_index_or_throw(std::int32_t key) const {
    const SkillRecord* found = find_by_index(key);
  ...
  void read(const std::string& filename) {
    ...
    for (const tabbit::Column& column : header.columns) {
      ...
      switch (column.tag) {
        case 1: {
          tabbit::check_column(column, "Skill.Index", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Index");
          std::int32_t value{};
        ...
        case 2: {
          tabbit::check_column(column, "Skill.Name", tabbit::kKindScalar, false, {tabbit::kElementString});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Name");
          std::string value{};
          for (std::size_t i = 0; i < row_count; ) {
        ...
        case 3: {
          tabbit::check_column(column, "Skill.Effect.Type", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Effect.Type");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 4: {
          tabbit::check_column(column, "Skill.Effect.Chance", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Effect.Chance");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 5: {
          tabbit::check_column(column, "Skill.Effect.Damage", tabbit::kKindScalar, false, {tabbit::kElementI32, tabbit::kElementVarint});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Effect.Damage");
          std::int32_t value{};
          for (std::size_t i = 0; i < row_count; ) {
            std::int32_t n = cursor.next_same_i32(
                static_cast<std::int32_t>(row_count - i), value);
        ...
        case 6: {
          tabbit::check_column(column, "Skill.Effect.Pierces", tabbit::kKindScalar, false, {tabbit::kElementBool});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "Skill.Effect.Pierces");
...
#endif  // TABBIT_GENERATED_POLYACCESSOR_SKILL_H
