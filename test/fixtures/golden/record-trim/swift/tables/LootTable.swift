...
public final class LootTable: Sequence {
    ...
    /// once. RecordTrimAccessor passes its own. spec/targets/accessor-instances.md.
    public func read(
        _ filename: String,
        key: [UInt8]? = nil,
        macKey: [UInt8]? = nil,
        ...
        for column in header.columns {
            ...
            case 3:
                ...
                for record in loaded {
                    ...
                    record.slot = [LootRecord.SlotEntry](
                        repeating: LootRecord.SlotEntry(), count: elementCount)
