...
public final class RecordTrimAccessor {
    ...
    public func readAll(
        ...
        RecordTrimAccessor.solveCrossReferences(loot: loadedLootTable)
    ...
    private static func solveCrossReferences(loot: LootTable) {
