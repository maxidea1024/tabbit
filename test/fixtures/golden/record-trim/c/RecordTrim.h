...
#ifndef RECORD_TRIM_H
#define RECORD_TRIM_H
...
typedef struct RecordTrim_t {
  RecordTrim_LootTable_t loot;
} RecordTrim_t;

/* Reads every table from base_path, then links the references between them.
 *
 * Declare the struct zeroed - `RecordTrim_t data = {0};` - and this is safe to
