...
public final class LootTable implements Iterable<LootRecord> {
    ...
    public void read(Path filename) {
        ...
        TcbReader reader = new TcbReader(TcbReader.open(
            TcbReader.readAllBytes(filename), RecordTrimAccessor.encryptionKey,
            ...
            switch (column.tag) {
                ...
                case 3: {
                    ...
                    for (LootRecord record : loaded) {
                        ...
                        record.slot = new LootRecord.SlotEntry[elementCount];

                        for (int j = 0; j < elementCount; j++) {
                            record.slot[j] = new LootRecord.SlotEntry();
                ...
                case 6: {
                    ...
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                            loaded.get(i).pos.x = cursor.runSameValue;
                        }
                    }
                    break;
                }
                case 7: {
                    ...
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                            loaded.get(i).pos.y = cursor.runSameValue;
                        }
                    }
                    break;
                }
