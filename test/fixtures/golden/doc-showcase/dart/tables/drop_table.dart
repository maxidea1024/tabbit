    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          break;
        case 2:
          checkColumn(column, 'Drop.Grades', kindArray, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Drop.Grades');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.grades = List.generate(elementCount, (_) => Rarity.of(cursor.nextI32()));
          }
          break;
        case 3:
          checkColumn(column, 'Drop.Counts', kindArray, false, [elementI32, elementVarint], true);
          ...
          elementAt = 0;
          cursor = TcbColumnCursor(reader, column, count, 'Drop.Counts');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.counts = List.generate(elementCount, (_) => cursor.nextI32());
            record.hasCountsAt =
