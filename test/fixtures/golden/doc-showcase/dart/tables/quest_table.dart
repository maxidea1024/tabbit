...
class QuestTable extends Iterable<QuestRecord> {
  ...
  QuestRecord getByIndexOrThrow(int key) {
  ...
  QuestRecord? operator [](int key) => findByIndex(key);
  ...
  void read(String filename) {
    ...
    final loadedByIndex = <int, QuestRecord>{};
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Quest.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Quest.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Quest.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Quest.Name');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Quest.Reward.Id', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Quest.Reward.Id');
          for (final record in loaded) {
            ...
            record.reward =
                List.generate(elementCount, (_) => QuestRewardEntry());
          ...
          break;
        case 4:
          checkColumn(column, 'Quest.Reward.Count', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Quest.Reward.Count');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            if (record.reward.length != elementCount) {
              throw TcbException(
                  'Quest.reward: the file gives one member of this '
