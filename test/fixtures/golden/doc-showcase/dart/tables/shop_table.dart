...
class ShopTable extends Iterable<ShopRecord> {
  ...
  ShopRecord getByIndexOrThrow(int key) {
  ...
  ShopRecord? operator [](int key) => findByIndex(key);
  ...
  void read(String filename) {
    ...
    final loadedByIndex = <int, ShopRecord>{};
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Shop.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Shop.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.Name');
          for (var i = 0; i < count; ) {
