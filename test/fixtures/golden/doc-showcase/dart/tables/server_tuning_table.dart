...
class ServerTuningTable extends Iterable<ServerTuningRecord> {
  ...
  List<ServerTuningRecord> get records => _records;
  List<ServerTuningRecord> _records = [];
  ...
  @override
  Iterator<ServerTuningRecord> get iterator => _records.iterator;

  Map<int, ServerTuningRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ServerTuningRecord? findByIndex(int key) => _byIndex[key];
  ...
  ServerTuningRecord getByIndexOrThrow(int key) {
  ...
  ServerTuningRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, ServerTuningRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ServerTuningRecord>[];
    final loadedByIndex = <int, ServerTuningRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ServerTuningRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'ServerTuning.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ServerTuning.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'ServerTuning.Knob', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'ServerTuning.Knob');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'ServerTuning.Value', kindScalar, false, [elementF32]);
          cursor = TcbColumnCursor(reader, column, count, 'ServerTuning.Value');
