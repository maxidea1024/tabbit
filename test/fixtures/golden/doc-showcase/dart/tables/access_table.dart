...
/// Every row of Access.
class AccessTable extends Iterable<AccessRecord> {
  ...
  @override
  Iterator<AccessRecord> get iterator => _records.iterator;

  Map<int, AccessRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  AccessRecord? findByIndex(int key) => _byIndex[key];
  ...
  AccessRecord getByIndexOrThrow(int key) {
  ...
  AccessRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, AccessRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loadedByIndex = <int, AccessRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(AccessRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Access.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Access.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Access.Flags', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Access.Flags');
          for (final record in loaded) {
            record.flags = cursor.nextI64();
          }
          break;
        case 3:
          checkColumn(column, 'Access.Same', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Access.Same');
          for (final record in loaded) {
