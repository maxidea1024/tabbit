    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          ...
          break;
        case 2:
          checkColumn(column, 'Loot.Tags', kindArray, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Loot.Tags');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.tags = List.generate(elementCount, (_) => cursor.nextString());
          }
          break;
        case 3:
          checkColumn(column, 'Loot.Weight', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Loot.Weight');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.weight = List.generate(elementCount, (_) => cursor.nextI32());
          }
          break;
        default:
