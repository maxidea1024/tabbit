...
/// Every row of Marker.
class MarkerTable extends Iterable<MarkerRecord> {
  ...
  List<MarkerRecord> get records => _records;
  List<MarkerRecord> _records = [];
  ...
  @override
  Iterator<MarkerRecord> get iterator => _records.iterator;

  Map<int, MarkerRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  MarkerRecord? findByIndex(int key) => _byIndex[key];
  ...
  MarkerRecord getByIndexOrThrow(int key) {
  ...
  MarkerRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, MarkerRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <MarkerRecord>[];
    final loadedByIndex = <int, MarkerRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(MarkerRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Marker.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Marker.Pos.X', kindScalar, false, [elementF32]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Pos.X');
          for (final record in loaded) {
            record.pos.x = cursor.nextF32();
          }
          break;
        case 3:
          checkColumn(column, 'Marker.Pos.Y', kindScalar, false, [elementF32]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Pos.Y');
          for (final record in loaded) {
            record.pos.y = cursor.nextF32();
          }
          break;
        case 4:
          checkColumn(column, 'Marker.Pos.Z', kindScalar, false, [elementF32]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Pos.Z');
          for (final record in loaded) {
            record.pos.z = cursor.nextF32();
          }
          break;
        case 5:
          checkColumn(column, 'Marker.Cell.X', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Cell.X');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].cell.x = value;
            }
          }
          break;
        case 6:
          checkColumn(column, 'Marker.Cell.Y', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Cell.Y');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].cell.y = value;
            }
          }
          break;
        case 7:
          checkColumn(column, 'Marker.Tint.R', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Tint.R');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].tint.r = value;
            }
          }
          break;
        case 8:
          checkColumn(column, 'Marker.Tint.G', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Tint.G');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].tint.g = value;
            }
          }
          break;
        case 9:
          checkColumn(column, 'Marker.Tint.B', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Tint.B');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].tint.b = value;
            }
          }
          break;
        case 10:
          checkColumn(column, 'Marker.Tint.A', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Marker.Tint.A');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].tint.a = value;
            }
          }
          break;
        default:
