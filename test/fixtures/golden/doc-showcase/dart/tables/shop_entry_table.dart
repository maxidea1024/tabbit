...
class ShopEntryTable extends Iterable<ShopEntryRecord> {
  ...
  List<ShopEntryRecord> get records => _records;
  List<ShopEntryRecord> _records = [];
  ...
  @override
  Iterator<ShopEntryRecord> get iterator => _records.iterator;

  Map<int, ShopEntryRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ShopEntryRecord? findByIndex(int key) => _byIndex[key];
  ...
  ShopEntryRecord getByIndexOrThrow(int key) {
  ...
  ShopEntryRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, ShopEntryRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ShopEntryRecord>[];
    final loadedByIndex = <int, ShopEntryRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ShopEntryRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'ShopEntry.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopEntry.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'ShopEntry.ShopId', kindScalar, false, [elementI32]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopEntry.ShopId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'ShopEntry.PotionId', kindScalar, false, [elementI32]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopEntry.PotionId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].potionId = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'ShopEntry.Stock', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopEntry.Stock');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].stock = value;
            }
          }
          break;
        default:
