...
/// Every row of Wire.
class WireTable extends Iterable<WireRecord> {
  ...
  List<WireRecord> get records => _records;
  List<WireRecord> _records = [];
  ...
  @override
  Iterator<WireRecord> get iterator => _records.iterator;

  Map<int, WireRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  WireRecord? findByIndex(int key) => _byIndex[key];
  ...
  WireRecord getByIndexOrThrow(int key) {
  ...
  WireRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, WireRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <WireRecord>[];
    final loadedByIndex = <int, WireRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(WireRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Wire.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Wire.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Wire.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Wire.Name');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Wire.Price', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Wire.Price');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
