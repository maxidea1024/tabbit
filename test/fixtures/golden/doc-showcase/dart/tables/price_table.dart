...
class PriceTable extends Iterable<PriceRecord> {
  ...
  PriceRecord getByIndexOrThrow(int key) {
  ...
  PriceRecord? operator [](int key) => findByIndex(key);
  ...
  void read(String filename) {
    ...
    final loadedByIndex = <int, PriceRecord>{};
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Price.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Price.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Price.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Price.Name');
          for (var i = 0; i < count; ) {
