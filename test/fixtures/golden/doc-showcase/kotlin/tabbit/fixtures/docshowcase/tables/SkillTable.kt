...
class SkillTable : Iterable<SkillRecord> {
    ...
    private var byIndex: HashMap<Int, SkillRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): SkillRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): SkillRecord =
     ...
     */
    operator fun get(key: Int): SkillRecord? = findByIndex(key)
    ...
    fun read(filename: String) {
        ...
        val loadedByIndex = HashMap<Int, SkillRecord>(count * 2)
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Skill.Index", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Skill.Index")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Skill.Name", KIND_SCALAR, false, ELEMENT_STRING)
                ...
                3 -> {
                    checkColumn(column, "Skill.Effect.Type", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Skill.Effect.Type")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "Skill.Effect.Chance", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Skill.Effect.Chance")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Skill.Effect.Damage", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Skill.Effect.Damage")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
