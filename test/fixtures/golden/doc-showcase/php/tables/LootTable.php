        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                ...
                case 2:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Loot.Tags');
                    foreach ($records as $record) {
                        $elementCount = $cursor->nextLength();
                        $record->tags = [];
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->tags[] = $cursor->nextString();
                        }
                    }
                    break;
                ...
                case 3:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Loot.Weight');
                    foreach ($records as $record) {
                        $elementCount = $cursor->nextLength();
                        $record->weight = [];
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->weight[] = $cursor->nextI32();
                        }
                    }
                    break;
