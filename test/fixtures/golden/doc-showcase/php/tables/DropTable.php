                ...
                case 2:
                    ...
                    foreach ($records as $record) {
                        ...
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->grades[] = Rarity::tryFrom($cursor->nextI32()) ?? Rarity::None;
                        }
                    }
                    break;

                case 3:
                    TcbReader::checkColumn($column, 'Drop.Counts', TcbReader::KIND_ARRAY, false, [TcbReader::ELEMENT_I32, TcbReader::ELEMENT_VARINT], true);
