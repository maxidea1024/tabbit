...
final class ShopEntryTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ShopEntryRecord> */
     ...
     *
     * @return \Traversable<int, ShopEntryRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?ShopEntryRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): ShopEntryRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?ShopEntryRecord
    {
    ...
    {
        throw new \LogicException('ShopEntryTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ShopEntryRecord>
     */
