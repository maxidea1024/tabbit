...
/** Every row of Wire. */
final class WireTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<WireRecord> */
     ...
     *
     * @return \Traversable<int, WireRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?WireRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): WireRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?WireRecord
    {
    ...
    {
        throw new \LogicException('WireTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, WireRecord>
     */
