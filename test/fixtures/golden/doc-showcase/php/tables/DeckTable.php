...
final class DeckHomeEntry
{
    /** two levels in */
    public DeckHomeEntryAt $at;
...
/** Every row of Deck. */
final class DeckTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<DeckRecord> */
     ...
     *
     * @return \Traversable<int, DeckRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?DeckRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): DeckRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?DeckRecord
    {
    ...
    {
        throw new \LogicException('DeckTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, DeckRecord>
     */
