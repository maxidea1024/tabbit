...
final class QuestTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     */
    public function findByIndex(int $key): ?QuestRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): QuestRecord
    {
        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                ...
                case 2:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Quest.Name');
                    for ($i = 0; $i < $count; ) {
                ...
                case 3:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Quest.Reward.Id');
                    foreach ($records as $record) {
                        ...
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->reward[] = new QuestRewardEntry();
                        }
                        for ($j = 0; $j < $elementCount; $j++) {
                ...
                case 4:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Quest.Reward.Count');
                    foreach ($records as $record) {
                        $elementCount = $cursor->nextLength();
                        if (\count($record->reward) !== $elementCount) {
