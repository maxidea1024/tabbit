...
/** Every row of Access. */
final class AccessTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, AccessRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?AccessRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): AccessRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?AccessRecord
    {
    ...
    {
        throw new \LogicException('AccessTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, AccessRecord>
     */
