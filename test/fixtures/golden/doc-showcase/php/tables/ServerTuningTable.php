...
final class ServerTuningTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ServerTuningRecord> */
     ...
     *
     * @return \Traversable<int, ServerTuningRecord>
     */
    ...
    /** @var array<int, ServerTuningRecord> */
     ...
     */
    public function findByIndex(int $key): ?ServerTuningRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): ServerTuningRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?ServerTuningRecord
    {
    ...
    {
        throw new \LogicException('ServerTuningTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ServerTuningRecord>
     */
    ...
    public function read(string $filename): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            $records[] = new ServerTuningRecord();
        }
