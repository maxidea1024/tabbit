...
/** Every row of Spawn. */
final class SpawnTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<SpawnRecord> */
     ...
     *
     * @return \Traversable<int, SpawnRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?SpawnRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): SpawnRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?SpawnRecord
    {
    ...
    {
        throw new \LogicException('SpawnTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, SpawnRecord>
     */
            ...
            switch ($column['tag']) {
                ...
                case 4:
                    ...
                    foreach ($records as $row => $record) {
                        $record->hasRadius = TcbReader::isPresent($presence, $row);
