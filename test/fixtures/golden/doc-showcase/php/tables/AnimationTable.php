...
final class AnimationTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<AnimationRecord> */
     ...
     *
     * @return \Traversable<int, AnimationRecord>
     */
    ...
    /** @var array<string, AnimationRecord> */
    private array $byIndex = [];

    /** @var array<int, AnimationRecord> */
     ...
     */
    public function findByIndex(string $key): ?AnimationRecord
    {
     ...
     */
    public function getByIndexOrThrow(string $key): AnimationRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?AnimationRecord
    {
    ...
    {
        throw new \LogicException('AnimationTable is read-only.');
    }
     ...
     *
     * @return \Generator<string, AnimationRecord>
     */
     ...
     * reference, a key that came from user input.
     */
    public function findBySlot(int $key): ?AnimationRecord
    {
        return $this->bySlot[$key] ?? null;
    }
     ...
     * cannot otherwise tell whether the next line is a null check or a catch.
     */
    public function getBySlotOrThrow(int $key): AnimationRecord
    {
        $record = $this->bySlot[$key] ?? null;
    ...
    public function containsSlot(int $key): bool
    {
        return isset($this->bySlot[$key]);
    }
