...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class PotionTable : IEnumerable<PotionRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Rarity", "Price" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Rarity, r.Price });
        ...
        /// </remarks>
        public List<PotionRecord> Records => _records;
        private List<PotionRecord> _records = new List<PotionRecord>();
        ...
        /// </remarks>
        public List<PotionRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PotionRecord> IEnumerable<PotionRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, PotionRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, PotionRecord> _recordsByIndex = new Dictionary<int, PotionRecord>();
        ...
        /// </remarks>
        public PotionRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out PotionRecord record) ? record : null;
        ...
        /// </remarks>
        public PotionRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out PotionRecord record))
                throw new TabbitException($"There is no record in table `Potion` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<PotionRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PotionRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PotionRecord Row) Current
        ...
        /// </remarks>
        public PotionRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<PotionRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new PotionRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Potion.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Potion.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Potion.Rarity", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._rarity = (global::Tabbit.Fixtures.DocShowcase.Rarity)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Potion.Price", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsByIndex = new Dictionary<int, PotionRecord>(count);
