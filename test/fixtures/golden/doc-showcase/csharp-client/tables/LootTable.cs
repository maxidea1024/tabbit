...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    public partial class LootTable : IEnumerable<LootRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Tags", "Weight" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Tags, r.Weight });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Loot.Tags", TcbTable.KindArray, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Loot.Weight", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            int elementCount;
                            elementCount = cursor.NextLength();
                            record._weight = new int[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._weight[j] = cursor.NextI32();
                            }
                        }
                        break;
