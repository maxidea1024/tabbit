    ...
    def read(filename)
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Quest.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Quest.Name')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Quest.Reward.Id')
          records.each do |record|
            ...
            record.reward = Array.new(element_count) { QuestRewardEntry.new }
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Quest.Reward.Count')
          records.each do |record|
            element_count = cursor.next_length
            if record.reward.length != element_count
