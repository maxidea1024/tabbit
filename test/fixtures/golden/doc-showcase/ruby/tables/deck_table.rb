...
module DocShowcase
  ...
  class DeckTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { DeckRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Deck.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Deck.Slot.Id')
          records.each do |record|
            ...
            record.slot = Array.new(element_count) { DeckSlotEntry.new }
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Deck.Slot.Label')
          records.each do |record|
            element_count = cursor.next_length
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Deck.Home.At.X')
          records.each do |record|
            record.home.at.x = cursor.next_f32
          end
        when 5
          Tabbit.check_column(column, 'Deck.Home.At.Y', Tabbit::KIND_SCALAR, false, [Tabbit::ELEMENT_F32])
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Deck.Home.At.Y')
          records.each do |record|
