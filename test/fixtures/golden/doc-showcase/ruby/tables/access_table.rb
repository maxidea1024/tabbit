...
module DocShowcase
  ...
  class AccessTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { AccessRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Access.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Access.Flags')
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Access.Same')
          records.each do |record|
