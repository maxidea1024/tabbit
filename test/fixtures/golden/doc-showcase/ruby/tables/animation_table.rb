...
module DocShowcase
  ...
  class AnimationTable
    ...
    # glance cannot otherwise tell whether the next line is a check or a rescue.
    def get_by_slot_or_throw(key)
      record = @by_slot[key]

      if record.nil?
        raise Tabbit::RecordNotFoundError,
              "there is no record in table `Animation` that corresponds to " \
              "field `Slot` value #{key.inspect}"
      end
    ...
    def read(filename)
      ...
      records = Array.new(count) { AnimationRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Animation.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Animation.Slot')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Animation.Blend')
      ...
      by_slot = records.to_h { |record| [record.slot, record] }
