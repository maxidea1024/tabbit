...
module DocShowcase
  ...
  class ServerTuningTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { ServerTuningRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'ServerTuning.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'ServerTuning.Knob')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'ServerTuning.Value')
