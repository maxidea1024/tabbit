...
public final class ShopTable implements Iterable<ShopRecord> {
    ...
    private Map<Integer, ShopRecord> byIndex = new HashMap<>();
     ...
     */
    public ShopRecord findByIndex(int key) {
     ...
     */
    public ShopRecord getByIndexOrThrow(int key) {
        ShopRecord record = byIndex.get(key);
    ...
    public void read(Path filename) {
        ...
        Map<Integer, ShopRecord> loadedByIndex = new HashMap<>(count * 2);
        ...
        for (TcbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    TcbReader.checkColumn(column, "Shop.Index", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_I32, TcbReader.ELEMENT_VARINT);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Shop.Index");
                    for (int i = 0; i < count; ) {
                ...
                case 2: {
                    TcbReader.checkColumn(column, "Shop.Name", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_STRING);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Shop.Name");
                    for (int i = 0; i < count; ) {
