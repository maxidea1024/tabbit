...
impl ShopTable {
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&ShopRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&ShopRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    tabbit::check_column(column, "Shop.Index", tabbit::KIND_SCALAR, false, &[tabbit::ELEMENT_I32, tabbit::ELEMENT_VARINT])?;
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Shop.Index")?;
                    let mut at = 0usize;
                ...
                2 => {
                    tabbit::check_column(column, "Shop.Name", tabbit::KIND_SCALAR, false, &[tabbit::ELEMENT_STRING])?;
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Shop.Name")?;
                    let mut at = 0usize;
                    while at < records.len() {
