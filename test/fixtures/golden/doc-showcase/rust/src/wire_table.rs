...
impl WireTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, WireRecord> {
        self.records.iter()
    }
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&WireRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&WireRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &WireRecord)> + '_ {
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![WireRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Wire.Index")?;
                    let mut at = 0usize;
                ...
                2 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Wire.Name")?;
                    let mut at = 0usize;
                    while at < records.len() {
                ...
                4 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Wire.Price")?;
                    let mut at = 0usize;
                    while at < records.len() {
                        let (n, value) = cursor.next_same_i32((records.len() - at) as i32)?;
                        for _ in 0..n {
...
impl<'a> IntoIterator for &'a WireTable {
    type Item = &'a WireRecord;
    type IntoIter = std::slice::Iter<'a, WireRecord>;
