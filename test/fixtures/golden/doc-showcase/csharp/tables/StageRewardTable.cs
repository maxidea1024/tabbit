...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    public partial class StageRewardTable : IEnumerable<StageRewardRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Stage", "Rank", "Gold", "DropTable" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Stage, r.Rank, r.Gold, r.DropTable });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "StageReward.DropTable", TcbTable.KindScalar, false, TcbTable.ElementString);
