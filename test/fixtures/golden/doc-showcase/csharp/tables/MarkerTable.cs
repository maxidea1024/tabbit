...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class MarkerTable : IEnumerable<MarkerRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Pos", "Cell", "Tint" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Pos, r.Cell, r.Tint });
        ...
        /// </remarks>
        public List<MarkerRecord> Records => _records;
        private List<MarkerRecord> _records = new List<MarkerRecord>();
        ...
        /// </remarks>
        public List<MarkerRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<MarkerRecord> IEnumerable<MarkerRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, MarkerRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, MarkerRecord> _recordsByIndex = new Dictionary<int, MarkerRecord>();
        ...
        /// </remarks>
        public MarkerRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out MarkerRecord record) ? record : null;
        ...
        /// </remarks>
        public MarkerRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out MarkerRecord record))
                throw new TabbitException($"There is no record in table `Marker` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<MarkerRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<MarkerRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, MarkerRecord Row) Current
        ...
        /// </remarks>
        public MarkerRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<MarkerRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Marker.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Marker.Pos.X", TcbTable.KindScalar, false, TcbTable.ElementF32);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Marker.Pos.Y", TcbTable.KindScalar, false, TcbTable.ElementF32);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Marker.Pos.Z", TcbTable.KindScalar, false, TcbTable.ElementF32);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Marker.Cell.X", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Marker.Cell.Y", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "Marker.Tint.R", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 8:
                        TcbTable.CheckColumn(column, "Marker.Tint.G", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 9:
                        TcbTable.CheckColumn(column, "Marker.Tint.B", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 10:
                        TcbTable.CheckColumn(column, "Marker.Tint.A", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsByIndex = new Dictionary<int, MarkerRecord>(count);
