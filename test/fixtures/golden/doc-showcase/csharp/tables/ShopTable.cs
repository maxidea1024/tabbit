...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    public partial class ShopTable : IEnumerable<ShopRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name });
        ...
        public Dictionary<int, ShopRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, ShopRecord> _recordsByIndex = new Dictionary<int, ShopRecord>();
        ...
        public ShopRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out ShopRecord record) ? record : null;
        ...
        {
            if (!_recordsByIndex.TryGetValue(key, out ShopRecord record))
        ...
        /// </remarks>
        public ShopRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Shop.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Shop.Name");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<int, ShopRecord>(count);
