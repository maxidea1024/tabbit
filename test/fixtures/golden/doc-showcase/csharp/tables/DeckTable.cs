...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    public partial class DeckTable : IEnumerable<DeckRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Slot", "Home" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Slot, r.Home });
        ...
        public Dictionary<int, DeckRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, DeckRecord> _recordsByIndex = new Dictionary<int, DeckRecord>();
        ...
        public DeckRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out DeckRecord record) ? record : null;
        ...
        {
            if (!_recordsByIndex.TryGetValue(key, out DeckRecord record))
                throw new TabbitException($"There is no record in table `Deck` that corresponds to field `Index` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, DeckRecord Row) Current
        ...
        /// </remarks>
        public DeckRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Deck.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Deck.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Deck.Slot.Id", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Deck.Slot.Id");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            int elementCount;
                            elementCount = cursor.NextLength();
                            record._slot = DeckRecord.NewSlotEntryArray(elementCount);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Deck.Slot.Label", TcbTable.KindArray, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Deck.Slot.Label");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            int elementCount;
                            ...
                            if (record._slot.Length != elementCount)
                            {
                                throw new TcbException(
                                    "Deck.Slot: the file gives this row "
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Deck.Home.At.X", TcbTable.KindScalar, false, TcbTable.ElementF32);
                        cursor = new TcbColumnCursor(reader, column, count, "Deck.Home.At.X");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Deck.Home.At.Y", TcbTable.KindScalar, false, TcbTable.ElementF32);
                        cursor = new TcbColumnCursor(reader, column, count, "Deck.Home.At.Y");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsByIndex = new Dictionary<int, DeckRecord>(count);
