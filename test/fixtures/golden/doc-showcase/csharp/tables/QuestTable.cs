...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    public partial class QuestTable : IEnumerable<QuestRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Reward" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Reward });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Quest.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Quest.Reward.Id", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._reward = new QuestRecord.RewardEntry[elementCount];
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Quest.Reward.Count", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            if (record._reward.Length != elementCount)
                            {
                                throw new TcbException(
                                    "Quest.Reward: the file gives this row "
                                    + elementCount + " elements for one member of the record and "
                                    + record._reward.Length + " for another. Every member of a "
