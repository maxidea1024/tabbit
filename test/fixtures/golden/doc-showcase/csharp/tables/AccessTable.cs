...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class AccessTable : IEnumerable<AccessRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Flags", "Same" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Flags, r.Same });
        ...
        /// </remarks>
        public List<AccessRecord> Records => _records;
        private List<AccessRecord> _records = new List<AccessRecord>();
        ...
        /// </remarks>
        public List<AccessRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<AccessRecord> IEnumerable<AccessRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, AccessRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, AccessRecord> _recordsByIndex = new Dictionary<int, AccessRecord>();
        ...
        /// </remarks>
        public AccessRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out AccessRecord record) ? record : null;
        ...
        /// </remarks>
        public AccessRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out AccessRecord record))
                throw new TabbitException($"There is no record in table `Access` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<AccessRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<AccessRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, AccessRecord Row) Current
        ...
        /// </remarks>
        public AccessRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<AccessRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Access.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Access.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Access.Flags", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Access.Flags");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            record._flags = cursor.NextI64();
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Access.Same", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Access.Same");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsByIndex = new Dictionary<int, AccessRecord>(count);
