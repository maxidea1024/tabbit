...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class LineTable : IEnumerable<LineRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Body", "Icon" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Body, r.Icon });
        ...
        /// </remarks>
        public List<LineRecord> Records => _records;
        private List<LineRecord> _records = new List<LineRecord>();
        ...
        /// </remarks>
        public List<LineRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<LineRecord> IEnumerable<LineRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, LineRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, LineRecord> _recordsByIndex = new Dictionary<int, LineRecord>();
        ...
        /// </remarks>
        public LineRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out LineRecord record) ? record : null;
        ...
        /// </remarks>
        public LineRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out LineRecord record))
                throw new TabbitException($"There is no record in table `Line` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<LineRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<LineRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, LineRecord Row) Current
        ...
        /// </remarks>
        public LineRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<LineRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Line.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Line.Body", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Line.Icon", TcbTable.KindScalar, false, TcbTable.ElementString);
            ...
            var recordsByIndex = new Dictionary<int, LineRecord>(count);
