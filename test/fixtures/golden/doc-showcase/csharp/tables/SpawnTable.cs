...
namespace Tabbit.Fixtures.DocShowcase
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class SpawnTable : IEnumerable<SpawnRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "At", "Radius" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.At, r.Radius });
        ...
        /// </remarks>
        public List<SpawnRecord> Records => _records;
        private List<SpawnRecord> _records = new List<SpawnRecord>();
        ...
        /// </remarks>
        public List<SpawnRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<SpawnRecord> IEnumerable<SpawnRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, SpawnRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, SpawnRecord> _recordsByIndex = new Dictionary<int, SpawnRecord>();
        ...
        public SpawnRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out SpawnRecord record) ? record : null;
        ...
        {
            if (!_recordsByIndex.TryGetValue(key, out SpawnRecord record))
                throw new TabbitException($"There is no record in table `Spawn` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<SpawnRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<SpawnRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, SpawnRecord Row) Current
        ...
        /// </remarks>
        public SpawnRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<SpawnRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Spawn.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Spawn.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Spawn.At.X", TcbTable.KindScalar, false, TcbTable.ElementF32);
                        cursor = new TcbColumnCursor(reader, column, count, "Spawn.At.X");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Spawn.At.Y", TcbTable.KindScalar, false, TcbTable.ElementF32);
                        cursor = new TcbColumnCursor(reader, column, count, "Spawn.At.Y");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Spawn.Radius", TcbTable.KindScalar, true, TcbTable.ElementF32);
                        presence = TcbTable.ReadPresence(reader, column, count);
                        cursor = new TcbColumnCursor(reader, column, count, "Spawn.Radius");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            records[i]._radiusHasValue = TcbTable.IsPresent(presence, i);
                            ...
                            if (!records[i]._radiusHasValue)
                                records[i]._radius = default(float);
                        }
                        break;
            ...
            var recordsByIndex = new Dictionary<int, SpawnRecord>(count);
