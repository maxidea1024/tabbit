...
class DeckSlotEntry:
    ...
    def __repr__(self):
        return "DeckSlotEntry(id=%r, label=%r)" % (self.id, self.label)
...
class DeckHomeEntryAt:
    ...
    def __repr__(self):
        return "DeckHomeEntryAt(x=%r, y=%r)" % (self.x, self.y)
...
class DeckHomeEntry:
    ...
    def __init__(self):
        self.at = DeckHomeEntryAt()

    def __repr__(self):
        return "DeckHomeEntry(at=%r)" % (self.at,)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Deck.Slot.Id")
                for record in records:
                    ...
                    record.slot = [
                        DeckSlotEntry() for _ in range(element_count)]
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Deck.Slot.Label")
                for record in records:
                    element_count = cursor.next_length()
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Deck.Home.At.X")
                for record in records:
                    record.home.at.x = cursor.next_f32()
            elif column.tag == 5:
                tabbit.check_column(column, "Deck.Home.At.Y", tabbit.KIND_SCALAR, False, (tabbit.ELEMENT_F32,))
                cursor = tabbit.ColumnCursor(reader, column, count, "Deck.Home.At.Y")
                for record in records:
