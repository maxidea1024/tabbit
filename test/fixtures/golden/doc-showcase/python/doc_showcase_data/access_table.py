    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Access.Flags")
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Access.Same")
                for record in records:
