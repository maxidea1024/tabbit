...
class ServerTuningTable:
    ...
    def read(self, filename):
        ...
        records = [ServerTuningRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ServerTuning.Index")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ServerTuning.Knob")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ServerTuning.Value")
