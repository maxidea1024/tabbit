    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Sample.Count")
                for record in records:
                    record.count = cursor.next_i64()
            elif column.tag == 3:
                tabbit.check_column(column, "Sample.Ratio", tabbit.KIND_SCALAR, False, (tabbit.ELEMENT_F32,))
                cursor = tabbit.ColumnCursor(reader, column, count, "Sample.Ratio")
                for record in records:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Sample.At")
                for record in records:
                    record.at = cursor.next_i64()
            elif column.tag == 8:
                tabbit.check_column(column, "Sample.Span", tabbit.KIND_SCALAR, False, (tabbit.ELEMENT_I64,))
                cursor = tabbit.ColumnCursor(reader, column, count, "Sample.Span")
                for record in records:
