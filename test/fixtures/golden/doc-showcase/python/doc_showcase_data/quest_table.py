...
class QuestRewardEntry:
    ...
    def __repr__(self):
        return "QuestRewardEntry(id=%r, count=%r)" % (self.id, self.count)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Quest.Index")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Quest.Name")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Quest.Reward.Id")
                for record in records:
                    ...
                    record.reward = [
                        QuestRewardEntry() for _ in range(element_count)]
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Quest.Reward.Count")
                for record in records:
                    element_count = cursor.next_length()
                    if len(record.reward) != element_count:
