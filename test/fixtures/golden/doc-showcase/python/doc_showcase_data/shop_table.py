...
class ShopRecord:
    ...
    def __repr__(self):
        return "ShopRecord(index=%r, name=%r)" % (self.index, self.name)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Shop.Index")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Shop.Name")
                at = 0
                while at < count:
