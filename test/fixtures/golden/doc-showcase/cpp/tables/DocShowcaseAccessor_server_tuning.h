...
#ifndef TABBIT_GENERATED_DOCSHOWCASEACCESSOR_SERVER_TUNING_H
#define TABBIT_GENERATED_DOCSHOWCASEACCESSOR_SERVER_TUNING_H
...
class ServerTuningTable {
 public:
  ...
  typename std::vector<ServerTuningRecord>::const_iterator begin() const {
    return records_.begin();
  }

  typename std::vector<ServerTuningRecord>::const_iterator end() const {
    return records_.end();
  }
  ...
  void read(const std::string& filename) {
    ...
    for (const tabbit::Column& column : header.columns) {
      ...
      switch (column.tag) {
        ...
        case 2: {
          tabbit::check_column(column, "ServerTuning.Knob", tabbit::kKindScalar, false, {tabbit::kElementString});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "ServerTuning.Knob");
          std::string value{};
          for (std::size_t i = 0; i < row_count; ) {
        ...
        case 3: {
          tabbit::check_column(column, "ServerTuning.Value", tabbit::kKindScalar, false, {tabbit::kElementF32});
          tabbit::TcbColumnCursor cursor(reader, column, header.row_count, "ServerTuning.Value");
...
#endif  // TABBIT_GENERATED_DOCSHOWCASEACCESSOR_SERVER_TUNING_H
