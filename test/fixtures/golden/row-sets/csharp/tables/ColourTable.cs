...
{
    [System.Serializable]
    public partial class ColourRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Ordinal\":"); ToStringHelper.ToString(Ordinal, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    /// <summary>
    /// Given its rows twice.
    /// </summary>
    [System.Serializable]
    public partial class ColourTable : IEnumerable<ColourRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Ordinal" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Ordinal });
        ...
        /// </remarks>
        public List<ColourRecord> Records => _records;
        private List<ColourRecord> _records = new List<ColourRecord>();
        ...
        /// </remarks>
        public List<ColourRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ColourRecord> IEnumerable<ColourRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, ColourRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, ColourRecord> _recordsByIndex = new Dictionary<int, ColourRecord>();
        ...
        /// </remarks>
        public ColourRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out ColourRecord record) ? record : null;
        ...
        /// </remarks>
        public ColourRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out ColourRecord record))
                throw new TabbitException($"There is no record in table `Colour` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<ColourRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ColourRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ColourRecord Row) Current
        ...
        /// </remarks>
        public ColourRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ColourRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ColourRecord());
            ...
            var recordsByIndex = new Dictionary<int, ColourRecord>(count);
