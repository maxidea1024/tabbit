...
namespace Tabbit.Fixtures.Core.Client
{
    ...
    public partial class ItemCategoryTable : IEnumerable<ItemCategoryRecord>
    {
        ...
        {
            var bytes = await CoreClientAccessor.ReadAllBytesAsync(filename);

            // Unconditionally, and with whatever `CoreClientAccessor.EncryptionKey` and `CoreClientAccessor.MacKey`
            ...
            var reader = new TcbReader(TcbTable.Open(
                bytes, CoreClientAccessor.EncryptionKey, CoreClientAccessor.MacKey, CoreClientAccessor.VerifyMac));
