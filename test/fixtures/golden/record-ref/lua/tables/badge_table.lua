...
---@class BadgeRecord
---@field index integer
---@field mark BadgeMarkEntry
---@field pad integer
local BadgeRecordMeta = tcb.strictType("a `Badge` row", { "index", "mark", "pad" })

---@return BadgeRecord
local function newBadgeRecord()
  return setmetatable({
    index = 0,
    mark = newBadgeMarkEntry(),
    pad = 0,
  }, BadgeRecordMeta)
end

---@class BadgeTable
---@field records BadgeRecord[]
local BadgeTable = {}

local BadgeTableMeta = tcb.strictInstance("the `Badge` table", BadgeTable, { "records", "byIndex" })

function BadgeTable.new()
  return setmetatable({
    records = {},
    byIndex = {},
  }, BadgeTableMeta)
...
function BadgeTable:containsIndex(key)
...
function BadgeTable:readBytes(data)
...
function BadgeTable:read(filename)
