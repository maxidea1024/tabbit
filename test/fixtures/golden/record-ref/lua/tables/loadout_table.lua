...
function LoadoutTable:readBytes(data)
  ...
  for c = 1, #columns do
    ...
    elseif column.tag == 2 then
      tcb.checkColumn(column, "Loadout.Slot.ItemId", tcb.KIND_FIXED_ARRAY, 2, false, { tcb.ELEMENT_I32 })
    ...
    elseif column.tag == 3 then
      tcb.checkColumn(column, "Loadout.Slot.SwapId", tcb.KIND_FIXED_ARRAY, 2, false, { tcb.ELEMENT_I32 })
