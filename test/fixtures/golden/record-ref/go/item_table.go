...
func (t *ItemTable) Read(filename string) error {
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "Item.Index", tabbit.KindScalar, 1, false, tabbit.ElementI32, tabbit.ElementVarint) {
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "Item.Name", tabbit.KindScalar, 1, false, tabbit.ElementString) {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "Item.Pad", tabbit.KindScalar, 1, false, tabbit.ElementI32, tabbit.ElementVarint) {
		...
		case 4:
			if tabbit.CheckColumn(reader, column, "Item.Pad2", tabbit.KindScalar, 1, false, tabbit.ElementI32, tabbit.ElementVarint) {
		...
		case 5:
			if tabbit.CheckColumn(reader, column, "Item.Pad3", tabbit.KindScalar, 1, false, tabbit.ElementI32, tabbit.ElementVarint) {
