...
final class PoseRecord
{
    ...
    {
        for ($i = 0; $i < 2; $i++) {
            $this->step[] = new PoseStepEntry();
        }
    }
}

/** Every row of Pose. */
final class PoseTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<PoseRecord> */
     ...
     *
     * @return \Traversable<int, PoseRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?PoseRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): PoseRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?PoseRecord
    {
    ...
    {
        throw new \LogicException('PoseTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PoseRecord>
     */
