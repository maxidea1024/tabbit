...
/** Every row of Seal. */
final class SealTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<SealRecord> */
     ...
     *
     * @return \Traversable<int, SealRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?SealRecord
    {
    ...
    {
        throw new \LogicException('SealTable is read-only.');
    }
     ...
     *
     * @return \Generator<string, SealRecord>
     */
