...
/** Every row of Bag. */
final class BagTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<BagRecord> */
     ...
     *
     * @return \Traversable<int, BagRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?BagRecord
    {
    ...
    {
        throw new \LogicException('BagTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, BagRecord>
     */
