...
/** Every row of Mount. */
final class MountTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, MountRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?MountRecord
    {
    ...
    {
        throw new \LogicException('MountTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, MountRecord>
     */
