...
final class ItemTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     */
    public function findByIndex(int $key): ?ItemRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): ItemRecord
    {
        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                ...
                case 3:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Item.Pad');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                            $records[$i]->pad = $value;
                ...
                case 4:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Item.Pad2');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                ...
                case 5:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Item.Pad3');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
