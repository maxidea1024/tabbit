...
/** Every row of Clip. */
final class ClipTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ClipRecord> */
     ...
     *
     * @return \Traversable<int, ClipRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?ClipRecord
    {
    ...
    {
        throw new \LogicException('ClipTable is read-only.');
    }
     ...
     *
     * @return \Generator<string, ClipRecord>
     */
