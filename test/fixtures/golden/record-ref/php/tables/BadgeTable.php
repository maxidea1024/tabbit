...
/** Every row of Badge. */
final class BadgeTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, BadgeRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?BadgeRecord
    {
    ...
    {
        throw new \LogicException('BadgeTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, BadgeRecord>
     */
