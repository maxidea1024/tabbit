...
/** Every row of Badge. */
public final class BadgeTable implements Iterable<BadgeRecord> {
     ...
     */
    @Override
    public Iterator<BadgeRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, BadgeRecord>> entries() {
        final List<BadgeRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, BadgeRecord>>() {
            private final Iterator<BadgeRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, BadgeRecord> next() {
                final BadgeRecord row = source.next();
