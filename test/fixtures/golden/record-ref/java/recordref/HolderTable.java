...
/** Every row of Holder. */
public final class HolderTable implements Iterable<HolderRecord> {
     ...
     */
    @Override
    public Iterator<HolderRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, HolderRecord>> entries() {
        final List<HolderRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, HolderRecord>>() {
            private final Iterator<HolderRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, HolderRecord> next() {
                final HolderRecord row = source.next();
        ...
        for (TcbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                ...
                case 2: {
                    ...
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Holder.Main.ItemId");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                ...
                case 3: {
                    ...
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Holder.Main.Count");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                            loaded.get(i).main.count = cursor.runSameValue;
                        }
                    }
                    break;
                }
                case 4: {
                    ...
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Holder.Pad");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                ...
                case 5: {
                    ...
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Holder.Pad2");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
