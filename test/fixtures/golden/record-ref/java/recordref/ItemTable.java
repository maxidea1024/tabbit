...
public final class ItemTable implements Iterable<ItemRecord> {
    ...
    private Map<Integer, ItemRecord> byIndex = new HashMap<>();
    ...
    public ItemRecord getByIndexOrThrow(int key) {
        ItemRecord record = byIndex.get(key);
    ...
    public void read(Path filename) {
        ...
        Map<Integer, ItemRecord> loadedByIndex = new HashMap<>(count * 2);
        ...
        for (TcbReader.Column column : header.columns) {
            ...
            switch (column.tag) {
                case 1: {
                    TcbReader.checkColumn(column, "Item.Index", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_I32, TcbReader.ELEMENT_VARINT);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Item.Index");
                    for (int i = 0; i < count; ) {
                ...
                case 2: {
                    TcbReader.checkColumn(column, "Item.Name", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_STRING);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Item.Name");
                    for (int i = 0; i < count; ) {
                ...
                case 3: {
                    TcbReader.checkColumn(column, "Item.Pad", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_I32, TcbReader.ELEMENT_VARINT);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Item.Pad");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                ...
                case 4: {
                    TcbReader.checkColumn(column, "Item.Pad2", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_I32, TcbReader.ELEMENT_VARINT);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Item.Pad2");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
                ...
                case 5: {
                    TcbReader.checkColumn(column, "Item.Pad3", TcbReader.KIND_SCALAR, false, TcbReader.ELEMENT_I32, TcbReader.ELEMENT_VARINT);
                    cursor = new TcbReader.ColumnCursor(reader, column, count, "Item.Pad3");
                    for (int i = 0; i < count; ) {
                        int n = cursor.nextSameI32(count - i);
                        for (; n > 0; n--, i++) {
