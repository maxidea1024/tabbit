...
/** Every row of Mount. */
public final class MountTable implements Iterable<MountRecord> {
     ...
     */
    @Override
    public Iterator<MountRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, MountRecord>> entries() {
        final List<MountRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, MountRecord>>() {
            private final Iterator<MountRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, MountRecord> next() {
                final MountRecord row = source.next();
