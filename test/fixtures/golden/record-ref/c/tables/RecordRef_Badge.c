...
static bool RecordRef_BadgeParse(RecordRef_BadgeTable_t* table, tb_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (RecordRef_BadgeRecord_t*)tb_arena_alloc(
