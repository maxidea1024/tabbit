...
static bool RecordRef_BagParse(RecordRef_BagTable_t* table, tb_reader* reader) {
  int32_t row;
  int32_t at;
  ...
  if (table->count > 0) {
    table->records = (RecordRef_BagRecord_t*)tb_arena_alloc(
