...
/// Every row of Seal.
class SealTable extends Iterable<SealRecord> {
  ...
  @override
  Iterator<SealRecord> get iterator => _records.iterator;
  ...
  SealRecord? operator [](Uuid key) => findByIndex(key);
  ...
  Iterable<MapEntry<Uuid, SealRecord>> get entries =>
