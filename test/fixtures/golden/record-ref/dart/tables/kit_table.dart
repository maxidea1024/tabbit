...
/// Every row of Kit.
class KitTable extends Iterable<KitRecord> {
  ...
  @override
  Iterator<KitRecord> get iterator => _records.iterator;
  ...
  KitRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, KitRecord>> get entries =>
