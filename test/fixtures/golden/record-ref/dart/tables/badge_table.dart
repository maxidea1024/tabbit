...
/// Every row of Badge.
class BadgeTable extends Iterable<BadgeRecord> {
  ...
  @override
  Iterator<BadgeRecord> get iterator => _records.iterator;
  ...
  BadgeRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, BadgeRecord>> get entries =>
