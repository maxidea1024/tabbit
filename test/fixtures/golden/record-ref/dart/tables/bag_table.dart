...
class BagRecord {
  ...
  int index = 0;
  /// element 1 of the member
  BagSlotsEntry slots = BagSlotsEntry();

}

/// Every row of Bag.
class BagTable extends Iterable<BagRecord> {
  ...
  List<BagRecord> get records => _records;
  List<BagRecord> _records = [];
  ...
  @override
  Iterator<BagRecord> get iterator => _records.iterator;

  Map<int, BagRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  BagRecord? findByIndex(int key) => _byIndex[key];
  ...
  BagRecord getByIndexOrThrow(int key) {
  ...
  BagRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, BagRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <BagRecord>[];
    final loadedByIndex = <int, BagRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(BagRecord());
    }
