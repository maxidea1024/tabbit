...
/// Every row of Pose.
class PoseTable extends Iterable<PoseRecord> {
  ...
  @override
  Iterator<PoseRecord> get iterator => _records.iterator;
  ...
  PoseRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, PoseRecord>> get entries =>
