...
/// Every row of Mount.
class MountTable extends Iterable<MountRecord> {
  ...
  @override
  Iterator<MountRecord> get iterator => _records.iterator;
  ...
  MountRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, MountRecord>> get entries =>
