...
/// Every row of Clip.
class ClipTable extends Iterable<ClipRecord> {
  ...
  List<ClipRecord> get records => _records;
  ...
  @override
  Iterator<ClipRecord> get iterator => _records.iterator;

  Map<String, ClipRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ClipRecord? findByIndex(String key) => _byIndex[key];
  ...
  ClipRecord getByIndexOrThrow(String key) {
  ...
  ClipRecord? operator [](String key) => findByIndex(key);
  ...
  Iterable<MapEntry<String, ClipRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ClipRecord>[];
    final loadedByIndex = <String, ClipRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ClipRecord());
    }
