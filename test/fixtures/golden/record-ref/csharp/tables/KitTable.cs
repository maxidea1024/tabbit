...
namespace Tabbit.Fixtures.RecordRef
{
    ...
    public partial class KitRecord
    {
        ...
        #region Storage
        internal int _index;
        internal PartEntry[] _part = System.Array.Empty<PartEntry>();
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Part\":"); ToStringHelper.ToString(Part, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    public partial class KitTable : IEnumerable<KitRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Part" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Part });
                ...
                switch (column.Tag)
                {
                    ...
                    case 2:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._part = new KitRecord.PartEntry[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._part[j].ItemId = cursor.NextI32();
                                record._part[j].ItemByItemId = default(ItemRecord); // will be assigned.
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            if (record._part.Length != elementCount)
                            {
                                throw new TcbException(
                                    "Kit.Part: the file gives this row "
                                    + elementCount + " elements for one member of the record and "
                                    + record._part.Length + " for another. Every member of a "
