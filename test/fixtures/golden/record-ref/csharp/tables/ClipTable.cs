...
namespace Tabbit.Fixtures.RecordRef
{
    ...
    public partial class ClipRecord
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Length\":"); ToStringHelper.ToString(Length, sb);
    ...
    public partial class ClipTable : IEnumerable<ClipRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Length", "Pad", "Pad2", "Pad3" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Length, r.Pad, r.Pad2, r.Pad3 });
        ...
        public Dictionary<string, ClipRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<string, ClipRecord> _recordsByIndex = new Dictionary<string, ClipRecord>();
        ...
        public struct EntryEnumerator
        {
            ...
            public (string Key, ClipRecord Row) Current
        ...
        /// </remarks>
        public ClipRecord this[string key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var recordsByIndex = new Dictionary<string, ClipRecord>(count);
