...
object Tables {
    ...
    var holder: HolderTable = HolderTable()
        private set
    var bag: BagTable = BagTable()
        private set
    var mount: MountTable = MountTable()
        private set
    var clip: ClipTable = ClipTable()
        private set
    var pose: PoseTable = PoseTable()
        private set
    var seal: SealTable = SealTable()
        private set
    var badge: BadgeTable = BadgeTable()
        private set
    ...
    fun readAll(basePath: String, fileExtension: String = ".tcb") {
        ...
        val loadedBagTable = BagTable()
        loadedBagTable.read(File(basePath, "Bag$fileExtension").path)
        val loadedMountTable = MountTable()
        loadedMountTable.read(File(basePath, "Mount$fileExtension").path)
        val loadedClipTable = ClipTable()
        loadedClipTable.read(File(basePath, "Clip$fileExtension").path)
        val loadedPoseTable = PoseTable()
        loadedPoseTable.read(File(basePath, "Pose$fileExtension").path)
        val loadedSealTable = SealTable()
        loadedSealTable.read(File(basePath, "Seal$fileExtension").path)
        val loadedBadgeTable = BadgeTable()
        loadedBadgeTable.read(File(basePath, "Badge$fileExtension").path)
