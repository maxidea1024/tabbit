...
class ItemTable : Iterable<ItemRecord> {
    ...
    private var byIndex: HashMap<Int, ItemRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): ItemRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): ItemRecord =
     ...
     */
    operator fun get(key: Int): ItemRecord? = findByIndex(key)
    ...
    fun read(filename: String) {
        ...
        val loadedByIndex = HashMap<Int, ItemRecord>(count * 2)
