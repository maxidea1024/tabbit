...
/** Every row of Badge. */
class BadgeTable : Iterable<BadgeRecord> {
     ...
     */
    override fun iterator(): Iterator<BadgeRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): BadgeRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, BadgeRecord>>
