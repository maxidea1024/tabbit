...
/** Every row of Holder. */
class HolderTable : Iterable<HolderRecord> {
     ...
     */
    override fun iterator(): Iterator<HolderRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): HolderRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, HolderRecord>>
