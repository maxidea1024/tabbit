...
class PoseRecord {
    ...
    var step: MutableList<StepEntry> = MutableList(2) { StepEntry() }
...
/** Every row of Pose. */
class PoseTable : Iterable<PoseRecord> {
     ...
     */
    var records: MutableList<PoseRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<PoseRecord> = records.iterator()

    private var byIndex: HashMap<Int, PoseRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Int): PoseRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): PoseRecord =
     ...
     */
    operator fun get(key: Int): PoseRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, PoseRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<PoseRecord>(count)
        val loadedByIndex = HashMap<Int, PoseRecord>(count * 2)

        repeat(count) { loaded.add(PoseRecord()) }
