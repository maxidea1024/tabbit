...
/** Every row of Seal. */
class SealTable : Iterable<SealRecord> {
     ...
     */
    var records: MutableList<SealRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<SealRecord> = records.iterator()

    private var byIndex: HashMap<Uuid, SealRecord> = HashMap()
     ...
     */
    fun findByIndex(key: Uuid): SealRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Uuid): SealRecord =
     ...
     */
    operator fun get(key: Uuid): SealRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Uuid, SealRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SealRecord>(count)
        val loadedByIndex = HashMap<Uuid, SealRecord>(count * 2)

        repeat(count) { loaded.add(SealRecord()) }
