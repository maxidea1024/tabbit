...
/** Every row of Bag. */
class BagTable : Iterable<BagRecord> {
     ...
     */
    override fun iterator(): Iterator<BagRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): BagRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, BagRecord>>
