...
class PoseStepEntry:
    ...
    def __repr__(self):
        return "PoseStepEntry(clip_id=%r, weight=%r)" % (self.clip_id, self.weight)
...
class PoseRecord:
    ...
    __slots__ = ("index", "step")

    def __init__(self):
        self.index = 0
        self.step = [PoseStepEntry() for _ in range(2)]

    def __repr__(self):
        return "PoseRecord(index=%r, step=%r)" % (self.index, self.step)
...
class PoseTable:
    ...
    def read(self, filename):
        ...
        records = [PoseRecord() for _ in range(count)]
