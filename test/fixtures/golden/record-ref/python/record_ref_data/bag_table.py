...
class BagSlotsEntry:
    ...
    def __repr__(self):
        return "BagSlotsEntry(item_id=%r, count=%r)" % (self.item_id, self.count)
...
class BagRecord:
    ...
    def __init__(self):
        self.index = 0
        self.slots = BagSlotsEntry()

    def __repr__(self):
        return "BagRecord(index=%r, slots=%r)" % (self.index, self.slots)
...
class BagTable:
    ...
    def read(self, filename):
        ...
        records = [BagRecord() for _ in range(count)]
