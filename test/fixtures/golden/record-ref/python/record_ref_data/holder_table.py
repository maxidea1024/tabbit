...
class HolderMainEntry:
    ...
    def __repr__(self):
        return "HolderMainEntry(item_id=%r, count=%r)" % (self.item_id, self.count)
...
class HolderRecord:
    ...
    __slots__ = ("index", "main", "pad", "pad2")

    def __init__(self):
        self.index = 0
        self.main = HolderMainEntry()
        self.pad = 0
        self.pad2 = 0

    def __repr__(self):
        return "HolderRecord(index=%r, main=%r, pad=%r, pad2=%r)" % (self.index, self.main, self.pad, self.pad2)
