...
public final class ItemTable: Sequence {
    ...
    private var byIndex: [Int32: ItemRecord] = [:]

    /// The row with this Index, or nil when the table has none.
    ///
    /// The lookup to reach for when a missing row is an ordinary answer - an optional
    /// reference, a key that came from user input.
    public func findByIndex(_ key: Int32) -> ItemRecord? {
        byIndex[key]
    }
    ...
    public func getByIndexOrThrow(_ key: Int32) throws -> ItemRecord {
    ...
    public func read(
        ...
        var loadedByIndex = [Int32: ItemRecord](
