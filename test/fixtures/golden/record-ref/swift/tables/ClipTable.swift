...
/// Every row of Clip.
public final class ClipTable: Sequence {
    ...
    public func makeIterator() -> Array<ClipRecord>.Iterator {
    ...
    public subscript(_ key: String) -> ClipRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[ClipRecord], (key: String, row: ClipRecord)> {
