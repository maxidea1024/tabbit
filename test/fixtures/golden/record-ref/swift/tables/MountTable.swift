...
/// Every row of Mount.
public final class MountTable: Sequence {
    ...
    public func makeIterator() -> Array<MountRecord>.Iterator {
    ...
    public subscript(_ key: Int32) -> MountRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[MountRecord], (key: Int32, row: MountRecord)> {
