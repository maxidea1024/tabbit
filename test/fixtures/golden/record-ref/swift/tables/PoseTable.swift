...
/// Every row of Pose.
public final class PoseTable: Sequence {
    ...
    public func makeIterator() -> Array<PoseRecord>.Iterator {
    ...
    public subscript(_ key: Int32) -> PoseRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[PoseRecord], (key: Int32, row: PoseRecord)> {
