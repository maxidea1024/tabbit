        ...
        for column in header.columns {
            ...
            case 2:
                ...
                for record in loaded {
                    ...
                    record.part = [KitRecord.PartEntry](
            ...
            case 3:
                ...
                for record in loaded {
                    let elementCount = max(0, try cursor.nextLength())
                    if record.part.count != elementCount {
                        throw TcbError(
                            "Kit.part: the file gives one "
                            + "member of this record a different element count than another")
                    }

                    for element in 0 ..< elementCount {
                        record.part[element].count = try cursor.nextI32()
                    }
                }
            default:
