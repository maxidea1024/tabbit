...
public final class BadgeRecord {
    ...
    public var mark: MarkEntry = MarkEntry()
...
/// Every row of Badge.
public final class BadgeTable: Sequence {
    ...
    public func makeIterator() -> Array<BadgeRecord>.Iterator {
    ...
    public private(set) var records: [BadgeRecord] = []

    private var byIndex: [Int32: BadgeRecord] = [:]

    /// The row with this Index, or nil when the table has none.
    ///
    /// The lookup to reach for when a missing row is an ordinary answer - an optional
    /// reference, a key that came from user input.
    public func findByIndex(_ key: Int32) -> BadgeRecord? {
        byIndex[key]
    }
    ...
    public func getByIndexOrThrow(_ key: Int32) throws -> BadgeRecord {
    ...
    public subscript(_ key: Int32) -> BadgeRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[BadgeRecord], (key: Int32, row: BadgeRecord)> {
    ...
    public func read(
        ...
        var loaded = [BadgeRecord]()
        loaded.reserveCapacity(count)

        for _ in 0 ..< count { loaded.append(BadgeRecord()) }
        var loadedByIndex = [Int32: BadgeRecord](
