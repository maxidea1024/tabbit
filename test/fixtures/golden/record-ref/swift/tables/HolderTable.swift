...
/// Every row of Holder.
public final class HolderTable: Sequence {
    ...
    public func makeIterator() -> Array<HolderRecord>.Iterator {
    ...
    public subscript(_ key: Int32) -> HolderRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[HolderRecord], (key: Int32, row: HolderRecord)> {
