...
impl BagTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, BagRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &BagRecord)> + '_ {
...
impl<'a> IntoIterator for &'a BagTable {
    type Item = &'a BagRecord;
    type IntoIter = std::slice::Iter<'a, BagRecord>;
