...
impl PoseTable {
    ...
    pub fn records(&self) -> &[PoseRecord] {
        &self.records
    }
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, PoseRecord> {
        self.records.iter()
    }
    ...
    pub fn find_by_index(&self, key: i32) -> Option<&PoseRecord> {
    ...
    /// error it returns.
    pub fn get_by_index_or_error(&self, key: i32) -> tabbit::Result<&PoseRecord> {
        self.by_index
            .get(&key)
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &PoseRecord)> + '_ {
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![PoseRecord::default(); count];
...
impl<'a> IntoIterator for &'a PoseTable {
    type Item = &'a PoseRecord;
    type IntoIter = std::slice::Iter<'a, PoseRecord>;
