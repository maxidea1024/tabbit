...
#[derive(Clone, Debug, Default)]
pub struct MountRigEntry {
    /// element 1, two levels in
    pub core: MountRigEntryCore,
}
...
impl MountTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, MountRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &MountRecord)> + '_ {
...
impl<'a> IntoIterator for &'a MountTable {
    type Item = &'a MountRecord;
    type IntoIter = std::slice::Iter<'a, MountRecord>;
