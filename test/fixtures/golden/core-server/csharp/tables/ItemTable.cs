...
namespace Tabbit.Fixtures.Core.Server
{
    ...
    public partial class ItemTable : IEnumerable<ItemTable.Record>
    {
        ...
        public partial class Record
        {
            ...
            /// item grade
            /// </summary>
            public global::Tabbit.Fixtures.Core.Server.Grade GradeField => _gradeField;

            /// <summary>
            /// granted skill
            /// </summary>
            public global::Tabbit.Fixtures.Core.Server.SkillType SkillField => _skillField;
                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._gradeField = (global::Tabbit.Fixtures.Core.Server.Grade)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._skillField = (global::Tabbit.Fixtures.Core.Server.SkillType)value;
                            } while (--n > 0);
                        }
                        break;
