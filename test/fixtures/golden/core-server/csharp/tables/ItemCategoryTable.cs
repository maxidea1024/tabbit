...
{
    [System.Serializable]
    public partial class ItemCategoryRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    /// </summary>
    [System.Serializable]
    public partial class ItemCategoryTable : IEnumerable<ItemCategoryRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<ItemCategoryRecord> Records => _records;
        private List<ItemCategoryRecord> _records = new List<ItemCategoryRecord>();
        ...
        /// </remarks>
        public List<ItemCategoryRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ItemCategoryRecord> IEnumerable<ItemCategoryRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, ItemCategoryRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, ItemCategoryRecord> _recordsByIndex = new Dictionary<int, ItemCategoryRecord>();
        ...
        /// </remarks>
        public ItemCategoryRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out ItemCategoryRecord record) ? record : null;
        ...
        /// </remarks>
        public ItemCategoryRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out ItemCategoryRecord record))
                throw new TabbitException($"There is no record in table `ItemCategory` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<ItemCategoryRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ItemCategoryRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ItemCategoryRecord Row) Current
        ...
        /// </remarks>
        public ItemCategoryRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
                records.Add(new ItemCategoryRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "ItemCategory.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "ItemCategory.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "ItemCategory.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "ItemCategory.Name");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "ItemCategory.Description", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "ItemCategory.Description");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<int, ItemCategoryRecord>(count);
