...
namespace Tabbit.Fixtures.Core.Server
{
    ...
    public partial class ArrayTypesTable : IEnumerable<ArrayTypesTable.Record>
    {
        ...
        public partial class Record
        {
            ...
            /// allowed grades
            /// </summary>
            public global::Tabbit.Fixtures.Core.Server.Grade[] Grades => _grades;
                ...
                switch (column.Tag)
                {
                    ...
                    case 5:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            int elementCount;
                            elementCount = cursor.NextLength();
                            record._grades = new global::Tabbit.Fixtures.Core.Server.Grade[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._grades[j] = (global::Tabbit.Fixtures.Core.Server.Grade)cursor.NextI32();
                            }
                        }
                        break;
