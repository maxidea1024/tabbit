...
{
    /// <summary>
    /// Another catalogue in the same set, keyed well clear of the first.
    /// </summary>
    [System.Serializable]
    public partial class MountTable
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Icon", "Speed" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Icon, r.Speed });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Mount.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Mount.Icon", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Mount.Icon");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Mount.Speed", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Mount.Speed");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
