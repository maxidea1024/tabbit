...
{
    /// <summary>
    /// What is for sale. The reward may be a row of any catalogue in the set.
    /// </summary>
    [System.Serializable]
    public partial class ShopTable
    {
        ...
        public partial class Record
        {
            ...
            /// <summary>Which table <see cref="RewardId"/> is a row of.</summary>
            public ShopRewardIdTarget RewardIdTarget => _rewardIdTarget;
            /// <summary>
            /// The <c>Item</c> row <see cref="RewardId"/> names, or null
            /// when it names a row of one of the others.
            /// </summary>
            public ItemTable.Record ItemByRewardId
                => _rewardIdTarget == ShopRewardIdTarget.Item
                    ? (ItemTable.Record)_rewardIdRow
                    : null;
            /// <summary>
            /// The <c>Mount</c> row <see cref="RewardId"/> names, or null
            /// when it names a row of one of the others.
            /// </summary>
            public MountTable.Record MountByRewardId
                => _rewardIdTarget == ShopRewardIdTarget.Mount
                    ? (MountTable.Record)_rewardIdRow
                    : null;
            #endregion

            #region Multi-target reference wiring
            public void SetReference_RewardId_INTERNAL(ShopRewardIdTarget target, object row)
            {
                _rewardIdTarget = target;
                _rewardIdRow = row;
            }
            #endregion
            ...
            internal int _price;
            internal object _rewardIdRow;
            internal ShopRewardIdTarget _rewardIdTarget;
            #endregion
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "RewardId", "Price" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.RewardId, r.Price });
        ...
        public Record GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out Record record))
                throw new TabbitException($"There is no record in table `Shop` that corresponds to field `Index` value {key}");
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Shop.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Shop.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Shop.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Shop.RewardId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Shop.Price", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Shop.Price");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
