...
---@class FoldedTable
---@field records FoldedRecord[]
local FoldedTable = {}

local FoldedTableMeta = tcb.strictInstance("the `Folded` table", FoldedTable, { "records", "byIndex" })

function FoldedTable.new()
  return setmetatable({
    records = {},
    byIndex = {},
  }, FoldedTableMeta)
...
function FoldedTable:containsIndex(key)
...
function FoldedTable:readBytes(data)
...
function FoldedTable:read(filename)
