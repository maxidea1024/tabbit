...
impl FoldedTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, FoldedRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &FoldedRecord)> + '_ {
...
impl<'a> IntoIterator for &'a FoldedTable {
    type Item = &'a FoldedRecord;
    type IntoIter = std::slice::Iter<'a, FoldedRecord>;
