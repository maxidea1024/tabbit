...
class FoldedTable : Iterable<FoldedRecord> {
     ...
     */
    fun findByIndex(key: Int): FoldedRecord? = byIndex[key]
     ...
     */
    fun getByIndexOrThrow(key: Int): FoldedRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<FoldedRecord>(count)
        val loadedByIndex = HashMap<Int, FoldedRecord>(count * 2)

        repeat(count) { loaded.add(FoldedRecord()) }
