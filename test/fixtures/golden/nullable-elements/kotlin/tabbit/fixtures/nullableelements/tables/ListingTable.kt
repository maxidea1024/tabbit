...
class ListingTable : Iterable<ListingRecord> {
     ...
     */
    override fun iterator(): Iterator<ListingRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): ListingRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, ListingRecord>>
