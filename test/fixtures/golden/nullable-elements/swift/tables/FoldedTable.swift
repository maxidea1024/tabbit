...
/// Every row of Folded.
public final class FoldedTable: Sequence {
    ...
    public func makeIterator() -> Array<FoldedRecord>.Iterator {
    ...
    public subscript(_ key: Int32) -> FoldedRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[FoldedRecord], (key: Int32, row: FoldedRecord)> {
