...
/// Every row of Folded.
class FoldedTable extends Iterable<FoldedRecord> {
  ...
  @override
  Iterator<FoldedRecord> get iterator => _records.iterator;
  ...
  FoldedRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, FoldedRecord>> get entries =>
