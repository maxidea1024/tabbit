...
class TrimKitTable : Iterable<TrimKitRecord> {
     ...
     */
    override fun iterator(): Iterator<TrimKitRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): TrimKitRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, TrimKitRecord>>
