...
class BitRecord:
    ...
    def __repr__(self):
        return "BitRecord(index=%r, name=%r, tier=%r)" % (self.index, self.name, self.tier)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Bit.Name")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Bit.Tier")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
