...
impl TrimKitTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, TrimKitRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &TrimKitRecord)> + '_ {
...
impl<'a> IntoIterator for &'a TrimKitTable {
    type Item = &'a TrimKitRecord;
    type IntoIter = std::slice::Iter<'a, TrimKitRecord>;
