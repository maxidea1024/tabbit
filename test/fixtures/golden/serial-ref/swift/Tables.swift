...
public final class Tables {
    ...
    public private(set) var piece: PieceTable = PieceTable()
    ...
    public func readAll(
        ...
        let loadedPieceTable = PieceTable()
        try loadedPieceTable.read(
            base.appendingPathComponent("Piece" + fileExtension).path,
