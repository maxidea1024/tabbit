...
export class PieceTable {
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Piece.Index', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Piece.Name', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_STRING])
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Piece.Tier', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
