...
export class BitTable {
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Bit.Index', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Bit.Name', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_STRING])
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Bit.Tier', tabbit.KIND_SCALAR, 1, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
