...
/// Every row of Bit.
class BitTable extends Iterable<BitRecord> {
  ...
  @override
  Iterator<BitRecord> get iterator => _records.iterator;
  ...
  BitRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, BitRecord>> get entries =>
