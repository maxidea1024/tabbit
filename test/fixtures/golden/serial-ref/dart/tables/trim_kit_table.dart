...
class TrimKitTable extends Iterable<TrimKitRecord> {
  ...
  @override
  Iterator<TrimKitRecord> get iterator => _records.iterator;
  ...
  TrimKitRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, TrimKitRecord>> get entries =>
