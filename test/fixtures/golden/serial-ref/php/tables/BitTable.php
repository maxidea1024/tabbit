...
/** Every row of Bit. */
final class BitTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<BitRecord> */
     ...
     *
     * @return \Traversable<int, BitRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?BitRecord
    {
    ...
    {
        throw new \LogicException('BitTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, BitRecord>
     */
