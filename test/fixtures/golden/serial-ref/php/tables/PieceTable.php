...
/** Every row of Piece. */
final class PieceTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, PieceRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?PieceRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): PieceRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?PieceRecord
    {
    ...
    {
        throw new \LogicException('PieceTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PieceRecord>
     */
