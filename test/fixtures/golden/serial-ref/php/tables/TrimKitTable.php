...
final class TrimKitTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, TrimKitRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?TrimKitRecord
    {
    ...
    {
        throw new \LogicException('TrimKitTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, TrimKitRecord>
     */
