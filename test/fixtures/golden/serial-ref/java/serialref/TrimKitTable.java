...
public final class TrimKitTable implements Iterable<TrimKitRecord> {
     ...
     */
    @Override
    public Iterator<TrimKitRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, TrimKitRecord>> entries() {
        final List<TrimKitRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, TrimKitRecord>>() {
            private final Iterator<TrimKitRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, TrimKitRecord> next() {
                final TrimKitRecord row = source.next();
