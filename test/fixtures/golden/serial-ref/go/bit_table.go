...
func (t *BitTable) Count() int { return len(t.records) }
...
func (t *BitTable) All() iter.Seq[*BitRecord] {
	records := t.records

	return func(yield func(*BitRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *BitTable) Entries() iter.Seq2[int32, *BitRecord] {
	records := t.records

	return func(yield func(int32, *BitRecord) bool) {
		for i := range records {
