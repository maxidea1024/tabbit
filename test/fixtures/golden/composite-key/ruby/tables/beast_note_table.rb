...
module CompositeKey
  ...
  class BeastNoteRecord
    attr_accessor :seq, :beast_id, :beast_by_beast_id, :note
  ...
  class BeastNoteTable
    ...
    # The row with this BeastId, or nil when the table has none.
    #
    # find_by_beast_id under the spelling Ruby uses for a keyed collection. It
    ...
    def each_pair
      ...
      @records.each { |record| yield record.beast_id, record }
      self
    end
    ...
    def read(filename)
      ...
      records = Array.new(count) { BeastNoteRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'BeastNote.Seq')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'BeastNote.BeastId')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'BeastNote.Note')
          at = 0
          while at < count
            n, value = cursor.next_same_string(count - at)
            (at...(at + n)).each do |i|
      ...
      by_beast_id = records.to_h { |record| [record.beast_id, record] }

      # Published, now that every column read.
      @records = records
      @by_beast_id = by_beast_id
    end
  end
end
