...
class BeastNoteTable extends Iterable<BeastNoteRecord> {
  ...
  @override
  Iterator<BeastNoteRecord> get iterator => _records.iterator;
  ...
  /// The row with this BeastId, or null when the table has none.
  ///
  /// `findByBeastId` under the spelling Dart uses for a keyed collection. It
  ...
  BeastNoteRecord? operator [](String key) => findByBeastId(key);
  ...
  Iterable<MapEntry<String, BeastNoteRecord>> get entries =>
      _records.map((record) => MapEntry(record.beastId, record));
