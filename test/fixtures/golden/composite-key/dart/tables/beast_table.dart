...
/// Every row of Beast.
class BeastTable extends Iterable<BeastRecord> {
  ...
  List<BeastRecord> get records => _records;
  List<BeastRecord> _records = [];
  ...
  @override
  Iterator<BeastRecord> get iterator => _records.iterator;

  Map<String, BeastRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  BeastRecord? findByIndex(String key) => _byIndex[key];
  ...
  BeastRecord getByIndexOrThrow(String key) {
  ...
  BeastRecord? operator [](String key) => findByIndex(key);
  ...
  Iterable<MapEntry<String, BeastRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <BeastRecord>[];
    final loadedByIndex = <String, BeastRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(BeastRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Beast.Index', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Beast.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Beast.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Beast.Name');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].name = value;
          ...
          break;
        case 3:
          checkColumn(column, 'Beast.Pad1', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Beast.Pad1');
          for (var i = 0; i < count; ) {
