...
/** Every row of Move. */
final class MoveTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<MoveRecord> */
     ...
     *
     * @return \Traversable<int, MoveRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?MoveRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): MoveRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?MoveRecord
    {
    ...
    {
        throw new \LogicException('MoveTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, MoveRecord>
     */
