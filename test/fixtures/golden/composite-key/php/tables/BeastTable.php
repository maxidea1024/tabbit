...
/** Every row of Beast. */
final class BeastTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, BeastRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?BeastRecord
    {
    ...
    {
        throw new \LogicException('BeastTable is read-only.');
    }
     ...
     *
     * @return \Generator<string, BeastRecord>
     */
