...
class MoveRecord:
    ...
    def __repr__(self):
        return "MoveRecord(index=%r, name=%r, pad1=%r)" % (self.index, self.name, self.pad1)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Move.Name")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Move.Pad1")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
