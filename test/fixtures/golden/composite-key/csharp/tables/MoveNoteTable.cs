...
namespace Tabbit.Fixtures.CompositeKey
{
    ...
    public partial class MoveNoteTable : IEnumerable<MoveNoteTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "MoveId", "Note", "Pad1" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.MoveId, r.Note, r.Pad1 });
        ...
        /// <summary>Whether the table holds a row with this `MoveId`.</summary>
        public bool ContainsMoveId(int key) => _recordsByMoveId.ContainsKey(key);
        #endregion // Indexing by `MoveId`

        /// <summary>Each row with the `MoveId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `MoveId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByMoveIdOrThrow` under the spelling the language uses for a
        ...
        /// `MoveId` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "MoveNote.MoveId", TcbTable.KindScalar, false, TcbTable.ElementI32);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "MoveNote.Note", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "MoveNote.Pad1", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            _records = records;
            _recordsByMoveId = recordsByMoveId;
