...
namespace Tabbit.Fixtures.CompositeKey
{
    ...
    public partial class BeastNoteTable : IEnumerable<BeastNoteRecord>
    {
        ...
        /// <summary>Each row with the `BeastId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `BeastId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByBeastIdOrThrow` under the spelling the language uses for a
        ...
        /// `BeastId` is 0, not the first row - the rows in order are
