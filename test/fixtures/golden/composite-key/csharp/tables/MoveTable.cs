...
namespace Tabbit.Fixtures.CompositeKey
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class MoveTable : IEnumerable<MoveRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<MoveRecord> Records => _records;
        private List<MoveRecord> _records = new List<MoveRecord>();
        ...
        /// </remarks>
        public List<MoveRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<MoveRecord> IEnumerable<MoveRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, MoveRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, MoveRecord> _recordsByIndex = new Dictionary<int, MoveRecord>();
        ...
        /// </remarks>
        public MoveRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out MoveRecord record) ? record : null;
        ...
        /// </remarks>
        public MoveRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out MoveRecord record))
                throw new TabbitException($"There is no record in table `Move` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<MoveRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<MoveRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, MoveRecord Row) Current
        ...
        /// </remarks>
        public MoveRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<MoveRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Move.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Move.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Move.Name", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Move.Name");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Move.Pad1", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Move.Pad1");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<int, MoveRecord>(count);
