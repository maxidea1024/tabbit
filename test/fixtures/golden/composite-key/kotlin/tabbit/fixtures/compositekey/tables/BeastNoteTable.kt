...
class BeastNoteTable : Iterable<BeastNoteRecord> {
     ...
     */
    override fun iterator(): Iterator<BeastNoteRecord> = records.iterator()
     ...
     * The row with this BeastId, or null when the table has none.
     *
     * findByBeastId under the spelling Kotlin uses for a keyed collection. It
     ...
     */
    operator fun get(key: String): BeastNoteRecord? = findByBeastId(key)
     ...
     */
    val entries: Sequence<Pair<String, BeastNoteRecord>>
        get() = records.asSequence().map { record -> record.beastId to record }
