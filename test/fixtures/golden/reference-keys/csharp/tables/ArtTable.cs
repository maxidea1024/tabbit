...
{
    [System.Serializable]
    public partial class ArtRecord
    {
        #region Values
        /// <summary>
    ...
    /// </summary>
    [System.Serializable]
    public partial class ArtTable : IEnumerable<ArtRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Path", "Pad1", "Pad2" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Path, r.Pad1, r.Pad2 });
        ...
        /// </remarks>
        public List<ArtRecord> Records => _records;
        private List<ArtRecord> _records = new List<ArtRecord>();
        ...
        /// </remarks>
        public List<ArtRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ArtRecord> IEnumerable<ArtRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<System.Guid, ArtRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<System.Guid, ArtRecord> _recordsByIndex = new Dictionary<System.Guid, ArtRecord>();
        ...
        /// </remarks>
        public ArtRecord FindByIndex(System.Guid key)
            => _recordsByIndex.TryGetValue(key, out ArtRecord record) ? record : null;
        ...
        /// </remarks>
        public ArtRecord GetByIndexOrThrow(System.Guid key)
        {
            if (!_recordsByIndex.TryGetValue(key, out ArtRecord record))
                throw new TabbitException($"There is no record in table `Art` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<ArtRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ArtRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (System.Guid Key, ArtRecord Row) Current
        ...
        /// </remarks>
        public ArtRecord this[System.Guid key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ArtRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Art.Index", TcbTable.KindScalar, false, TcbTable.ElementUuid);
                        for (int i = 0; i < count; i++)
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Art.Path", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Art.Path");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Art.Pad1", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Art.Pad1");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Art.Pad2", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Art.Pad2");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<System.Guid, ArtRecord>(count);
