...
namespace Tabbit.Fixtures.Bitset
{
    ...
    public partial class FlagsTable : IEnumerable<FlagsRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Mask", "Same", "Set", "Label" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Mask, r.Same, r.Set, r.Label });
        ...
        {
            var bytes = await BitsetAccessor.ReadAllBytesAsync(filename);

            // Unconditionally, and with whatever `BitsetAccessor.EncryptionKey` and `BitsetAccessor.MacKey`
            ...
            var reader = new TcbReader(TcbTable.Open(
                bytes, BitsetAccessor.EncryptionKey, BitsetAccessor.MacKey, BitsetAccessor.VerifyMac));
                ...
                switch (column.Tag)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._set = new long[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._set[j] = cursor.NextI64();
                            }
                        }
                        break;
