...
namespace Tabbit.Fixtures.NestedDeep
{
    ...
    public partial class DeepTable : IEnumerable<DeepRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Star" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Star });
        ...
        {
            var bytes = await NestedDeepAccessor.ReadAllBytesAsync(filename);

            // Unconditionally, and with whatever `NestedDeepAccessor.EncryptionKey` and `NestedDeepAccessor.MacKey`
            ...
            var reader = new TcbReader(TcbTable.Open(
                bytes, NestedDeepAccessor.EncryptionKey, NestedDeepAccessor.MacKey, NestedDeepAccessor.VerifyMac));
