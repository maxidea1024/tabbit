...
/// Every row of Deep.
class DeepTable extends Iterable<DeepRecord> {
  ...
  @override
  Iterator<DeepRecord> get iterator => _records.iterator;
  ...
  DeepRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, DeepRecord>> get entries =>
