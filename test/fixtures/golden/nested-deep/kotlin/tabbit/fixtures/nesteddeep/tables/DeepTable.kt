...
/** Every row of Deep. */
class DeepTable : Iterable<DeepRecord> {
     ...
     */
    override fun iterator(): Iterator<DeepRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): DeepRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Int, DeepRecord>>
