...
object NestedDeepAccessor {
    var deep: DeepTable = DeepTable()
        private set
    ...
    fun readAll(basePath: String, fileExtension: String = ".tcb") {
        val loadedDeepTable = DeepTable()
        loadedDeepTable.read(File(basePath, "Deep$fileExtension").path)
     ...
     */
    private fun solveCrossReferences(deep: DeepTable) {
