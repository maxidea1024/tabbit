...
impl DeepTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, DeepRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &DeepRecord)> + '_ {
...
impl<'a> IntoIterator for &'a DeepTable {
    type Item = &'a DeepRecord;
    type IntoIter = std::slice::Iter<'a, DeepRecord>;
