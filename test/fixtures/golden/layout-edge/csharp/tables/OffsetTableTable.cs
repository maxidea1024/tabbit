...
{
    [System.Serializable]
    public partial class OffsetTableRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    /// </summary>
    [System.Serializable]
    public partial class OffsetTableTable : IEnumerable<OffsetTableRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<OffsetTableRecord> Records => _records;
        private List<OffsetTableRecord> _records = new List<OffsetTableRecord>();
        ...
        /// </remarks>
        public List<OffsetTableRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<OffsetTableRecord> IEnumerable<OffsetTableRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, OffsetTableRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, OffsetTableRecord> _recordsByIndex = new Dictionary<int, OffsetTableRecord>();
        ...
        /// </remarks>
        public OffsetTableRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out OffsetTableRecord record) ? record : null;
        ...
        /// </remarks>
        public OffsetTableRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out OffsetTableRecord record))
                throw new TabbitException($"There is no record in table `OffsetTable` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<OffsetTableRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<OffsetTableRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, OffsetTableRecord Row) Current
        ...
        /// </remarks>
        public OffsetTableRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<OffsetTableRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new OffsetTableRecord());
            ...
            var recordsByIndex = new Dictionary<int, OffsetTableRecord>(count);
