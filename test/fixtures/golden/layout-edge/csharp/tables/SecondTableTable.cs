...
{
    [System.Serializable]
    public partial class SecondTableRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    /// </summary>
    [System.Serializable]
    public partial class SecondTableTable : IEnumerable<SecondTableRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<SecondTableRecord> Records => _records;
        private List<SecondTableRecord> _records = new List<SecondTableRecord>();
        ...
        /// </remarks>
        public List<SecondTableRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<SecondTableRecord> IEnumerable<SecondTableRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, SecondTableRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, SecondTableRecord> _recordsByIndex = new Dictionary<int, SecondTableRecord>();
        ...
        /// </remarks>
        public SecondTableRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out SecondTableRecord record) ? record : null;
        ...
        /// </remarks>
        public SecondTableRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out SecondTableRecord record))
                throw new TabbitException($"There is no record in table `SecondTable` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<SecondTableRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<SecondTableRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, SecondTableRecord Row) Current
        ...
        /// </remarks>
        public SecondTableRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<SecondTableRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new SecondTableRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "SecondTable.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SecondTable.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "SecondTable.Label", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "SecondTable.Label");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "SecondTable.Amount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SecondTable.Amount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<int, SecondTableRecord>(count);
