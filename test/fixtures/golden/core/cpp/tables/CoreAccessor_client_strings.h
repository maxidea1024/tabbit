...
#ifndef TABBIT_GENERATED_COREACCESSOR_CLIENT_STRINGS_H
#define TABBIT_GENERATED_COREACCESSOR_CLIENT_STRINGS_H
...
class ClientStringsTable {
 public:
  ...
  typename std::vector<ClientStringsRecord>::const_iterator begin() const {
    return records_.begin();
  }

  typename std::vector<ClientStringsRecord>::const_iterator end() const {
    return records_.end();
  }
...
#endif  // TABBIT_GENERATED_COREACCESSOR_CLIENT_STRINGS_H
