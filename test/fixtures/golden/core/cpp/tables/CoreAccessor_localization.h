...
#ifndef TABBIT_GENERATED_COREACCESSOR_LOCALIZATION_H
#define TABBIT_GENERATED_COREACCESSOR_LOCALIZATION_H
  ...
  void read(const std::string& filename) {
    ...
    for (const tabbit::Column& column : header.columns) {
      ...
      switch (column.tag) {
        ...
        case 3: {
          tabbit::check_column(column, "Localization.TextEn_array", tabbit::kKindFixedArray, 2, false, {tabbit::kElementString});
        ...
        case 4: {
          tabbit::check_column(column, "Localization.TextKo_array", tabbit::kKindFixedArray, 2, false, {tabbit::kElementString});
...
#endif  // TABBIT_GENERATED_COREACCESSOR_LOCALIZATION_H
