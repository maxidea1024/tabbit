...
#ifndef TABBIT_GENERATED_COREACCESSOR_ARRAY_TYPES_H
#define TABBIT_GENERATED_COREACCESSOR_ARRAY_TYPES_H
...
class ArrayTypesTable {
 public:
  ...
  typename std::vector<ArrayTypesRecord>::const_iterator begin() const {
    return records_.begin();
  }

  typename std::vector<ArrayTypesRecord>::const_iterator end() const {
    return records_.end();
  }
      ...
      switch (column.tag) {
        ...
        case 4: {
          ...
          for (std::size_t i = 0; i < row_count; ++i) {
            ...
            for (std::int32_t j = 0; j < element_count; ++j) {
              record.weights[static_cast<std::size_t>(j)] = cursor.next_f32();
            }
          }
          break;
        }
        case 5: {
          ...
          for (std::size_t i = 0; i < row_count; ++i) {
            ...
            for (std::int32_t j = 0; j < element_count; ++j) {
              record.grades[static_cast<std::size_t>(j)] = static_cast<Grade>(cursor.next_i32());
            }
          }
          break;
        }
...
#endif  // TABBIT_GENERATED_COREACCESSOR_ARRAY_TYPES_H
