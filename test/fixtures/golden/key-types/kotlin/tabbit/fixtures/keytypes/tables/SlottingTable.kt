...
class SlottingTable : Iterable<SlottingRecord> {
     ...
     */
    override fun iterator(): Iterator<SlottingRecord> = records.iterator()
     ...
     */
    operator fun get(key: Slot): SlottingRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Slot, SlottingRecord>>
