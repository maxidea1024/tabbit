...
/** Every row of Asset. */
class AssetTable : Iterable<AssetRecord> {
     ...
     */
    override fun iterator(): Iterator<AssetRecord> = records.iterator()
     ...
     */
    operator fun get(key: Uuid): AssetRecord? = findByIndex(key)
     ...
     */
    val entries: Sequence<Pair<Uuid, AssetRecord>>
