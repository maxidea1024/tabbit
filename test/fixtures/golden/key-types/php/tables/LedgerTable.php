...
/** Every row of Ledger. */
final class LedgerTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, LedgerRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?LedgerRecord
    {
    ...
    {
        throw new \LogicException('LedgerTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, LedgerRecord>
     */
