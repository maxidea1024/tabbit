...
final class SlottingTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, SlottingRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?SlottingRecord
    {
    ...
    {
        throw new \LogicException('SlottingTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, SlottingRecord>
     */
