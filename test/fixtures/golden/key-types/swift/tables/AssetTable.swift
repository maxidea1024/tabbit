...
/// Every row of Asset.
public final class AssetTable: Sequence {
    ...
    public func makeIterator() -> Array<AssetRecord>.Iterator {
    ...
    public subscript(_ key: Tcb.Uuid) -> AssetRecord? {
        findByIndex(key)
    }
    ...
    /// row with.
    public var entries: LazyMapSequence<[AssetRecord], (key: Tcb.Uuid, row: AssetRecord)> {
