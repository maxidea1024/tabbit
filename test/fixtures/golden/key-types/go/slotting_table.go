...
func (t *SlottingTable) All() iter.Seq[*SlottingRecord] {
	records := t.records

	return func(yield func(*SlottingRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *SlottingTable) Entries() iter.Seq2[Slot, *SlottingRecord] {
	records := t.records

	return func(yield func(Slot, *SlottingRecord) bool) {
		for i := range records {
