...
/// Every row of Asset.
class AssetTable extends Iterable<AssetRecord> {
  ...
  @override
  Iterator<AssetRecord> get iterator => _records.iterator;
  ...
  AssetRecord? operator [](Uuid key) => findByIndex(key);
  ...
  Iterable<MapEntry<Uuid, AssetRecord>> get entries =>
