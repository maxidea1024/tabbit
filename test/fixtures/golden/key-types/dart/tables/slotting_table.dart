...
class SlottingTable extends Iterable<SlottingRecord> {
  ...
  @override
  Iterator<SlottingRecord> get iterator => _records.iterator;
  ...
  SlottingRecord? operator [](Slot key) => findByIndex(key);
  ...
  Iterable<MapEntry<Slot, SlottingRecord>> get entries =>
