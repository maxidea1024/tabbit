...
namespace Tabbit.Fixtures.KeyTypes
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class AssetTable : IEnumerable<AssetRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<AssetRecord> Records => _records;
        ...
        /// </remarks>
        public List<AssetRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<AssetRecord> IEnumerable<AssetRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<System.Guid, AssetRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<System.Guid, AssetRecord> _recordsByIndex = new Dictionary<System.Guid, AssetRecord>();
        ...
        /// </remarks>
        public AssetRecord FindByIndex(System.Guid key)
            => _recordsByIndex.TryGetValue(key, out AssetRecord record) ? record : null;
        ...
        /// </remarks>
        public AssetRecord GetByIndexOrThrow(System.Guid key)
        {
            if (!_recordsByIndex.TryGetValue(key, out AssetRecord record))
        ...
        {
            private readonly List<AssetRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<AssetRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (System.Guid Key, AssetRecord Row) Current
        ...
        /// </remarks>
        public AssetRecord this[System.Guid key] => GetByIndexOrThrow(key);

        #region Indexing by 'Slot'
        public Dictionary<global::Tabbit.Fixtures.KeyTypes.Slot, AssetRecord> RecordsBySlot => _recordsBySlot;
        private Dictionary<global::Tabbit.Fixtures.KeyTypes.Slot, AssetRecord> _recordsBySlot = new Dictionary<global::Tabbit.Fixtures.KeyTypes.Slot, AssetRecord>();
        ...
        /// this one under the same name.
        /// </remarks>
        public AssetRecord FindBySlot(global::Tabbit.Fixtures.KeyTypes.Slot key)
            => _recordsBySlot.TryGetValue(key, out AssetRecord record) ? record : null;
        ...
        /// a glance cannot otherwise tell whether the next line is a null check or a catch.
        /// </remarks>
        public AssetRecord GetBySlotOrThrow(global::Tabbit.Fixtures.KeyTypes.Slot key)
        {
            if (!_recordsBySlot.TryGetValue(key, out AssetRecord record))
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var recordsByIndex = new Dictionary<System.Guid, AssetRecord>(count);
            foreach (var record in records)
                recordsByIndex.Add(record.Index, record);
            var recordsBySlot = new Dictionary<global::Tabbit.Fixtures.KeyTypes.Slot, AssetRecord>(count);
            foreach (var record in records)
