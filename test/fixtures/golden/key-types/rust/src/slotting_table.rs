...
impl SlottingTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, SlottingRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&Slot, &SlottingRecord)> + '_ {
...
impl<'a> IntoIterator for &'a SlottingTable {
    type Item = &'a SlottingRecord;
    type IntoIter = std::slice::Iter<'a, SlottingRecord>;
