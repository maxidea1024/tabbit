...
namespace Tabbit.Fixtures.StringIndex
{
    ...
    public partial class AnimationTable : IEnumerable<AnimationTable.Record>
    {
        ...
        public Dictionary<int, Record> RecordsBySlot => _recordsBySlot;
        private Dictionary<int, Record> _recordsBySlot = new Dictionary<int, Record>();
        ...
        /// this one under the same name.
        /// </remarks>
        public Record FindBySlot(int key)
        ...
        /// a glance cannot otherwise tell whether the next line is a null check or a catch.
        /// </remarks>
        public Record GetBySlotOrThrow(int key)
        {
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var recordsBySlot = new Dictionary<int, Record>(count);
            foreach (var record in records)
