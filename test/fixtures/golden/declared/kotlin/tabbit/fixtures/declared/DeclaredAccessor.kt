...
object DeclaredAccessor {
    var loadout: LoadoutTable = LoadoutTable()
        private set
    var bonuses: BonusesTable = BonusesTable()
        private set
    var chest: ChestTable = ChestTable()
        private set
    ...
    fun readAll(basePath: String, fileExtension: String = ".tcb") {
        ...
        val loadedBonusesTable = BonusesTable()
        loadedBonusesTable.read(File(basePath, "Bonuses$fileExtension").path)
        val loadedChestTable = ChestTable()
        loadedChestTable.read(File(basePath, "Chest$fileExtension").path)
     ...
     */
    private fun solveCrossReferences(loadout: LoadoutTable, bonuses: BonusesTable, chest: ChestTable) {
