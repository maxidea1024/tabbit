...
namespace Tabbit.Fixtures.Declared
{
    ...
    public partial class LoadoutRecord
    {
        ...
        internal static Reward[] NewRewardArray(int length)
        {
            var result = new Reward[length];
    ...
    public partial class LoadoutTable : IEnumerable<LoadoutRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Name", "Slot", "Grade" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Name, r.Slot, r.Grade });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                switch (column.Tag)
                {
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Loadout.Slot.ItemId", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._slot = LoadoutRecord.NewRewardArray(elementCount);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Loadout.Slot.Icon", TcbTable.KindArray, false, TcbTable.ElementString);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Loadout.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
