...
namespace Tabbit.Fixtures.Declared
{
    ...
    public partial class ChestRecord
    {
        ...
        /// </summary>
        public Reward Prize => _prize;
        #endregion

        /// <summary>One element of <see cref="Prize"/>.</summary>

        private static Reward NewReward()
        {
            var result = default(Reward);
            result.Icon = "";
            return result;
        }
        ...
        #region Storage
        internal int _index;
        internal Reward _prize = NewReward();
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Prize\":"); ToStringHelper.ToString(Prize, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    /// </summary>
    [System.Serializable]
    public partial class ChestTable : IEnumerable<ChestRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Index", "Prize" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Index, r.Prize });
        ...
        /// </remarks>
        public List<ChestRecord> Records => _records;
        private List<ChestRecord> _records = new List<ChestRecord>();
        ...
        /// </remarks>
        public List<ChestRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ChestRecord> IEnumerable<ChestRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Index'
        public Dictionary<int, ChestRecord> RecordsByIndex => _recordsByIndex;
        private Dictionary<int, ChestRecord> _recordsByIndex = new Dictionary<int, ChestRecord>();
        ...
        /// </remarks>
        public ChestRecord FindByIndex(int key)
            => _recordsByIndex.TryGetValue(key, out ChestRecord record) ? record : null;
        ...
        /// </remarks>
        public ChestRecord GetByIndexOrThrow(int key)
        {
            if (!_recordsByIndex.TryGetValue(key, out ChestRecord record))
                throw new TabbitException($"There is no record in table `Chest` that corresponds to field `Index` value {key}");
        ...
        {
            private readonly List<ChestRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ChestRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ChestRecord Row) Current
        ...
        /// </remarks>
        public ChestRecord this[int key] => GetByIndexOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ChestRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ChestRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Chest.Index", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Chest.Index");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Chest.Prize.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Chest.Prize.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._prize.ItemId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Chest.Prize.Count", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Chest.Prize.Count");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._prize.Count = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Chest.Prize.Icon", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Chest.Prize.Icon");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsByIndex = new Dictionary<int, ChestRecord>(count);
