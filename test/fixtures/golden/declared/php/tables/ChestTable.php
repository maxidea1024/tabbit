...
require_once __DIR__ . '/../DeclaredAccessor.php';
...
final class ChestRecord
{
    ...
    {
        $this->prize = new Reward();
    }
}

/** Every row of Chest. */
final class ChestTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ChestRecord> */
     ...
     *
     * @return \Traversable<int, ChestRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?ChestRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): ChestRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?ChestRecord
    {
    ...
    {
        throw new \LogicException('ChestTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ChestRecord>
     */
    ...
    public function read(string $filename): void
    {
        ...
        // so unconditionally, and with whatever DeclaredAccessor::$encryptionKey and
        ...
        $reader = TcbReader::fromFile(
            $filename, DeclaredAccessor::$encryptionKey,
