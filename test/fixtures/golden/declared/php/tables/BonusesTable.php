...
final class BonusesTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<BonusesRecord> */
     ...
     *
     * @return \Traversable<int, BonusesRecord>
     */
     ...
     */
    public function findByIndex(int $key): ?BonusesRecord
    {
     ...
     */
    public function getByIndexOrThrow(int $key): BonusesRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?BonusesRecord
    {
    ...
    {
        throw new \LogicException('BonusesTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, BonusesRecord>
     */
        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                ...
                case 3:
                    ...
                    foreach ($records as $record) {
                        $elementCount = $cursor->nextLength();
                        if (\count($record->bonus) !== $elementCount) {
