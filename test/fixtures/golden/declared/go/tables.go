...
func (t *Tables) ReadAllWithExtension(basePath string, fileExtension string) error {
	...
	if err := loaded.Bonuses.Read(filepath.Join(basePath, "Bonuses"+fileExtension)); err != nil {
		return err
	}
	if err := loaded.Chest.Read(filepath.Join(basePath, "Chest"+fileExtension)); err != nil {
		return err
	}
