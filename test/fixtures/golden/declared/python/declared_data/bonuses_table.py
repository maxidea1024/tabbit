...
class BonusesRecord:
    ...
    def __repr__(self):
        return "BonusesRecord(index=%r, bonus=%r)" % (self.index, self.bonus)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Bonuses.Bonus.StatId")
                for record in records:
                    ...
                    record.bonus = [
                        Bonus() for _ in range(element_count)]
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Bonuses.Bonus.Amount")
                for record in records:
                    element_count = cursor.next_length()
                    if len(record.bonus) != element_count:
