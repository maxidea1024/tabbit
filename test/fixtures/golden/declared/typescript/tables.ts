...
export class Tables {
  ...
  /** Peroperty for table Bonuses */
  public get bonuses(): BonusesTable { return this._bonuses }
  private _bonuses: BonusesTable = new BonusesTable()

  /** Peroperty for table Chest */
  public get chest(): ChestTable { return this._chest }
   ...
   */
  private publish(loadout: LoadoutTable, bonuses: BonusesTable, chest: ChestTable): void {
