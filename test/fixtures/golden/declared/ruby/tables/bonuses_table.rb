...
require_relative '../structs/reward'

require_relative '../structs/bonus'
...
module DeclaredData
  ...
  class BonusesTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { BonusesRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Bonuses.Index')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Bonuses.Bonus.StatId')
          records.each do |record|
            ...
            record.bonus = Array.new(element_count) { Bonus.new }
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Bonuses.Bonus.Amount')
          records.each do |record|
            element_count = cursor.next_length
            if record.bonus.length != element_count
