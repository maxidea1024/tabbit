...
class LoadoutRecord {
  ...
  List<Reward> slot = List.generate(2, (_) => Reward());
  /// an enum the schema file declares
  Affinity grade = Affinity.of(0);
...
class LoadoutTable extends Iterable<LoadoutRecord> {
  ...
  LoadoutRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, LoadoutRecord>> get entries =>
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        ...
        case 2:
          ...
          break;
        case 3:
          checkColumn(column, 'Loadout.Slot.ItemId', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Loadout.Slot.ItemId');
          for (final record in loaded) {
            ...
            record.slot =
                List.generate(elementCount, (_) => Reward());
        ...
        case 4:
          ...
          break;
        case 5:
          checkColumn(column, 'Loadout.Slot.Icon', kindArray, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Loadout.Slot.Icon');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            if (record.slot.length != elementCount) {
              throw TcbException(
          ...
          break;
        case 6:
          checkColumn(column, 'Loadout.Grade', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Loadout.Grade');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].grade = Affinity.of(value);
            }
          }
          break;
        default:
