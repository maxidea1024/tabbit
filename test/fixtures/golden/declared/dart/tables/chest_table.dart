...
/// Every row of Chest.
class ChestTable extends Iterable<ChestRecord> {
  ...
  List<ChestRecord> get records => _records;
  List<ChestRecord> _records = [];
  ...
  @override
  Iterator<ChestRecord> get iterator => _records.iterator;

  Map<int, ChestRecord> _byIndex = {};

  /// The row with this Index, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ChestRecord? findByIndex(int key) => _byIndex[key];
  ...
  ChestRecord getByIndexOrThrow(int key) {
  ...
  ChestRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, ChestRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ChestRecord>[];
    final loadedByIndex = <int, ChestRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ChestRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Chest.Index', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chest.Index');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Chest.Prize.ItemId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chest.Prize.ItemId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].prize.itemId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'Chest.Prize.Count', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chest.Prize.Count');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].prize.count = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'Chest.Prize.Icon', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Chest.Prize.Icon');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].prize.icon = value;
            }
          }
          break;
        default:
