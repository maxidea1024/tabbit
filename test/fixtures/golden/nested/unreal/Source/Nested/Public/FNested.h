...
#include "FNested.generated.h"


// Generated from test/fixtures/xlsx/nested/nested.xlsx : Nested : B2
/** One element of FLoadoutRow::Pos. */
USTRUCT(BlueprintType)
struct NESTED_API FLoadoutPosEntry
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct NESTED_API FLoadoutSlotEntry
{
    GENERATED_BODY()
...
class NESTED_API FLoadoutTable
{
public:
 ...
 */
UCLASS()
class NESTED_API UNestedLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
...
public:
    ...
    /**
     * Reads every table from BasePath, as FNested::ReadAll does.
     *
