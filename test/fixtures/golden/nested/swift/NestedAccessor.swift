...
public final class NestedAccessor {
    ...
    public func readAll(
        ...
        NestedAccessor.solveCrossReferences(loadout: loadedLoadoutTable)
    ...
    private static func solveCrossReferences(loadout: LoadoutTable) {
