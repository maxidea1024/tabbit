...
/// Every row of Guide.
class GuideTable extends Iterable<GuideRecord> {
  ...
  @override
  Iterator<GuideRecord> get iterator => _records.iterator;
  ...
  GuideRecord? operator [](int key) => findByIndex(key);
  ...
  Iterable<MapEntry<int, GuideRecord>> get entries =>
