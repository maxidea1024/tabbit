...
class GuideRecord:
    ...
    __slots__ = ("index", "name", "skill", "pos", "tag_array", "grid")
    ...
    def __repr__(self):
        return "GuideRecord(index=%r, name=%r, skill=%r, pos=%r, tag_array=%r, grid=%r)" % (self.index, self.name, self.skill, self.pos, self.tag_array, self.grid)
