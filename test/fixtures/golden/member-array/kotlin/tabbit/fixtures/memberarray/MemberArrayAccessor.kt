...
object MemberArrayAccessor {
    var guide: GuideTable = GuideTable()
        private set
    ...
    fun readAll(basePath: String, fileExtension: String = ".tcb") {
        val loadedGuideTable = GuideTable()
        loadedGuideTable.read(File(basePath, "Guide$fileExtension").path)
     ...
     */
    private fun solveCrossReferences(guide: GuideTable) {
