...
/** Every row of Guide. */
public final class GuideTable implements Iterable<GuideRecord> {
     ...
     */
    @Override
    public Iterator<GuideRecord> iterator() {
     ...
     */
    public Iterable<Map.Entry<Integer, GuideRecord>> entries() {
        final List<GuideRecord> rows = records;

        return () -> new Iterator<Map.Entry<Integer, GuideRecord>>() {
            private final Iterator<GuideRecord> source = rows.iterator();
            ...
            @Override
            public Map.Entry<Integer, GuideRecord> next() {
                final GuideRecord row = source.next();
