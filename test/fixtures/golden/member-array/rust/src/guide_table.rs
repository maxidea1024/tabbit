...
impl GuideTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, GuideRecord> {
        self.records.iter()
    }
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &GuideRecord)> + '_ {
...
impl<'a> IntoIterator for &'a GuideTable {
    type Item = &'a GuideRecord;
    type IntoIter = std::slice::Iter<'a, GuideRecord>;
