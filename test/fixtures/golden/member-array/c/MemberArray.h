...
#ifndef MEMBER_ARRAY_H
#define MEMBER_ARRAY_H
...
typedef struct MemberArray_t {
  MemberArray_GuideTable_t guide;
} MemberArray_t;

/* Reads every table from base_path, then links the references between them.
 *
 * Declare the struct zeroed - `MemberArray_t data = {0};` - and this is safe to
