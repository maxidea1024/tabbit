...
func (t *GuideTable) Count() int { return len(t.records) }
...
func (t *GuideTable) All() iter.Seq[*GuideRecord] {
	records := t.records

	return func(yield func(*GuideRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *GuideTable) Entries() iter.Seq2[int32, *GuideRecord] {
	records := t.records

	return func(yield func(int32, *GuideRecord) bool) {
		for i := range records {
