...
/// Every row of Goods.
class GoodsTable extends Iterable<GoodsRecord> {
  ...
  List<GoodsRecord> get records => _records;
  List<GoodsRecord> _records = [];
  ...
  @override
  Iterator<GoodsRecord> get iterator => _records.iterator;

  Map<int, GoodsRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  GoodsRecord? findById(int key) => _byId[key];
  ...
  GoodsRecord getByIdOrThrow(int key) {
  ...
  GoodsRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, GoodsRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <GoodsRecord>[];
    final loadedById = <int, GoodsRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(GoodsRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Goods.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Goods.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Goods.Name', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Goods.Name');
          for (var i = 0; i < count; ) {
