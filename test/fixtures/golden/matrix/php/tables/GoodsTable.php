...
/** Every row of Goods. */
final class GoodsTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<GoodsRecord> */
     ...
     *
     * @return \Traversable<int, GoodsRecord>
     */
     ...
     */
    public function findById(int $key): ?GoodsRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): GoodsRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?GoodsRecord
    {
    ...
    {
        throw new \LogicException('GoodsTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, GoodsRecord>
     */
