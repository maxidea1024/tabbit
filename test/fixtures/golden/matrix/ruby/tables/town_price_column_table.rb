...
module MatrixData
  ...
  class TownPriceColumnRecord
    attr_accessor :goods, :goods_by_goods, :at
  ...
  class TownPriceColumnTable
    ...
    # The row with this Goods, or nil when the table has none.
    #
    # find_by_goods under the spelling Ruby uses for a keyed collection. It
    ...
    def each_pair
      ...
      @records.each { |record| yield record.goods, record }
      self
    end
    ...
    def read(filename)
      ...
      records = Array.new(count) { TownPriceColumnRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'TownPriceColumn.Goods')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'TownPriceColumn.At')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
      ...
      by_goods = records.to_h { |record| [record.goods, record] }
