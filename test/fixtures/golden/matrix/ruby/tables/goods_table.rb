...
module MatrixData
  ...
  class GoodsTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { GoodsRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Goods.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'Goods.Name')
          at = 0
          while at < count
