...
namespace Tabbit.Fixtures.Matrix
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class ElementChartColumnTable : IEnumerable<ElementChartColumnRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Defender", "At" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Defender, r.At });
        ...
        /// </remarks>
        public List<ElementChartColumnRecord> Records => _records;
        private List<ElementChartColumnRecord> _records = new List<ElementChartColumnRecord>();
        ...
        /// </remarks>
        public List<ElementChartColumnRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ElementChartColumnRecord> IEnumerable<ElementChartColumnRecord>.GetEnumerator() => _records.GetEnumerator();
        ...
        /// <summary>
        /// The row with this `Defender`, or a thrown exception naming what was
        /// missing.
        /// </summary>
        /// <remarks>
        ...
        /// `Defender` here, something else in the next table.
        ///
        ...
        {
            private readonly List<ElementChartColumnRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ElementChartColumnRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
        ...
        /// </summary>
        /// <remarks>
        /// `GetByDefenderOrThrow` under the spelling the language uses for a
        ...
        /// `Defender` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ElementChartColumnRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ElementChartColumnRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "ElementChartColumn.Defender", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "ElementChartColumn.At", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            _records = records;
            _recordsByDefender = recordsByDefender;
