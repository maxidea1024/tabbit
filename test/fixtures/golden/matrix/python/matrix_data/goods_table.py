...
class GoodsRecord:
    ...
    def __repr__(self):
        return "GoodsRecord(id=%r, name=%r)" % (self.id, self.name)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Goods.Name")
                at = 0
                while at < count:
