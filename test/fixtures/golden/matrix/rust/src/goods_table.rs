...
impl GoodsTable {
    ...
    pub fn records(&self) -> &[GoodsRecord] {
        &self.records
    }
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, GoodsRecord> {
        self.records.iter()
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&GoodsRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> tabbit::Result<&GoodsRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &GoodsRecord)> + '_ {
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![GoodsRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    tabbit::check_column(column, "Goods.Id", tabbit::KIND_SCALAR, false, &[tabbit::ELEMENT_I32, tabbit::ELEMENT_VARINT])?;
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Goods.Id")?;
                    let mut at = 0usize;
                ...
                2 => {
                    tabbit::check_column(column, "Goods.Name", tabbit::KIND_SCALAR, false, &[tabbit::ELEMENT_STRING])?;
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Goods.Name")?;
                    let mut at = 0usize;
                    while at < records.len() {
...
impl<'a> IntoIterator for &'a GoodsTable {
    type Item = &'a GoodsRecord;
    type IntoIter = std::slice::Iter<'a, GoodsRecord>;
