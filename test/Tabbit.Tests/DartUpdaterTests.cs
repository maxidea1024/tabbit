...
///
/// The file under test is the shipped one - lib/dart/tabbit/updater.dart - copied
...
public class DartUpdaterTests : IDisposable
{
    ...
    private string Stage()
    {
        ...
        File.Copy(Path.Combine(RepoLayout.Root, "lib", "dart", "tabbit", "updater.dart"),
                  Path.Combine(work, "tabbit", "updater.dart"), overwrite: true);
