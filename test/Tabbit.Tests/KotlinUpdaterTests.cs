...
///
/// The file under test is the shipped one - lib/kotlin/tabbit/TabbitUpdater.kt -
...
public class KotlinUpdaterTests : IDisposable
{
    ...
    private string Stage()
    {
        ...
        File.Copy(Path.Combine(RepoLayout.Root, "lib", "kotlin", "tabbit", "TabbitUpdater.kt"),
                  Path.Combine(work, "tabbit", "TabbitUpdater.kt"), overwrite: true);
