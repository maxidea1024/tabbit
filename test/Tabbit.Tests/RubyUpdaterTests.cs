...
///
/// The file under test is the shipped one - lib/ruby/tabbit/updater.rb - copied into
...
public class RubyUpdaterTests : IDisposable
{
    ...
    private string Stage()
    {
        ...
        File.Copy(Path.Combine(RepoLayout.Root, "lib", "ruby", "tabbit", "updater.rb"),
                  Path.Combine(work, "tabbit", "updater.rb"), overwrite: true);
