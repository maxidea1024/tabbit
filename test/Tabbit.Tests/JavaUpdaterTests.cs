...
///
/// The file under test is the shipped one - lib/java/tabbit/TabbitUpdater.java -
...
public class JavaUpdaterTests : IDisposable
{
    ...
    private string Stage()
    {
        ...
        File.Copy(Path.Combine(RepoLayout.Root, "lib", "java", "tabbit", "TabbitUpdater.java"),
                  Path.Combine(work, "tabbit", "TabbitUpdater.java"), overwrite: true);
