...
namespace Wildling.Data
{
    ...
    public partial class CurrencyTable : IEnumerable<CurrencyTable.Record>
    {
        ...
        /// <summary>Each row with the `CurrencyId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `CurrencyId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByCurrencyIdOrThrow` under the spelling the language uses for a
        ...
        /// `CurrencyId` is 0, not the first row - the rows in order are
