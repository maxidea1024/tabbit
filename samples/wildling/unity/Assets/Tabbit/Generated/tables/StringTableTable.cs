...
namespace Wildling.Data
{
    ...
    public partial class StringTableTable : IEnumerable<StringTableTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "StringId", "Ko", "En", "Ja" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.StringId, r.Ko, r.En, r.Ja });
        ...
        /// <summary>Whether the table holds a row with this `StringId`.</summary>
        public bool ContainsStringId(string key) => _recordsByStringId.ContainsKey(key);
        #endregion // Indexing by `StringId`

        /// <summary>Each row with the `StringId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `StringId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByStringIdOrThrow` under the spelling the language uses for a
        ...
        /// `StringId` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "StringTable.StringId", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "StringTable.StringId");
                        for (int i = 0; i < count; )
                        {
                            ...
                            do
                            {
                                ...
                                record._stringId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 2:
                        TcbTable.CheckColumn(column, "StringTable.Ko", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "StringTable.Ko");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "StringTable.En", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "StringTable.En");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            _records = records;
            _recordsByStringId = recordsByStringId;
