...
namespace Wildling.Data
{
    ...
    public partial class ItemTable : IEnumerable<ItemRecord>
    {
        ...
        /// <summary>Each row with the `ItemId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `ItemId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByItemIdOrThrow` under the spelling the language uses for a
        ...
        /// `ItemId` is 0, not the first row - the rows in order are
