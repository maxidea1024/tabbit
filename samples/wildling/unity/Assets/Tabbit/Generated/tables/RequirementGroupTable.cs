...
{
    [System.Serializable]
    public partial class RequirementGroupRecord
    {
        #region Values
        /// <summary>
        /// 식별자
    ...
    /// </summary>
    [System.Serializable]
    public partial class RequirementGroupTable : IEnumerable<RequirementGroupRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<RequirementGroupRecord> Records => _records;
        private List<RequirementGroupRecord> _records = new List<RequirementGroupRecord>();
        ...
        /// </remarks>
        public List<RequirementGroupRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<RequirementGroupRecord> IEnumerable<RequirementGroupRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'RequirementGroupId'
        public Dictionary<string, RequirementGroupRecord> RecordsByRequirementGroupId => _recordsByRequirementGroupId;
        private Dictionary<string, RequirementGroupRecord> _recordsByRequirementGroupId = new Dictionary<string, RequirementGroupRecord>();
        ...
        /// </remarks>
        public RequirementGroupRecord FindByRequirementGroupId(string key)
            => _recordsByRequirementGroupId.TryGetValue(key, out RequirementGroupRecord record) ? record : null;
        ...
        /// </remarks>
        public RequirementGroupRecord GetByRequirementGroupIdOrThrow(string key)
        {
            if (!_recordsByRequirementGroupId.TryGetValue(key, out RequirementGroupRecord record))
        ...
        /// <summary>Each row with the `RequirementGroupId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `RequirementGroupId` here, something else in the next table.
        ///
        ...
        {
            private readonly List<RequirementGroupRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<RequirementGroupRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (string Key, RequirementGroupRecord Row) Current
                => (_rows[_at].RequirementGroupId, _rows[_at]);
        }
        ...
        /// </summary>
        /// <remarks>
        /// `GetByRequirementGroupIdOrThrow` under the spelling the language uses for a
        ...
        /// `RequirementGroupId` is 0, not the first row - the rows in order are
        /// `Records`. Nothing in the type says which, which is why the table itself is not
        /// subscriptable by position anywhere.
        ///
        /// It does not replace `FindByRequirementGroupId`: a key that may be absent
        /// wants the one whose name says a miss is an ordinary answer.
        /// </remarks>
        public RequirementGroupRecord this[string key] => GetByRequirementGroupIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<RequirementGroupRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new RequirementGroupRecord());
            ...
            var recordsByRequirementGroupId = new Dictionary<string, RequirementGroupRecord>(count);
