...
namespace Wildling.Data
{
    ...
    public partial class MissionTable : IEnumerable<MissionTable.Record>
    {
        ...
        /// <summary>Each row with the `MissionId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `MissionId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByMissionIdOrThrow` under the spelling the language uses for a
        ...
        /// `MissionId` is 0, not the first row - the rows in order are
