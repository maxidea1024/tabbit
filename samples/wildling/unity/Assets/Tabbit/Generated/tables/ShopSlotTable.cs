...
namespace Wildling.Data
{
    ...
    public partial class ShopSlotTable : IEnumerable<ShopSlotRecord>
    {
        ...
        /// <summary>Each row with the `ShopSlotId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `ShopSlotId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByShopSlotIdOrThrow` under the spelling the language uses for a
        ...
        /// `ShopSlotId` is 0, not the first row - the rows in order are
