...
namespace Wildling.Data
{
    ...
    public partial class MonsterTable : IEnumerable<MonsterRecord>
    {
        ...
        /// <summary>Each row with the `MonsterId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `MonsterId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByMonsterIdOrThrow` under the spelling the language uses for a
        ...
        /// `MonsterId` is 0, not the first row - the rows in order are
