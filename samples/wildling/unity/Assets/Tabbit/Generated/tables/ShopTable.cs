...
namespace Wildling.Data
{
    ...
    public partial class ShopTable : IEnumerable<ShopTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "ShopId", "Name", "RefreshHours" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.ShopId, r.Name, r.RefreshHours });
        ...
        /// <summary>Whether the table holds a row with this `ShopId`.</summary>
        public bool ContainsShopId(string key) => _recordsByShopId.ContainsKey(key);
        #endregion // Indexing by `ShopId`

        /// <summary>Each row with the `ShopId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `ShopId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByShopIdOrThrow` under the spelling the language uses for a
        ...
        /// `ShopId` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Shop.ShopId", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Shop.ShopId");
                        for (int i = 0; i < count; )
                        {
            ...
            _records = records;
            _recordsByShopId = recordsByShopId;
