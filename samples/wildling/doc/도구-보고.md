...
|~~[9](#9-string-셀-배열--c-생성기만-스칼라로-봅니다)~~|~~`string[]` 셀 배열~~|**닫힘** — 2026-08-25|
|[10](#10-기본-인덱스가-참조일-때의-조회-표면)|**기본 인덱스가 참조일 때의 조회 표면**|**막음**|
...
**게이트 제안.** 기본 인덱스가 `foreign` 인 테이블을 시나리오에 하나 두는 것입니다. 연결
