...
`doc/tool-findings.md` 의 항목이 고쳐졌는지 확인하는 절차이기도 합니다 — 우회를 되돌릴 수 있게
되면 그 항목이 닫힙니다.

    python samples/wildling/design-data/tools/verify.py            # 전부
    python samples/wildling/design-data/tools/verify.py --list      # 검사 목록만
