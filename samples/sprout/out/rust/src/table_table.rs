...
impl TableTable {
    ...
    pub fn iter(&self) -> std::slice::Iter<'_, TableRecord> {
        self.records.iter()
    }
    ...
    pub fn find_by_id(&self, key: i32) -> Option<&TableRecord> {
    ...
    /// error it returns.
    pub fn get_by_id_or_error(&self, key: i32) -> tabbit::Result<&TableRecord> {
        self.by_id
            .get(&key)
    ...
    pub fn entries(&self) -> impl Iterator<Item = (&i32, &TableRecord)> + '_ {
    ...
    pub fn read(&mut self, filename: &Path) -> tabbit::Result<()> {
        ...
        let mut records = vec![TableRecord::default(); count];
        ...
        for column in &header.columns {
            ...
            match column.tag {
                1 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Table.Id")?;
                    let mut at = 0usize;
                ...
                2 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Table.NameKey")?;
                    let mut at = 0usize;
                    while at < records.len() {
                ...
                3 => {
                    ...
                    let mut cursor = tabbit::TcbColumnCursor::new(&mut reader, column, header.row_count, "Table.Value")?;
                    let mut at = 0usize;
                    while at < records.len() {
                        let (n, value) = cursor.next_same_i32((records.len() - at) as i32)?;
                        for _ in 0..n {
...
impl<'a> IntoIterator for &'a TableTable {
    type Item = &'a TableRecord;
    type IntoIter = std::slice::Iter<'a, TableRecord>;
