...
class ElementAffinityRecord {
  ...
  int id = 0;
  /// attacking element
  ElementType attacker = ElementType.of(0);
  /// defending element
  ElementType defender = ElementType.of(0);
...
class ElementAffinityTable extends Iterable<ElementAffinityRecord> {
  ...
  List<ElementAffinityRecord> get records => _records;
  List<ElementAffinityRecord> _records = [];
  ...
  @override
  Iterator<ElementAffinityRecord> get iterator => _records.iterator;

  Map<int, ElementAffinityRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ElementAffinityRecord? findById(int key) => _byId[key];
  ...
  ElementAffinityRecord getByIdOrThrow(int key) {
  ...
  ElementAffinityRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ElementAffinityRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ElementAffinityRecord>[];
    final loadedById = <int, ElementAffinityRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ElementAffinityRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'ElementAffinity.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ElementAffinity.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'ElementAffinity.Attacker', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ElementAffinity.Attacker');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].attacker = ElementType.of(value);
            }
          }
          break;
        case 3:
          checkColumn(column, 'ElementAffinity.Defender', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ElementAffinity.Defender');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].defender = ElementType.of(value);
            }
          }
          break;
        case 4:
          checkColumn(column, 'ElementAffinity.Rate', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ElementAffinity.Rate');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].rate = value;
