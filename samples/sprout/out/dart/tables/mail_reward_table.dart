...
class MailRewardTable extends Iterable<MailRewardRecord> {
  ...
  List<MailRewardRecord> get records => _records;
  List<MailRewardRecord> _records = [];
  ...
  @override
  Iterator<MailRewardRecord> get iterator => _records.iterator;

  Map<int, MailRewardRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  MailRewardRecord? findById(int key) => _byId[key];
  ...
  MailRewardRecord getByIdOrThrow(int key) {
  ...
  MailRewardRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, MailRewardRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <MailRewardRecord>[];
    final loadedById = <int, MailRewardRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(MailRewardRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'MailReward.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'MailReward.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'MailReward.TitleKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'MailReward.TitleKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'MailReward.BodyKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'MailReward.BodyKey');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].bodyKey = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'MailReward.RewardId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'MailReward.RewardId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'MailReward.ExpiryDays', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'MailReward.ExpiryDays');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].expiryDays = value;
            }
          }
          break;
        default:
