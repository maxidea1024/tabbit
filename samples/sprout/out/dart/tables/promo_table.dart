...
/// Every row of Promo.
class PromoTable extends Iterable<PromoRecord> {
  ...
  List<PromoRecord> get records => _records;
  List<PromoRecord> _records = [];
  ...
  @override
  Iterator<PromoRecord> get iterator => _records.iterator;

  Map<int, PromoRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  PromoRecord? findById(int key) => _byId[key];
  ...
  PromoRecord getByIdOrThrow(int key) {
  ...
  PromoRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, PromoRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <PromoRecord>[];
    final loadedById = <int, PromoRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(PromoRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Promo.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Promo.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Promo.OfferId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Promo.OfferId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'Promo.Banner', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Promo.Banner');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Promo.AvailableDays', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Promo.AvailableDays');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].availableDays = value;
            }
          }
          break;
        default:
