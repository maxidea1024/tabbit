...
/// Every row of Reward.
class RewardTable extends Iterable<RewardRecord> {
  ...
  List<RewardRecord> get records => _records;
  List<RewardRecord> _records = [];
  ...
  @override
  Iterator<RewardRecord> get iterator => _records.iterator;

  Map<int, RewardRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  RewardRecord? findById(int key) => _byId[key];
  ...
  RewardRecord getByIdOrThrow(int key) {
  ...
  RewardRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, RewardRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <RewardRecord>[];
    final loadedById = <int, RewardRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(RewardRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Reward.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Reward.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Reward.Type', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Reward.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'Reward.LootGroupId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Reward.LootGroupId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'Reward.ItemIds', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Reward.ItemIds');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.itemIds = List.generate(elementCount, (_) => cursor.nextI32());
          }
          break;
        case 5:
          checkColumn(column, 'Reward.ItemCounts', kindArray, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Reward.ItemCounts');
          for (final record in loaded) {
            final elementCount = cursor.nextLength();
            record.itemCounts = List.generate(elementCount, (_) => cursor.nextI32());
          }
          break;
        default:
