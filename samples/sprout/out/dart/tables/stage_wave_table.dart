...
class StageWaveTable extends Iterable<StageWaveRecord> {
  ...
  @override
  Iterator<StageWaveRecord> get iterator => _records.iterator;
  ...
  StageWaveRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, StageWaveRecord>> get entries =>
