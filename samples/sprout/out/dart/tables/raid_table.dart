...
/// Every row of Raid.
class RaidTable extends Iterable<RaidRecord> {
  ...
  List<RaidRecord> get records => _records;
  List<RaidRecord> _records = [];
  ...
  @override
  Iterator<RaidRecord> get iterator => _records.iterator;

  Map<int, RaidRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  RaidRecord? findById(int key) => _byId[key];
  ...
  RaidRecord getByIdOrThrow(int key) {
  ...
  RaidRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, RaidRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <RaidRecord>[];
    final loadedById = <int, RaidRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(RaidRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Raid.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Raid.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Raid.BossId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.BossId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].bossId = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'Raid.BossHealth', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.BossHealth');
          for (final record in loaded) {
            record.bossHealth = cursor.nextI64();
          }
          break;
        case 5:
          checkColumn(column, 'Raid.TurnLimit', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.TurnLimit');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].turnLimit = value;
            }
          }
          break;
        case 6:
          checkColumn(column, 'Raid.SeasonDays', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Raid.SeasonDays');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].seasonDays = value;
            }
          }
          break;
        default:
