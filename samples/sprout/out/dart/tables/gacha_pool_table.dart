...
class GachaPoolTable extends Iterable<GachaPoolRecord> {
  ...
  @override
  Iterator<GachaPoolRecord> get iterator => _records.iterator;
  ...
  GachaPoolRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, GachaPoolRecord>> get entries =>
