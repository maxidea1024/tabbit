...
class AfkBonusTable extends Iterable<AfkBonusRecord> {
  ...
  List<AfkBonusRecord> get records => _records;
  List<AfkBonusRecord> _records = [];
  ...
  @override
  Iterator<AfkBonusRecord> get iterator => _records.iterator;

  Map<int, AfkBonusRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  AfkBonusRecord? findById(int key) => _byId[key];
  ...
  AfkBonusRecord getByIdOrThrow(int key) {
  ...
  AfkBonusRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, AfkBonusRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <AfkBonusRecord>[];
    final loadedById = <int, AfkBonusRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(AfkBonusRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'AfkBonus.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'AfkBonus.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'AfkBonus.Hours', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'AfkBonus.Hours');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].hours = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'AfkBonus.Bonus', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'AfkBonus.Bonus');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
