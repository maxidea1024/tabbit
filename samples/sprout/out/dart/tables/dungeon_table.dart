...
class DungeonRecord {
  ...
  int id = 0;
  /// dungeon kind
  DungeonType type = DungeonType.of(0);
  /// name key
  String nameKey = '';
  /// element
...
class DungeonTable extends Iterable<DungeonRecord> {
  ...
  List<DungeonRecord> get records => _records;
  List<DungeonRecord> _records = [];
  ...
  @override
  Iterator<DungeonRecord> get iterator => _records.iterator;

  Map<int, DungeonRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  DungeonRecord? findById(int key) => _byId[key];
  ...
  DungeonRecord getByIdOrThrow(int key) {
  ...
  DungeonRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, DungeonRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <DungeonRecord>[];
    final loadedById = <int, DungeonRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(DungeonRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Dungeon.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Dungeon.Type', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].type = DungeonType.of(value);
            }
          }
          break;
        case 3:
          checkColumn(column, 'Dungeon.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Dungeon.Element', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.Element');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'Dungeon.DailyEntries', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.DailyEntries');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].dailyEntries = value;
            }
          }
          break;
        case 6:
          checkColumn(column, 'Dungeon.UnlockId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Dungeon.UnlockId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
