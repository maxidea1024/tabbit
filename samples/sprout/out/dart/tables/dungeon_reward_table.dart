...
class DungeonRewardTable extends Iterable<DungeonRewardRecord> {
  ...
  List<DungeonRewardRecord> get records => _records;
  List<DungeonRewardRecord> _records = [];
  ...
  @override
  Iterator<DungeonRewardRecord> get iterator => _records.iterator;

  Map<int, DungeonRewardRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  DungeonRewardRecord? findById(int key) => _byId[key];
  ...
  DungeonRewardRecord getByIdOrThrow(int key) {
  ...
  DungeonRewardRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, DungeonRewardRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <DungeonRewardRecord>[];
    final loadedById = <int, DungeonRewardRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(DungeonRewardRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'DungeonReward.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DungeonReward.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'DungeonReward.ItemId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DungeonReward.ItemId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'DungeonReward.MinCount', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DungeonReward.MinCount');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'DungeonReward.MaxCount', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DungeonReward.MaxCount');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'DungeonReward.Chance', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DungeonReward.Chance');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
