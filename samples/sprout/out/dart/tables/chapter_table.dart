...
class ChapterTable extends Iterable<ChapterRecord> {
  ...
  List<ChapterRecord> get records => _records;
  List<ChapterRecord> _records = [];
  ...
  @override
  Iterator<ChapterRecord> get iterator => _records.iterator;

  Map<int, ChapterRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ChapterRecord? findById(int key) => _byId[key];
  ...
  ChapterRecord getByIdOrThrow(int key) {
  ...
  ChapterRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ChapterRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ChapterRecord>[];
    final loadedById = <int, ChapterRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ChapterRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Chapter.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chapter.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Chapter.WorldId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chapter.WorldId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].worldId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'Chapter.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Chapter.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Chapter.SortOrder', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chapter.SortOrder');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].sortOrder = value;
            }
          }
          break;
        case 5:
          checkColumn(column, 'Chapter.UnlockId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Chapter.UnlockId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
