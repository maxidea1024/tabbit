...
/// Every row of Gacha.
class GachaTable extends Iterable<GachaRecord> {
  ...
  @override
  Iterator<GachaRecord> get iterator => _records.iterator;
  ...
  GachaRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, GachaRecord>> get entries =>
