...
class LootGroupTable extends Iterable<LootGroupRecord> {
  ...
  @override
  Iterator<LootGroupRecord> get iterator => _records.iterator;
  ...
  LootGroupRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, LootGroupRecord>> get entries =>
