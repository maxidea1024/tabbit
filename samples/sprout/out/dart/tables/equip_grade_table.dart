...
class EquipGradeTable extends Iterable<EquipGradeRecord> {
  ...
  @override
  Iterator<EquipGradeRecord> get iterator => _records.iterator;
  ...
  EquipGradeRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, EquipGradeRecord>> get entries =>
