...
class CodexEntryTable extends Iterable<CodexEntryRecord> {
  ...
  List<CodexEntryRecord> get records => _records;
  List<CodexEntryRecord> _records = [];
  ...
  @override
  Iterator<CodexEntryRecord> get iterator => _records.iterator;

  Map<int, CodexEntryRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  CodexEntryRecord? findById(int key) => _byId[key];
  ...
  CodexEntryRecord getByIdOrThrow(int key) {
  ...
  CodexEntryRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CodexEntryRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <CodexEntryRecord>[];
    final loadedById = <int, CodexEntryRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(CodexEntryRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'CodexEntry.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'CodexEntry.CodexId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.CodexId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].codexId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'CodexEntry.EntryOrder', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.EntryOrder');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].entryOrder = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'CodexEntry.ConditionId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.ConditionId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'CodexEntry.Stat', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.Stat');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 6:
          checkColumn(column, 'CodexEntry.Bonus', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexEntry.Bonus');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
