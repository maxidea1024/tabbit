...
class CharacterStatRecord {
  ...
  int level = 0;
  /// required experience
  BigInt requiredExp = BigInt.zero;
...
class CharacterStatTable extends Iterable<CharacterStatRecord> {
  ...
  List<CharacterStatRecord> get records => _records;
  List<CharacterStatRecord> _records = [];
  ...
  @override
  Iterator<CharacterStatRecord> get iterator => _records.iterator;

  Map<int, CharacterStatRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  CharacterStatRecord? findById(int key) => _byId[key];
  ...
  CharacterStatRecord getByIdOrThrow(int key) {
  ...
  CharacterStatRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CharacterStatRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <CharacterStatRecord>[];
    final loadedById = <int, CharacterStatRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(CharacterStatRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'CharacterStat.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'CharacterStat.CharacterId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.CharacterId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'CharacterStat.Level', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.Level');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'CharacterStat.RequiredExp', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.RequiredExp');
          for (final record in loaded) {
            record.requiredExp = cursor.nextI64();
          }
          break;
        case 5:
          checkColumn(column, 'CharacterStat.Attack', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.Attack');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 6:
          checkColumn(column, 'CharacterStat.Defense', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.Defense');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 7:
          checkColumn(column, 'CharacterStat.Health', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterStat.Health');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].health = value;
            }
          }
          break;
        default:
