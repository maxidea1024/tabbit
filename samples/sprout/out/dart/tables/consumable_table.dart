...
class ConsumableTable extends Iterable<ConsumableRecord> {
  ...
  List<ConsumableRecord> get records => _records;
  List<ConsumableRecord> _records = [];
  ...
  @override
  Iterator<ConsumableRecord> get iterator => _records.iterator;

  Map<int, ConsumableRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ConsumableRecord? findById(int key) => _byId[key];
  ...
  ConsumableRecord getByIdOrThrow(int key) {
  ...
  ConsumableRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ConsumableRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ConsumableRecord>[];
    final loadedById = <int, ConsumableRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ConsumableRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Consumable.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Consumable.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Consumable.ItemId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Consumable.ItemId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'Consumable.BuffId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Consumable.BuffId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].buffId = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'Consumable.Cooldown', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Consumable.Cooldown');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
