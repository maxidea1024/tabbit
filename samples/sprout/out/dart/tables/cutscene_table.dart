...
class CutsceneTable extends Iterable<CutsceneRecord> {
  ...
  @override
  Iterator<CutsceneRecord> get iterator => _records.iterator;
  ...
  CutsceneRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CutsceneRecord>> get entries =>
