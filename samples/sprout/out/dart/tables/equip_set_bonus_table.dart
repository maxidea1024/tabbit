...
class EquipSetBonusTable extends Iterable<EquipSetBonusRecord> {
  ...
  List<EquipSetBonusRecord> get records => _records;
  List<EquipSetBonusRecord> _records = [];
  ...
  @override
  Iterator<EquipSetBonusRecord> get iterator => _records.iterator;

  Map<int, EquipSetBonusRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  EquipSetBonusRecord? findById(int key) => _byId[key];
  ...
  EquipSetBonusRecord getByIdOrThrow(int key) {
  ...
  EquipSetBonusRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, EquipSetBonusRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <EquipSetBonusRecord>[];
    final loadedById = <int, EquipSetBonusRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(EquipSetBonusRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'EquipSetBonus.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipSetBonus.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'EquipSetBonus.SetId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipSetBonus.SetId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'EquipSetBonus.Pieces', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipSetBonus.Pieces');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].pieces = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'EquipSetBonus.Stat', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipSetBonus.Stat');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'EquipSetBonus.Bonus', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipSetBonus.Bonus');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
