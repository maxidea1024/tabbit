...
class EquipOptionTable extends Iterable<EquipOptionRecord> {
  ...
  List<EquipOptionRecord> get records => _records;
  List<EquipOptionRecord> _records = [];
  ...
  @override
  Iterator<EquipOptionRecord> get iterator => _records.iterator;

  Map<int, EquipOptionRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  EquipOptionRecord? findById(int key) => _byId[key];
  ...
  EquipOptionRecord getByIdOrThrow(int key) {
  ...
  EquipOptionRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, EquipOptionRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <EquipOptionRecord>[];
    final loadedById = <int, EquipOptionRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(EquipOptionRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'EquipOption.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipOption.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'EquipOption.Stat', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipOption.Stat');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'EquipOption.MinRoll', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipOption.MinRoll');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].minRoll = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'EquipOption.MaxRoll', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipOption.MaxRoll');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].maxRoll = value;
            }
          }
          break;
        case 5:
          checkColumn(column, 'EquipOption.Weight', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'EquipOption.Weight');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
