...
class GachaOddsTable extends Iterable<GachaOddsRecord> {
  ...
  List<GachaOddsRecord> get records => _records;
  List<GachaOddsRecord> _records = [];
  ...
  @override
  Iterator<GachaOddsRecord> get iterator => _records.iterator;

  Map<int, GachaOddsRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  GachaOddsRecord? findById(int key) => _byId[key];
  ...
  GachaOddsRecord getByIdOrThrow(int key) {
  ...
  GachaOddsRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, GachaOddsRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <GachaOddsRecord>[];
    final loadedById = <int, GachaOddsRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(GachaOddsRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'GachaOdds.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'GachaOdds.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'GachaOdds.GachaId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'GachaOdds.GachaId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'GachaOdds.Grade', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'GachaOdds.Grade');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'GachaOdds.Rate', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'GachaOdds.Rate');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].rate = value;
