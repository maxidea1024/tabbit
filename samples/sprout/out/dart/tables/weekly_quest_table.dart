...
class WeeklyQuestTable extends Iterable<WeeklyQuestRecord> {
  ...
  List<WeeklyQuestRecord> get records => _records;
  List<WeeklyQuestRecord> _records = [];
  ...
  @override
  Iterator<WeeklyQuestRecord> get iterator => _records.iterator;

  Map<int, WeeklyQuestRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  WeeklyQuestRecord? findById(int key) => _byId[key];
  ...
  WeeklyQuestRecord getByIdOrThrow(int key) {
  ...
  WeeklyQuestRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, WeeklyQuestRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <WeeklyQuestRecord>[];
    final loadedById = <int, WeeklyQuestRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(WeeklyQuestRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'WeeklyQuest.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'WeeklyQuest.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'WeeklyQuest.QuestId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'WeeklyQuest.QuestId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'WeeklyQuest.Points', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'WeeklyQuest.Points');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].points = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'WeeklyQuest.ResetWeekday', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'WeeklyQuest.ResetWeekday');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].resetWeekday = value;
            }
          }
          break;
        default:
