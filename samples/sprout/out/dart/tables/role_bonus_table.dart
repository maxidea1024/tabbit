...
class RoleBonusTable extends Iterable<RoleBonusRecord> {
  ...
  @override
  Iterator<RoleBonusRecord> get iterator => _records.iterator;
  ...
  RoleBonusRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, RoleBonusRecord>> get entries =>
