...
/// Every row of Equip.
class EquipTable extends Iterable<EquipRecord> {
  ...
  @override
  Iterator<EquipRecord> get iterator => _records.iterator;
  ...
  EquipRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, EquipRecord>> get entries =>
