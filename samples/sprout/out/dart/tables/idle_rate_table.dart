...
class IdleRateTable extends Iterable<IdleRateRecord> {
  ...
  @override
  Iterator<IdleRateRecord> get iterator => _records.iterator;
  ...
  IdleRateRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, IdleRateRecord>> get entries =>
