...
/// Every row of Shop.
class ShopTable extends Iterable<ShopRecord> {
  ...
  List<ShopRecord> get records => _records;
  List<ShopRecord> _records = [];
  ...
  @override
  Iterator<ShopRecord> get iterator => _records.iterator;

  Map<int, ShopRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ShopRecord? findById(int key) => _byId[key];
  ...
  ShopRecord getByIdOrThrow(int key) {
  ...
  ShopRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ShopRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ShopRecord>[];
    final loadedById = <int, ShopRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ShopRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Shop.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Shop.Type', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].type = ShopType.of(value);
            }
          }
          break;
        case 3:
          checkColumn(column, 'Shop.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Shop.RefreshHours', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.RefreshHours');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].refreshHours = value;
            }
          }
          break;
        case 5:
          checkColumn(column, 'Shop.FreeRefresh', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Shop.FreeRefresh');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].freeRefresh = value;
            }
          }
          break;
        default:
