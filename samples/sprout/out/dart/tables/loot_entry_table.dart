...
class LootEntryTable extends Iterable<LootEntryRecord> {
  ...
  @override
  Iterator<LootEntryRecord> get iterator => _records.iterator;
  ...
  LootEntryRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, LootEntryRecord>> get entries =>
