...
class SkillLevelTable extends Iterable<SkillLevelRecord> {
  ...
  List<SkillLevelRecord> get records => _records;
  List<SkillLevelRecord> _records = [];
  ...
  @override
  Iterator<SkillLevelRecord> get iterator => _records.iterator;

  Map<int, SkillLevelRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  SkillLevelRecord? findById(int key) => _byId[key];
  ...
  SkillLevelRecord getByIdOrThrow(int key) {
  ...
  SkillLevelRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, SkillLevelRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <SkillLevelRecord>[];
    final loadedById = <int, SkillLevelRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(SkillLevelRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'SkillLevel.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'SkillLevel.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'SkillLevel.SkillId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'SkillLevel.SkillId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].skillId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'SkillLevel.Level', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'SkillLevel.Level');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'SkillLevel.Power', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'SkillLevel.Power');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'SkillLevel.Cost', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'SkillLevel.Cost');
