...
/// Every row of World.
class WorldTable extends Iterable<WorldRecord> {
  ...
  List<WorldRecord> get records => _records;
  ...
  @override
  Iterator<WorldRecord> get iterator => _records.iterator;

  Map<int, WorldRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  WorldRecord? findById(int key) => _byId[key];
  ...
  WorldRecord getByIdOrThrow(int key) {
  ...
  WorldRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, WorldRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <WorldRecord>[];
    final loadedById = <int, WorldRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(WorldRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'World.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'World.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'World.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'World.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'World.Map', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'World.Map');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].map = value;
          ...
          break;
        case 4:
          checkColumn(column, 'World.ThemeColour', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'World.ThemeColour');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].themeColour = value;
            }
          }
          break;
        default:
