...
class PowerScoreTable extends Iterable<PowerScoreRecord> {
  ...
  @override
  Iterator<PowerScoreRecord> get iterator => _records.iterator;
  ...
  PowerScoreRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, PowerScoreRecord>> get entries =>
