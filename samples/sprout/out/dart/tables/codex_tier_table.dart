...
class CodexTierTable extends Iterable<CodexTierRecord> {
  ...
  List<CodexTierRecord> get records => _records;
  List<CodexTierRecord> _records = [];
  ...
  @override
  Iterator<CodexTierRecord> get iterator => _records.iterator;

  Map<int, CodexTierRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  CodexTierRecord? findById(int key) => _byId[key];
  ...
  CodexTierRecord getByIdOrThrow(int key) {
  ...
  CodexTierRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CodexTierRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <CodexTierRecord>[];
    final loadedById = <int, CodexTierRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(CodexTierRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'CodexTier.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexTier.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'CodexTier.CodexId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexTier.CodexId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'CodexTier.Required', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexTier.Required');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].required = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'CodexTier.RewardId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CodexTier.RewardId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
