...
class CharacterSkinTable extends Iterable<CharacterSkinRecord> {
  ...
  @override
  Iterator<CharacterSkinRecord> get iterator => _records.iterator;
  ...
  CharacterSkinRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CharacterSkinRecord>> get entries =>
