...
class PassiveTable extends Iterable<PassiveRecord> {
  ...
  @override
  Iterator<PassiveRecord> get iterator => _records.iterator;
  ...
  PassiveRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, PassiveRecord>> get entries =>
