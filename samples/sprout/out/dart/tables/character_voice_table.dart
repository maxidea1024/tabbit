...
class CharacterVoiceTable extends Iterable<CharacterVoiceRecord> {
  ...
  List<CharacterVoiceRecord> get records => _records;
  List<CharacterVoiceRecord> _records = [];
  ...
  @override
  Iterator<CharacterVoiceRecord> get iterator => _records.iterator;

  Map<int, CharacterVoiceRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  CharacterVoiceRecord? findById(int key) => _byId[key];
  ...
  CharacterVoiceRecord getByIdOrThrow(int key) {
  ...
  CharacterVoiceRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CharacterVoiceRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <CharacterVoiceRecord>[];
    final loadedById = <int, CharacterVoiceRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(CharacterVoiceRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'CharacterVoice.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterVoice.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'CharacterVoice.CharacterId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterVoice.CharacterId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'CharacterVoice.Cue', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterVoice.Cue');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'CharacterVoice.Clip', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterVoice.Clip');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].clip = value;
          ...
          break;
        case 5:
          checkColumn(column, 'CharacterVoice.SubtitleKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'CharacterVoice.SubtitleKey');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].subtitleKey = value;
            }
          }
          break;
        default:
