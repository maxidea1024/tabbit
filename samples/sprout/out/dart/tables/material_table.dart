...
class MaterialTable extends Iterable<MaterialRecord> {
  ...
  @override
  Iterator<MaterialRecord> get iterator => _records.iterator;
  ...
  MaterialRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, MaterialRecord>> get entries =>
