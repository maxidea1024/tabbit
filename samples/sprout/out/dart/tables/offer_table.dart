...
/// Every row of Offer.
class OfferTable extends Iterable<OfferRecord> {
  ...
  List<OfferRecord> get records => _records;
  List<OfferRecord> _records = [];
  ...
  @override
  Iterator<OfferRecord> get iterator => _records.iterator;

  Map<int, OfferRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  OfferRecord? findById(int key) => _byId[key];
  ...
  OfferRecord getByIdOrThrow(int key) {
  ...
  OfferRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, OfferRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <OfferRecord>[];
    final loadedById = <int, OfferRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(OfferRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Offer.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Offer.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Offer.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Offer.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Offer.Shop', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Offer.Shop');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].shop = ShopType.of(value);
            }
          }
          break;
        case 4:
          checkColumn(column, 'Offer.Price', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Offer.Price');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'Offer.Limit', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Offer.Limit');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].limit = value;
            }
          }
          break;
        default:
