...
/// Every row of Item.
class ItemTable extends Iterable<ItemRecord> {
  ...
  @override
  Iterator<ItemRecord> get iterator => _records.iterator;

  Map<int, ItemRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ItemRecord? findById(int key) => _byId[key];
  ...
  ItemRecord getByIdOrThrow(int key) {
  ...
  ItemRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ItemRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loadedById = <int, ItemRecord>{};
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Item.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Item.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Item.Type', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].type = ItemType.of(value);
            }
          }
          break;
        case 4:
          checkColumn(column, 'Item.Grade', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.Grade');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'Item.Icon', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.Icon');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].icon = value;
          ...
          break;
        case 6:
          checkColumn(column, 'Item.StackLimit', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.StackLimit');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 7:
          checkColumn(column, 'Item.SellPrice', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.SellPrice');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].sellPrice = value;
            }
          }
          break;
        case 8:
          checkColumn(column, 'Item.Tradable', kindScalar, false, [elementBool]);
          cursor = TcbColumnCursor(reader, column, count, 'Item.Tradable');
