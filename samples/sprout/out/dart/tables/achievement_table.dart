...
class AchievementTable extends Iterable<AchievementRecord> {
  ...
  List<AchievementRecord> get records => _records;
  ...
  @override
  Iterator<AchievementRecord> get iterator => _records.iterator;

  Map<int, AchievementRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  AchievementRecord? findById(int key) => _byId[key];
  ...
  AchievementRecord getByIdOrThrow(int key) {
  ...
  AchievementRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, AchievementRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <AchievementRecord>[];
    final loadedById = <int, AchievementRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(AchievementRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Achievement.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Achievement.TitleKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.TitleKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 3:
          checkColumn(column, 'Achievement.ConditionId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.ConditionId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'Achievement.TargetCount', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.TargetCount');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'Achievement.RewardId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.RewardId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 6:
          checkColumn(column, 'Achievement.Badge', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Achievement.Badge');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].badge = value;
            }
          }
          break;
        default:
