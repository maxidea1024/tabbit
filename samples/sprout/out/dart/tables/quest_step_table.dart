...
class QuestStepTable extends Iterable<QuestStepRecord> {
  ...
  List<QuestStepRecord> get records => _records;
  List<QuestStepRecord> _records = [];
  ...
  @override
  Iterator<QuestStepRecord> get iterator => _records.iterator;

  Map<int, QuestStepRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  QuestStepRecord? findById(int key) => _byId[key];
  ...
  QuestStepRecord getByIdOrThrow(int key) {
  ...
  QuestStepRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, QuestStepRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <QuestStepRecord>[];
    final loadedById = <int, QuestStepRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(QuestStepRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'QuestStep.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'QuestStep.QuestId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.QuestId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].questId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'QuestStep.StepOrder', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.StepOrder');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].stepOrder = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'QuestStep.ConditionId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.ConditionId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].conditionId = value;
            }
          }
          break;
        case 5:
          checkColumn(column, 'QuestStep.TargetCount', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.TargetCount');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].targetCount = value;
            }
          }
          break;
        case 6:
          checkColumn(column, 'QuestStep.DialogueId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'QuestStep.DialogueId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
