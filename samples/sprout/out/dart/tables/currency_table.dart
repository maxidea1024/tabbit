...
class CurrencyTable extends Iterable<CurrencyRecord> {
  ...
  @override
  Iterator<CurrencyRecord> get iterator => _records.iterator;
  ...
  CurrencyRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CurrencyRecord>> get entries =>
