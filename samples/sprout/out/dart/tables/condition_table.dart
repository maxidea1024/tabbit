...
class ConditionTable extends Iterable<ConditionRecord> {
  ...
  @override
  Iterator<ConditionRecord> get iterator => _records.iterator;
  ...
  ConditionRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ConditionRecord>> get entries =>
