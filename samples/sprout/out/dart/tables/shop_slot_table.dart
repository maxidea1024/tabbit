...
class ShopSlotTable extends Iterable<ShopSlotRecord> {
  ...
  List<ShopSlotRecord> get records => _records;
  List<ShopSlotRecord> _records = [];
  ...
  @override
  Iterator<ShopSlotRecord> get iterator => _records.iterator;

  Map<int, ShopSlotRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  ShopSlotRecord? findById(int key) => _byId[key];
  ...
  ShopSlotRecord getByIdOrThrow(int key) {
  ...
  ShopSlotRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ShopSlotRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <ShopSlotRecord>[];
    final loadedById = <int, ShopSlotRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(ShopSlotRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'ShopSlot.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'ShopSlot.ShopId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.ShopId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].shopId = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'ShopSlot.SlotOrder', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.SlotOrder');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].slotOrder = value;
            }
          }
          break;
        case 4:
          checkColumn(column, 'ShopSlot.ItemId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.ItemId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 5:
          checkColumn(column, 'ShopSlot.Count', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.Count');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 6:
          checkColumn(column, 'ShopSlot.PriceId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.PriceId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 7:
          checkColumn(column, 'ShopSlot.Weight', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'ShopSlot.Weight');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
