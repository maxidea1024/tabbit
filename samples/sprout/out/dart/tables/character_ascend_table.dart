...
class CharacterAscendTable extends Iterable<CharacterAscendRecord> {
  ...
  @override
  Iterator<CharacterAscendRecord> get iterator => _records.iterator;
  ...
  CharacterAscendRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CharacterAscendRecord>> get entries =>
