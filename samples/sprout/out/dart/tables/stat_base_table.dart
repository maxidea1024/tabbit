...
class StatBaseTable extends Iterable<StatBaseRecord> {
  ...
  List<StatBaseRecord> get records => _records;
  List<StatBaseRecord> _records = [];
  ...
  @override
  Iterator<StatBaseRecord> get iterator => _records.iterator;

  Map<int, StatBaseRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  StatBaseRecord? findById(int key) => _byId[key];
  ...
  StatBaseRecord getByIdOrThrow(int key) {
  ...
  StatBaseRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, StatBaseRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <StatBaseRecord>[];
    final loadedById = <int, StatBaseRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(StatBaseRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'StatBase.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'StatBase.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'StatBase.Role', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'StatBase.Role');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'StatBase.Stat', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'StatBase.Stat');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'StatBase.BaseValue', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'StatBase.BaseValue');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
