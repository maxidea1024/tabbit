...
class OfferItemTable extends Iterable<OfferItemRecord> {
  ...
  @override
  Iterator<OfferItemRecord> get iterator => _records.iterator;
  ...
  OfferItemRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, OfferItemRecord>> get entries =>
