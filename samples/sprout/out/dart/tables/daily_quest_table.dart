...
class DailyQuestTable extends Iterable<DailyQuestRecord> {
  ...
  List<DailyQuestRecord> get records => _records;
  List<DailyQuestRecord> _records = [];
  ...
  @override
  Iterator<DailyQuestRecord> get iterator => _records.iterator;

  Map<int, DailyQuestRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  DailyQuestRecord? findById(int key) => _byId[key];
  ...
  DailyQuestRecord getByIdOrThrow(int key) {
  ...
  DailyQuestRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, DailyQuestRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <DailyQuestRecord>[];
    final loadedById = <int, DailyQuestRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(DailyQuestRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'DailyQuest.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DailyQuest.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'DailyQuest.QuestId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DailyQuest.QuestId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 3:
          checkColumn(column, 'DailyQuest.Points', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DailyQuest.Points');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
          ...
          break;
        case 4:
          checkColumn(column, 'DailyQuest.ResetHour', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'DailyQuest.ResetHour');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].resetHour = value;
            }
          }
          break;
        default:
