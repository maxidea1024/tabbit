...
class CodexRecord {
  ...
  int id = 0;
  /// collection kind
  CollectionType type = CollectionType.of(0);
  /// name key
  String nameKey = '';
  /// icon asset
  String icon = '';
...
/// Every row of Codex.
class CodexTable extends Iterable<CodexRecord> {
  ...
  List<CodexRecord> get records => _records;
  List<CodexRecord> _records = [];
  ...
  @override
  Iterator<CodexRecord> get iterator => _records.iterator;

  Map<int, CodexRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  CodexRecord? findById(int key) => _byId[key];
  ...
  CodexRecord getByIdOrThrow(int key) {
  ...
  CodexRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, CodexRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <CodexRecord>[];
    final loadedById = <int, CodexRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(CodexRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'Codex.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Codex.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'Codex.Type', kindScalar, false, [elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Codex.Type');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].type = CollectionType.of(value);
            }
          }
          break;
        case 3:
          checkColumn(column, 'Codex.NameKey', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Codex.NameKey');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 4:
          checkColumn(column, 'Codex.Icon', kindScalar, false, [elementString]);
          cursor = TcbColumnCursor(reader, column, count, 'Codex.Icon');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameString(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].icon = value;
          ...
          break;
        case 5:
          checkColumn(column, 'Codex.RewardId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'Codex.RewardId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
