...
class ItemGradeTable extends Iterable<ItemGradeRecord> {
  ...
  @override
  Iterator<ItemGradeRecord> get iterator => _records.iterator;
  ...
  ItemGradeRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, ItemGradeRecord>> get entries =>
