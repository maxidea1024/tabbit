...
class OfflineRewardRecord {
  ...
  BigInt goldPerHour = BigInt.zero;
  /// experience per hour
  BigInt expPerHour = BigInt.zero;
  /// drop group
  int lootGroupId = 0;
...
class OfflineRewardTable extends Iterable<OfflineRewardRecord> {
  ...
  List<OfflineRewardRecord> get records => _records;
  List<OfflineRewardRecord> _records = [];
  ...
  @override
  Iterator<OfflineRewardRecord> get iterator => _records.iterator;

  Map<int, OfflineRewardRecord> _byId = {};

  /// The row with this Id, or null when the table has none.
  ///
  /// The lookup to reach for when a missing row is an ordinary answer - an optional
  /// reference, a key that came from user input.
  OfflineRewardRecord? findById(int key) => _byId[key];
  ...
  OfflineRewardRecord getByIdOrThrow(int key) {
  ...
  OfflineRewardRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, OfflineRewardRecord>> get entries =>
  ...
  void read(String filename) {
    ...
    final loaded = <OfflineRewardRecord>[];
    final loadedById = <int, OfflineRewardRecord>{};

    for (var i = 0; i < count; i++) {
      loaded.add(OfflineRewardRecord());
    }
    ...
    for (final column in header.columns) {
      ...
      switch (column.tag) {
        case 1:
          checkColumn(column, 'OfflineReward.Id', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'OfflineReward.Id');
          for (var i = 0; i < count; ) {
          ...
          break;
        case 2:
          checkColumn(column, 'OfflineReward.AccountLevel', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'OfflineReward.AccountLevel');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
              loaded[i].accountLevel = value;
            }
          }
          break;
        case 3:
          checkColumn(column, 'OfflineReward.GoldPerHour', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'OfflineReward.GoldPerHour');
          for (final record in loaded) {
            record.goldPerHour = cursor.nextI64();
          }
          break;
        case 4:
          checkColumn(column, 'OfflineReward.ExpPerHour', kindScalar, false, [elementI64, elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'OfflineReward.ExpPerHour');
          for (final record in loaded) {
            record.expPerHour = cursor.nextI64();
          }
          break;
        case 5:
          checkColumn(column, 'OfflineReward.LootGroupId', kindScalar, false, [elementI32, elementVarint]);
          cursor = TcbColumnCursor(reader, column, count, 'OfflineReward.LootGroupId');
          for (var i = 0; i < count; ) {
            final (n, value) = cursor.nextSameI32(count - i);
            for (var left = n; left > 0; left--, i++) {
