...
class DungeonFloorTable extends Iterable<DungeonFloorRecord> {
  ...
  @override
  Iterator<DungeonFloorRecord> get iterator => _records.iterator;
  ...
  DungeonFloorRecord? operator [](int key) => findById(key);
  ...
  Iterable<MapEntry<int, DungeonFloorRecord>> get entries =>
