...
class DungeonRewardTable : Iterable<DungeonRewardRecord> {
     ...
     */
    var records: MutableList<DungeonRewardRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<DungeonRewardRecord> = records.iterator()

    private var byId: HashMap<Int, DungeonRewardRecord> = HashMap()
     ...
     */
    fun findById(key: Int): DungeonRewardRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): DungeonRewardRecord =
     ...
     */
    operator fun get(key: Int): DungeonRewardRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, DungeonRewardRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<DungeonRewardRecord>(count)
        val loadedById = HashMap<Int, DungeonRewardRecord>(count * 2)

        repeat(count) { loaded.add(DungeonRewardRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "DungeonReward.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DungeonReward.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "DungeonReward.ItemId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DungeonReward.ItemId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "DungeonReward.MinCount", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DungeonReward.MinCount")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "DungeonReward.MaxCount", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DungeonReward.MaxCount")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "DungeonReward.Chance", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DungeonReward.Chance")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
