...
class SkillEffectRecord {
    ...
    var id: Int = 0
    /** effect kind */
    var kind: BuffKind = BuffKind.of(0)
    /** affected stat */
    var stat: StatType = StatType.of(0)
...
class SkillEffectTable : Iterable<SkillEffectRecord> {
     ...
     */
    var records: MutableList<SkillEffectRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<SkillEffectRecord> = records.iterator()

    private var byId: HashMap<Int, SkillEffectRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SkillEffectRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SkillEffectRecord =
     ...
     */
    operator fun get(key: Int): SkillEffectRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, SkillEffectRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SkillEffectRecord>(count)
        val loadedById = HashMap<Int, SkillEffectRecord>(count * 2)

        repeat(count) { loaded.add(SkillEffectRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "SkillEffect.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "SkillEffect.Kind", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Kind")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "SkillEffect.Stat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Stat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "SkillEffect.Magnitude", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Magnitude")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "SkillEffect.Duration", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Duration")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "SkillEffect.Chance", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillEffect.Chance")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
