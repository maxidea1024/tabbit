...
class LevelCurveRecord {
    ...
    var tierName: String = ""
    /** affected stat */
    var curveStat: StatType = StatType.of(0)
    ...
    var endValue: Long = 0L
    /** ceiling for this curve */
    var capValue: Long = 0L
    /** balance revision */
    var revision: Int = 0
...
class LevelCurveTable : Iterable<LevelCurveRecord> {
     ...
     */
    var records: MutableList<LevelCurveRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<LevelCurveRecord> = records.iterator()

    private var byId: HashMap<Int, LevelCurveRecord> = HashMap()
     ...
     */
    fun findById(key: Int): LevelCurveRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): LevelCurveRecord =
     ...
     */
    operator fun get(key: Int): LevelCurveRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, LevelCurveRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<LevelCurveRecord>(count)
        val loadedById = HashMap<Int, LevelCurveRecord>(count * 2)

        repeat(count) { loaded.add(LevelCurveRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "LevelCurve.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "LevelCurve.TierName", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.TierName")
                    var at = 0
                    while (at < count) {
                ...
                3 -> {
                    checkColumn(column, "LevelCurve.CurveStat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.CurveStat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "LevelCurve.Tick", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.Tick")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "LevelCurve.BaseValue", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.BaseValue")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "LevelCurve.StepValue", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.StepValue")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                7 -> {
                    checkColumn(column, "LevelCurve.EndValue", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.EndValue")
                    for (record in loaded) {
                        record.endValue = cursor.nextI64()
                    }
                }
                8 -> {
                    checkColumn(column, "LevelCurve.CapValue", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.CapValue")
                    for (record in loaded) {
                        record.capValue = cursor.nextI64()
                    }
                }
                9 -> {
                    checkColumn(column, "LevelCurve.Revision", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "LevelCurve.Revision")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
