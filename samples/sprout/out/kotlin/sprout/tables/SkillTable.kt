...
/** Every row of Skill. */
class SkillTable : Iterable<SkillRecord> {
     ...
     */
    override fun iterator(): Iterator<SkillRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): SkillRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, SkillRecord>>
