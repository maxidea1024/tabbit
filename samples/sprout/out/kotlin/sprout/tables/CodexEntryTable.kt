...
class CodexEntryTable : Iterable<CodexEntryRecord> {
     ...
     */
    var records: MutableList<CodexEntryRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<CodexEntryRecord> = records.iterator()

    private var byId: HashMap<Int, CodexEntryRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CodexEntryRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CodexEntryRecord =
     ...
     */
    operator fun get(key: Int): CodexEntryRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CodexEntryRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CodexEntryRecord>(count)
        val loadedById = HashMap<Int, CodexEntryRecord>(count * 2)

        repeat(count) { loaded.add(CodexEntryRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CodexEntry.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "CodexEntry.CodexId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.CodexId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "CodexEntry.EntryOrder", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.EntryOrder")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "CodexEntry.ConditionId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.ConditionId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "CodexEntry.Stat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.Stat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "CodexEntry.Bonus", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CodexEntry.Bonus")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
