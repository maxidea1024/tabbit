...
/** Every row of Shop. */
class ShopTable : Iterable<ShopRecord> {
     ...
     */
    override fun iterator(): Iterator<ShopRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): ShopRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, ShopRecord>>
