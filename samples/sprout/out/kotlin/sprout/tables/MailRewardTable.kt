...
class MailRewardTable : Iterable<MailRewardRecord> {
     ...
     */
    var records: MutableList<MailRewardRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<MailRewardRecord> = records.iterator()

    private var byId: HashMap<Int, MailRewardRecord> = HashMap()
     ...
     */
    fun findById(key: Int): MailRewardRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): MailRewardRecord =
     ...
     */
    operator fun get(key: Int): MailRewardRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, MailRewardRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<MailRewardRecord>(count)
        val loadedById = HashMap<Int, MailRewardRecord>(count * 2)

        repeat(count) { loaded.add(MailRewardRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "MailReward.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "MailReward.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "MailReward.TitleKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "MailReward.TitleKey")
                    var at = 0
                    while (at < count) {
                ...
                3 -> {
                    checkColumn(column, "MailReward.BodyKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "MailReward.BodyKey")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "MailReward.RewardId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "MailReward.RewardId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "MailReward.ExpiryDays", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "MailReward.ExpiryDays")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
