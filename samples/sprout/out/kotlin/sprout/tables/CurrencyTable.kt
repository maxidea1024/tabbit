...
class CurrencyTable : Iterable<CurrencyRecord> {
     ...
     */
    override fun iterator(): Iterator<CurrencyRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): CurrencyRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CurrencyRecord>>
    ...
    fun read(filename: String) {
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Currency.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                ...
                2 -> {
                    checkColumn(column, "Currency.Type", KIND_SCALAR, false, ELEMENT_VARINT)
                ...
                3 -> {
                    checkColumn(column, "Currency.NameKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Currency.NameKey")
                    var at = 0
                    while (at < count) {
                ...
                4 -> {
                    checkColumn(column, "Currency.Icon", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Currency.Icon")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Currency.Cap", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Currency.Cap")
