...
class OfflineRewardRecord {
    ...
    var goldPerHour: Long = 0L
    /** experience per hour */
    var expPerHour: Long = 0L
    /** drop group */
...
class OfflineRewardTable : Iterable<OfflineRewardRecord> {
     ...
     */
    var records: MutableList<OfflineRewardRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<OfflineRewardRecord> = records.iterator()

    private var byId: HashMap<Int, OfflineRewardRecord> = HashMap()
     ...
     */
    fun findById(key: Int): OfflineRewardRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): OfflineRewardRecord =
     ...
     */
    operator fun get(key: Int): OfflineRewardRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, OfflineRewardRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<OfflineRewardRecord>(count)
        val loadedById = HashMap<Int, OfflineRewardRecord>(count * 2)

        repeat(count) { loaded.add(OfflineRewardRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "OfflineReward.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "OfflineReward.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "OfflineReward.AccountLevel", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "OfflineReward.AccountLevel")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "OfflineReward.GoldPerHour", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "OfflineReward.GoldPerHour")
                    for (record in loaded) {
                        record.goldPerHour = cursor.nextI64()
                    }
                }
                4 -> {
                    checkColumn(column, "OfflineReward.ExpPerHour", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "OfflineReward.ExpPerHour")
                    for (record in loaded) {
                        record.expPerHour = cursor.nextI64()
                    }
                }
                5 -> {
                    checkColumn(column, "OfflineReward.LootGroupId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "OfflineReward.LootGroupId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
