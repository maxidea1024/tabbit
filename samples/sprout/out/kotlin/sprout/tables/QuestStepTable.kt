...
class QuestStepTable : Iterable<QuestStepRecord> {
     ...
     */
    override fun iterator(): Iterator<QuestStepRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): QuestStepRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, QuestStepRecord>>
