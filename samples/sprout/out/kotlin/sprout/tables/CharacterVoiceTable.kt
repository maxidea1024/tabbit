...
class CharacterVoiceTable : Iterable<CharacterVoiceRecord> {
     ...
     */
    var records: MutableList<CharacterVoiceRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<CharacterVoiceRecord> = records.iterator()

    private var byId: HashMap<Int, CharacterVoiceRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CharacterVoiceRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CharacterVoiceRecord =
     ...
     */
    operator fun get(key: Int): CharacterVoiceRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CharacterVoiceRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CharacterVoiceRecord>(count)
        val loadedById = HashMap<Int, CharacterVoiceRecord>(count * 2)

        repeat(count) { loaded.add(CharacterVoiceRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CharacterVoice.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterVoice.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "CharacterVoice.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterVoice.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "CharacterVoice.Cue", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "CharacterVoice.Cue")
                    var at = 0
                    while (at < count) {
                ...
                4 -> {
                    checkColumn(column, "CharacterVoice.Clip", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "CharacterVoice.Clip")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "CharacterVoice.SubtitleKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "CharacterVoice.SubtitleKey")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
