...
class SkillLevelTable : Iterable<SkillLevelRecord> {
     ...
     */
    var records: MutableList<SkillLevelRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<SkillLevelRecord> = records.iterator()

    private var byId: HashMap<Int, SkillLevelRecord> = HashMap()
     ...
     */
    fun findById(key: Int): SkillLevelRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): SkillLevelRecord =
     ...
     */
    operator fun get(key: Int): SkillLevelRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, SkillLevelRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<SkillLevelRecord>(count)
        val loadedById = HashMap<Int, SkillLevelRecord>(count * 2)

        repeat(count) { loaded.add(SkillLevelRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "SkillLevel.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillLevel.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "SkillLevel.SkillId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillLevel.SkillId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "SkillLevel.Level", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillLevel.Level")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "SkillLevel.Power", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillLevel.Power")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "SkillLevel.Cost", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "SkillLevel.Cost")
