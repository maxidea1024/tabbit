...
class CharacterAscendRecord {
    ...
    var step: Int = 0
    /** material item ids */
    var materialIds: MutableList<Int> = ArrayList()
    /** material counts */
    var materialCounts: MutableList<Int> = ArrayList()
    /** soft currency cost */
    var goldCost: Long = 0L
    /** stat multiplier */
    var statScale: Float = 0.0f

}

/** Every row of CharacterAscend. */
class CharacterAscendTable : Iterable<CharacterAscendRecord> {
     ...
     */
    var records: MutableList<CharacterAscendRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<CharacterAscendRecord> = records.iterator()

    private var byId: HashMap<Int, CharacterAscendRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CharacterAscendRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CharacterAscendRecord =
     ...
     */
    operator fun get(key: Int): CharacterAscendRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CharacterAscendRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CharacterAscendRecord>(count)
        val loadedById = HashMap<Int, CharacterAscendRecord>(count * 2)

        repeat(count) { loaded.add(CharacterAscendRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CharacterAscend.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "CharacterAscend.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "CharacterAscend.Step", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.Step")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "CharacterAscend.MaterialIds", KIND_ARRAY, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.MaterialIds")
                    for (record in loaded) {
                        val elementCount = cursor.nextLength()
                        record.materialIds = ArrayList(elementCount.coerceAtLeast(0))
                        repeat(elementCount) { record.materialIds.add(cursor.nextI32()) }
                    }
                }
                5 -> {
                    checkColumn(column, "CharacterAscend.MaterialCounts", KIND_ARRAY, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.MaterialCounts")
                    for (record in loaded) {
                        val elementCount = cursor.nextLength()
                        record.materialCounts = ArrayList(elementCount.coerceAtLeast(0))
                        repeat(elementCount) { record.materialCounts.add(cursor.nextI32()) }
                    }
                }
                6 -> {
                    checkColumn(column, "CharacterAscend.GoldCost", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.GoldCost")
                    for (record in loaded) {
                        record.goldCost = cursor.nextI64()
                    }
                }
                7 -> {
                    checkColumn(column, "CharacterAscend.StatScale", KIND_SCALAR, false, ELEMENT_F32)
                    val cursor = ColumnCursor(reader, column, count, "CharacterAscend.StatScale")
                    for (record in loaded) {
