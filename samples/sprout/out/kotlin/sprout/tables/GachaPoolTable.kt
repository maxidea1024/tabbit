...
class GachaPoolTable : Iterable<GachaPoolRecord> {
     ...
     */
    var records: MutableList<GachaPoolRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<GachaPoolRecord> = records.iterator()

    private var byId: HashMap<Int, GachaPoolRecord> = HashMap()
     ...
     */
    fun findById(key: Int): GachaPoolRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): GachaPoolRecord =
     ...
     */
    operator fun get(key: Int): GachaPoolRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, GachaPoolRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<GachaPoolRecord>(count)
        val loadedById = HashMap<Int, GachaPoolRecord>(count * 2)

        repeat(count) { loaded.add(GachaPoolRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "GachaPool.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "GachaPool.GachaId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.GachaId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "GachaPool.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "GachaPool.EquipId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.EquipId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "GachaPool.Grade", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.Grade")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "GachaPool.Weight", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "GachaPool.Weight")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
