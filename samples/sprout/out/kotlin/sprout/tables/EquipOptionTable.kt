...
class EquipOptionTable : Iterable<EquipOptionRecord> {
     ...
     */
    var records: MutableList<EquipOptionRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<EquipOptionRecord> = records.iterator()

    private var byId: HashMap<Int, EquipOptionRecord> = HashMap()
     ...
     */
    fun findById(key: Int): EquipOptionRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): EquipOptionRecord =
     ...
     */
    operator fun get(key: Int): EquipOptionRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, EquipOptionRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<EquipOptionRecord>(count)
        val loadedById = HashMap<Int, EquipOptionRecord>(count * 2)

        repeat(count) { loaded.add(EquipOptionRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "EquipOption.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipOption.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "EquipOption.Stat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipOption.Stat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "EquipOption.MinRoll", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipOption.MinRoll")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "EquipOption.MaxRoll", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipOption.MaxRoll")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "EquipOption.Weight", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipOption.Weight")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
