...
class AchievementTable : Iterable<AchievementRecord> {
     ...
     */
    var records: MutableList<AchievementRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<AchievementRecord> = records.iterator()

    private var byId: HashMap<Int, AchievementRecord> = HashMap()
     ...
     */
    fun findById(key: Int): AchievementRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): AchievementRecord =
     ...
     */
    operator fun get(key: Int): AchievementRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, AchievementRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<AchievementRecord>(count)
        val loadedById = HashMap<Int, AchievementRecord>(count * 2)

        repeat(count) { loaded.add(AchievementRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Achievement.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Achievement.TitleKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.TitleKey")
                    var at = 0
                    while (at < count) {
                ...
                3 -> {
                    checkColumn(column, "Achievement.ConditionId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.ConditionId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "Achievement.TargetCount", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.TargetCount")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Achievement.RewardId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.RewardId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "Achievement.Badge", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Achievement.Badge")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
