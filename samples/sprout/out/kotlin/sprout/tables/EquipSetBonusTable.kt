...
class EquipSetBonusTable : Iterable<EquipSetBonusRecord> {
     ...
     */
    var records: MutableList<EquipSetBonusRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<EquipSetBonusRecord> = records.iterator()

    private var byId: HashMap<Int, EquipSetBonusRecord> = HashMap()
     ...
     */
    fun findById(key: Int): EquipSetBonusRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): EquipSetBonusRecord =
     ...
     */
    operator fun get(key: Int): EquipSetBonusRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, EquipSetBonusRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<EquipSetBonusRecord>(count)
        val loadedById = HashMap<Int, EquipSetBonusRecord>(count * 2)

        repeat(count) { loaded.add(EquipSetBonusRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "EquipSetBonus.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipSetBonus.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "EquipSetBonus.SetId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipSetBonus.SetId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "EquipSetBonus.Pieces", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipSetBonus.Pieces")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "EquipSetBonus.Stat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipSetBonus.Stat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "EquipSetBonus.Bonus", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "EquipSetBonus.Bonus")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
