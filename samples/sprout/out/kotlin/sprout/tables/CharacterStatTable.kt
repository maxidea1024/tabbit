...
class CharacterStatTable : Iterable<CharacterStatRecord> {
     ...
     */
    var records: MutableList<CharacterStatRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<CharacterStatRecord> = records.iterator()

    private var byId: HashMap<Int, CharacterStatRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CharacterStatRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CharacterStatRecord =
     ...
     */
    operator fun get(key: Int): CharacterStatRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CharacterStatRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CharacterStatRecord>(count)
        val loadedById = HashMap<Int, CharacterStatRecord>(count * 2)

        repeat(count) { loaded.add(CharacterStatRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CharacterStat.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "CharacterStat.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "CharacterStat.Level", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.Level")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "CharacterStat.RequiredExp", KIND_SCALAR, false, ELEMENT_I64, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.RequiredExp")
                    for (record in loaded) {
                        record.requiredExp = cursor.nextI64()
                    }
                }
                5 -> {
                    checkColumn(column, "CharacterStat.Attack", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.Attack")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "CharacterStat.Defense", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.Defense")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                7 -> {
                    checkColumn(column, "CharacterStat.Health", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterStat.Health")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
