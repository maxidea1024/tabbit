...
class DungeonRecord {
    ...
    var id: Int = 0
    /** dungeon kind */
    var type: DungeonType = DungeonType.of(0)
    /** name key */
    var nameKey: String = ""
    /** element */
    var element: ElementType = ElementType.of(0)
    /** daily entries */
    var dailyEntries: Int = 0
    /** unlock condition */
    var unlockId: Int = 0
...
class DungeonTable {
     ...
     */
    fun findById(key: Int): DungeonRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): DungeonRecord =
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<DungeonRecord>(count)
        val loadedById = HashMap<Int, DungeonRecord>(count * 2)

        repeat(count) { loaded.add(DungeonRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Dungeon.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Dungeon.Type", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.Type")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "Dungeon.NameKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.NameKey")
                    var at = 0
                    while (at < count) {
                ...
                4 -> {
                    checkColumn(column, "Dungeon.Element", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.Element")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Dungeon.DailyEntries", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.DailyEntries")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "Dungeon.UnlockId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Dungeon.UnlockId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
