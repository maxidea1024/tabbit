...
class DungeonFloorTable : Iterable<DungeonFloorRecord> {
     ...
     */
    override fun iterator(): Iterator<DungeonFloorRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): DungeonFloorRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, DungeonFloorRecord>>
