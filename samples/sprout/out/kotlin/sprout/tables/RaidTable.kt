...
/** Every row of Raid. */
class RaidTable : Iterable<RaidRecord> {
     ...
     */
    override fun iterator(): Iterator<RaidRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): RaidRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, RaidRecord>>
