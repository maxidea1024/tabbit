...
/** Every row of Gacha. */
class GachaTable : Iterable<GachaRecord> {
     ...
     */
    override fun iterator(): Iterator<GachaRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): GachaRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, GachaRecord>>
