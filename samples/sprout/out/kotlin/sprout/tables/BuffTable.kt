...
class BuffRecord {
    ...
    /** dispellable */
    var dispellable: Boolean = false

}

/** Every row of Buff. */
class BuffTable : Iterable<BuffRecord> {
     ...
     */
    override fun iterator(): Iterator<BuffRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): BuffRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, BuffRecord>>
    ...
    fun read(filename: String) {
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Buff.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                ...
                2 -> {
                    checkColumn(column, "Buff.NameKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Buff.NameKey")
                    var at = 0
                    while (at < count) {
                ...
                3 -> {
                    checkColumn(column, "Buff.Kind", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Buff.Kind")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "Buff.Icon", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Buff.Icon")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Buff.StackLimit", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Buff.StackLimit")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "Buff.Dispellable", KIND_SCALAR, false, ELEMENT_BOOL)
                    val cursor = ColumnCursor(reader, column, count, "Buff.Dispellable")
