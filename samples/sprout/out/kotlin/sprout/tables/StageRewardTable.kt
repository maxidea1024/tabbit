...
class StageRewardRecord {
    ...
    var stageId: Int = 0
    /** reward kind */
    var type: RewardType = RewardType.of(0)
    /** granted item */
    var itemId: Int = 0
    /** count */
    var count: Int = 0
...
class StageRewardTable : Iterable<StageRewardRecord> {
    ...
    private var byId: HashMap<Int, StageRewardRecord> = HashMap()
     ...
     */
    fun findById(key: Int): StageRewardRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): StageRewardRecord =
     ...
     */
    operator fun get(key: Int): StageRewardRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, StageRewardRecord>>
    ...
    fun read(filename: String) {
        ...
        val loadedById = HashMap<Int, StageRewardRecord>(count * 2)
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "StageReward.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "StageReward.StageId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.StageId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "StageReward.Type", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.Type")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "StageReward.ItemId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.ItemId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "StageReward.Count", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.Count")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "StageReward.Chance", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "StageReward.Chance")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
