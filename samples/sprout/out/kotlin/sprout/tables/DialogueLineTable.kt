...
class DialogueLineRecord {
    ...
    var lineOrder: Int = 0
    /** speaker */
    var speaker: DialogueSpeaker = DialogueSpeaker.of(0)
    /** portrait asset */
    var portrait: String = ""
    /** line key */
    var lineKey: String = ""
...
class DialogueLineTable : Iterable<DialogueLineRecord> {
     ...
     */
    var records: MutableList<DialogueLineRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<DialogueLineRecord> = records.iterator()

    private var byId: HashMap<Int, DialogueLineRecord> = HashMap()
     ...
     */
    fun findById(key: Int): DialogueLineRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): DialogueLineRecord =
     ...
     */
    operator fun get(key: Int): DialogueLineRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, DialogueLineRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<DialogueLineRecord>(count)
        val loadedById = HashMap<Int, DialogueLineRecord>(count * 2)

        repeat(count) { loaded.add(DialogueLineRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "DialogueLine.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "DialogueLine.DialogueId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.DialogueId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "DialogueLine.LineOrder", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.LineOrder")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "DialogueLine.Speaker", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.Speaker")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "DialogueLine.Portrait", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.Portrait")
                    var at = 0
                    while (at < count) {
                ...
                6 -> {
                    checkColumn(column, "DialogueLine.LineKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "DialogueLine.LineKey")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
