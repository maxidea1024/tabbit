...
class CharacterSkinTable : Iterable<CharacterSkinRecord> {
     ...
     */
    var records: MutableList<CharacterSkinRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<CharacterSkinRecord> = records.iterator()

    private var byId: HashMap<Int, CharacterSkinRecord> = HashMap()
     ...
     */
    fun findById(key: Int): CharacterSkinRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): CharacterSkinRecord =
     ...
     */
    operator fun get(key: Int): CharacterSkinRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, CharacterSkinRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<CharacterSkinRecord>(count)
        val loadedById = HashMap<Int, CharacterSkinRecord>(count * 2)

        repeat(count) { loaded.add(CharacterSkinRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "CharacterSkin.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "CharacterSkin.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "CharacterSkin.NameKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.NameKey")
                    var at = 0
                    while (at < count) {
                ...
                4 -> {
                    checkColumn(column, "CharacterSkin.Model", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.Model")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameString(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "CharacterSkin.Price", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.Price")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "CharacterSkin.IsDefault", KIND_SCALAR, false, ELEMENT_BOOL)
                    val cursor = ColumnCursor(reader, column, count, "CharacterSkin.IsDefault")
