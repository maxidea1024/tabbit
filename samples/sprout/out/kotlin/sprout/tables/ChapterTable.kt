...
class ChapterTable : Iterable<ChapterRecord> {
     ...
     */
    var records: MutableList<ChapterRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<ChapterRecord> = records.iterator()

    private var byId: HashMap<Int, ChapterRecord> = HashMap()
     ...
     */
    fun findById(key: Int): ChapterRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): ChapterRecord =
     ...
     */
    operator fun get(key: Int): ChapterRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, ChapterRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<ChapterRecord>(count)
        val loadedById = HashMap<Int, ChapterRecord>(count * 2)

        repeat(count) { loaded.add(ChapterRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Chapter.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Chapter.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Chapter.WorldId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Chapter.WorldId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "Chapter.NameKey", KIND_SCALAR, false, ELEMENT_STRING)
                    val cursor = ColumnCursor(reader, column, count, "Chapter.NameKey")
                    var at = 0
                    while (at < count) {
                ...
                4 -> {
                    checkColumn(column, "Chapter.SortOrder", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Chapter.SortOrder")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Chapter.UnlockId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Chapter.UnlockId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
