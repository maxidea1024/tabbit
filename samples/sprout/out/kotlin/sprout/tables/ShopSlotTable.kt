...
class ShopSlotTable : Iterable<ShopSlotRecord> {
     ...
     */
    var records: MutableList<ShopSlotRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<ShopSlotRecord> = records.iterator()

    private var byId: HashMap<Int, ShopSlotRecord> = HashMap()
     ...
     */
    fun findById(key: Int): ShopSlotRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): ShopSlotRecord =
     ...
     */
    operator fun get(key: Int): ShopSlotRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, ShopSlotRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<ShopSlotRecord>(count)
        val loadedById = HashMap<Int, ShopSlotRecord>(count * 2)

        repeat(count) { loaded.add(ShopSlotRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "ShopSlot.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "ShopSlot.ShopId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.ShopId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "ShopSlot.SlotOrder", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.SlotOrder")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "ShopSlot.ItemId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.ItemId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "ShopSlot.Count", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.Count")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                6 -> {
                    checkColumn(column, "ShopSlot.PriceId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.PriceId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                7 -> {
                    checkColumn(column, "ShopSlot.Weight", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "ShopSlot.Weight")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
