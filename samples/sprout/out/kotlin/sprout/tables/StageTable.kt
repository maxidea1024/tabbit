...
/** Every row of Stage. */
class StageTable : Iterable<StageRecord> {
     ...
     */
    override fun iterator(): Iterator<StageRecord> = records.iterator()
     ...
     */
    operator fun get(key: Int): StageRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, StageRecord>>
