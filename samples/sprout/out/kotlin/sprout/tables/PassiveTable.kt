...
class PassiveTable : Iterable<PassiveRecord> {
     ...
     */
    var records: MutableList<PassiveRecord> = ArrayList()
        private set
     ...
     */
    override fun iterator(): Iterator<PassiveRecord> = records.iterator()

    private var byId: HashMap<Int, PassiveRecord> = HashMap()
     ...
     */
    fun findById(key: Int): PassiveRecord? = byId[key]
     ...
     */
    fun getByIdOrThrow(key: Int): PassiveRecord =
     ...
     */
    operator fun get(key: Int): PassiveRecord? = findById(key)
     ...
     */
    val entries: Sequence<Pair<Int, PassiveRecord>>
    ...
    fun read(filename: String) {
        ...
        val loaded = ArrayList<PassiveRecord>(count)
        val loadedById = HashMap<Int, PassiveRecord>(count * 2)

        repeat(count) { loaded.add(PassiveRecord()) }
        ...
        for (column in header.columns) {
            ...
            when (column.tag) {
                1 -> {
                    checkColumn(column, "Passive.Id", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Passive.Id")
                    var at = 0
                    while (at < count) {
                ...
                2 -> {
                    checkColumn(column, "Passive.CharacterId", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Passive.CharacterId")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                3 -> {
                    checkColumn(column, "Passive.UnlockStep", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Passive.UnlockStep")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                4 -> {
                    checkColumn(column, "Passive.Stat", KIND_SCALAR, false, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Passive.Stat")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
                ...
                5 -> {
                    checkColumn(column, "Passive.Bonus", KIND_SCALAR, false, ELEMENT_I32, ELEMENT_VARINT)
                    val cursor = ColumnCursor(reader, column, count, "Passive.Bonus")
                    var at = 0
                    while (at < count) {
                        var n = cursor.nextSameI32(count - at)
                        while (n > 0) {
