...
func (t *SkillEffectTable) All() iter.Seq[*SkillEffectRecord] {
	records := t.records

	return func(yield func(*SkillEffectRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *SkillEffectTable) Entries() iter.Seq2[int32, *SkillEffectRecord] {
	records := t.records

	return func(yield func(int32, *SkillEffectRecord) bool) {
		for i := range records {
