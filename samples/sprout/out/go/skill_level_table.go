...
func (t *SkillLevelTable) All() iter.Seq[*SkillLevelRecord] {
	records := t.records

	return func(yield func(*SkillLevelRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *SkillLevelTable) Entries() iter.Seq2[int32, *SkillLevelRecord] {
	records := t.records

	return func(yield func(int32, *SkillLevelRecord) bool) {
		for i := range records {
