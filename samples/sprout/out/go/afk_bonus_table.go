...
func (t *AfkBonusTable) Count() int { return len(t.records) }
...
func (t *AfkBonusTable) All() iter.Seq[*AfkBonusRecord] {
	records := t.records

	return func(yield func(*AfkBonusRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *AfkBonusTable) Entries() iter.Seq2[int32, *AfkBonusRecord] {
	records := t.records

	return func(yield func(int32, *AfkBonusRecord) bool) {
		for i := range records {
