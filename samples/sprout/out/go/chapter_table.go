...
func (t *ChapterTable) Count() int { return len(t.records) }
...
func (t *ChapterTable) All() iter.Seq[*ChapterRecord] {
	records := t.records

	return func(yield func(*ChapterRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *ChapterTable) Entries() iter.Seq2[int32, *ChapterRecord] {
	records := t.records

	return func(yield func(int32, *ChapterRecord) bool) {
		for i := range records {
