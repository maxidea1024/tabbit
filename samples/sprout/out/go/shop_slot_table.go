...
func (t *ShopSlotTable) Records() []ShopSlotRecord { return t.records }
...
func (t *ShopSlotTable) All() iter.Seq[*ShopSlotRecord] {
	records := t.records

	return func(yield func(*ShopSlotRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *ShopSlotTable) FindById(key int32) *ShopSlotRecord {
...
func (t *ShopSlotTable) GetByIdOrError(key int32) (*ShopSlotRecord, error) {
	position, found := t.byId[key]
	if !found {
		return nil, fmt.Errorf(
			"there is no record in table `ShopSlot` that corresponds to field `Id` value %v", key)
	}
...
func (t *ShopSlotTable) ContainsId(key int32) bool {
	_, found := t.byId[key]
	return found
}
...
func (t *ShopSlotTable) Entries() iter.Seq2[int32, *ShopSlotRecord] {
	records := t.records

	return func(yield func(int32, *ShopSlotRecord) bool) {
		for i := range records {
...
func (t *ShopSlotTable) Read(filename string) error {
	...
	records := make([]ShopSlotRecord, count)
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "ShopSlot.Id", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.Id")
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "ShopSlot.ShopId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.ShopId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "ShopSlot.SlotOrder", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.SlotOrder")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 4:
			if tabbit.CheckColumn(reader, column, "ShopSlot.ItemId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.ItemId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 5:
			if tabbit.CheckColumn(reader, column, "ShopSlot.Count", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.Count")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 6:
			if tabbit.CheckColumn(reader, column, "ShopSlot.PriceId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.PriceId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 7:
			if tabbit.CheckColumn(reader, column, "ShopSlot.Weight", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "ShopSlot.Weight")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
	...
	if err := reader.Err(); err != nil {
		return fmt.Errorf("ShopSlot: %w", err)
	}
