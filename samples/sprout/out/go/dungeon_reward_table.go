...
// DungeonRewardRecord was generated from samples/sprout/xlsx/Dungeon.xlsx : DungeonRewardTable : A1.
type DungeonRewardRecord struct {
	// primary index
	Id int32
	// granted item
	ItemId int32
...
func (t *DungeonRewardTable) Records() []DungeonRewardRecord { return t.records }
...
func (t *DungeonRewardTable) All() iter.Seq[*DungeonRewardRecord] {
	records := t.records

	return func(yield func(*DungeonRewardRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *DungeonRewardTable) FindById(key int32) *DungeonRewardRecord {
...
func (t *DungeonRewardTable) GetByIdOrError(key int32) (*DungeonRewardRecord, error) {
	position, found := t.byId[key]
	if !found {
		return nil, fmt.Errorf(
			"there is no record in table `DungeonReward` that corresponds to field `Id` value %v", key)
	}
...
func (t *DungeonRewardTable) ContainsId(key int32) bool {
	_, found := t.byId[key]
	return found
}
...
func (t *DungeonRewardTable) Entries() iter.Seq2[int32, *DungeonRewardRecord] {
	records := t.records

	return func(yield func(int32, *DungeonRewardRecord) bool) {
		for i := range records {
...
func (t *DungeonRewardTable) Read(filename string) error {
	...
	records := make([]DungeonRewardRecord, count)
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "DungeonReward.Id", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "DungeonReward.Id")
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "DungeonReward.ItemId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "DungeonReward.ItemId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "DungeonReward.MinCount", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "DungeonReward.MinCount")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 4:
			if tabbit.CheckColumn(reader, column, "DungeonReward.MaxCount", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "DungeonReward.MaxCount")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 5:
			if tabbit.CheckColumn(reader, column, "DungeonReward.Chance", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "DungeonReward.Chance")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
	...
	if err := reader.Err(); err != nil {
		return fmt.Errorf("DungeonReward: %w", err)
	}
