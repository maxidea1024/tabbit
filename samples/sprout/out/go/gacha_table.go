...
func (t *GachaTable) All() iter.Seq[*GachaRecord] {
	records := t.records

	return func(yield func(*GachaRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *GachaTable) Entries() iter.Seq2[int32, *GachaRecord] {
	records := t.records

	return func(yield func(int32, *GachaRecord) bool) {
		for i := range records {
