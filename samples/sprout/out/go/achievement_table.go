...
func (t *AchievementTable) Records() []AchievementRecord { return t.records }
...
func (t *AchievementTable) All() iter.Seq[*AchievementRecord] {
	records := t.records

	return func(yield func(*AchievementRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *AchievementTable) FindById(key int32) *AchievementRecord {
...
func (t *AchievementTable) GetByIdOrError(key int32) (*AchievementRecord, error) {
	position, found := t.byId[key]
	if !found {
		return nil, fmt.Errorf(
			"there is no record in table `Achievement` that corresponds to field `Id` value %v", key)
	}
...
func (t *AchievementTable) ContainsId(key int32) bool {
	_, found := t.byId[key]
	return found
}
...
func (t *AchievementTable) Entries() iter.Seq2[int32, *AchievementRecord] {
	records := t.records

	return func(yield func(int32, *AchievementRecord) bool) {
		for i := range records {
...
func (t *AchievementTable) Read(filename string) error {
	...
	records := make([]AchievementRecord, count)
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "Achievement.Id", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.Id")
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "Achievement.TitleKey", tabbit.KindScalar, false, tabbit.ElementString) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.TitleKey")
				for i := int32(0); i < count; {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "Achievement.ConditionId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.ConditionId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 4:
			if tabbit.CheckColumn(reader, column, "Achievement.TargetCount", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.TargetCount")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 5:
			if tabbit.CheckColumn(reader, column, "Achievement.RewardId", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.RewardId")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 6:
			if tabbit.CheckColumn(reader, column, "Achievement.Badge", tabbit.KindScalar, false, tabbit.ElementString) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Achievement.Badge")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameString(count - i)
					for ; n > 0; n-- {
