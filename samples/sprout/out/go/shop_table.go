...
// ShopRecord was generated from samples/sprout/xlsx/Shop.xlsx : ShopTable : A1.
...
func (t *ShopTable) Count() int { return len(t.records) }
...
func (t *ShopTable) All() iter.Seq[*ShopRecord] {
	records := t.records

	return func(yield func(*ShopRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *ShopTable) Entries() iter.Seq2[int32, *ShopRecord] {
	records := t.records

	return func(yield func(int32, *ShopRecord) bool) {
		for i := range records {
