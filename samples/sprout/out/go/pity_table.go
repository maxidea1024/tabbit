...
func (t *PityTable) Count() int { return len(t.records) }
...
func (t *PityTable) All() iter.Seq[*PityRecord] {
	records := t.records

	return func(yield func(*PityRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *PityTable) Entries() iter.Seq2[int32, *PityRecord] {
	records := t.records

	return func(yield func(int32, *PityRecord) bool) {
		for i := range records {
