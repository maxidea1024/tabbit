...
func (t *RoleBonusTable) Count() int { return len(t.records) }
...
func (t *RoleBonusTable) All() iter.Seq[*RoleBonusRecord] {
	records := t.records

	return func(yield func(*RoleBonusRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *RoleBonusTable) Entries() iter.Seq2[int32, *RoleBonusRecord] {
	records := t.records

	return func(yield func(int32, *RoleBonusRecord) bool) {
		for i := range records {
