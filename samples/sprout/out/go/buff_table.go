...
func (t *BuffTable) All() iter.Seq[*BuffRecord] {
	records := t.records

	return func(yield func(*BuffRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *BuffTable) Entries() iter.Seq2[int32, *BuffRecord] {
	records := t.records

	return func(yield func(int32, *BuffRecord) bool) {
		for i := range records {
...
func (t *BuffTable) Read(filename string) error {
	...
	for _, column := range columns {
		...
		switch column.Tag {
		case 1:
			if tabbit.CheckColumn(reader, column, "Buff.Id", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.Id")
		...
		case 2:
			if tabbit.CheckColumn(reader, column, "Buff.NameKey", tabbit.KindScalar, false, tabbit.ElementString) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.NameKey")
				for i := int32(0); i < count; {
		...
		case 3:
			if tabbit.CheckColumn(reader, column, "Buff.Kind", tabbit.KindScalar, false, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.Kind")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 4:
			if tabbit.CheckColumn(reader, column, "Buff.Icon", tabbit.KindScalar, false, tabbit.ElementString) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.Icon")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameString(count - i)
					for ; n > 0; n-- {
		...
		case 5:
			if tabbit.CheckColumn(reader, column, "Buff.StackLimit", tabbit.KindScalar, false, tabbit.ElementI32, tabbit.ElementVarint) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.StackLimit")
				for i := int32(0); i < count; {
					n, value := cursor.NextSameI32(count - i)
					for ; n > 0; n-- {
		...
		case 6:
			if tabbit.CheckColumn(reader, column, "Buff.Dispellable", tabbit.KindScalar, false, tabbit.ElementBool) {
				cursor := tabbit.NewColumnCursor(reader, column, count, "Buff.Dispellable")
				for i := int32(0); i < count; i++ {
					r := &records[i]
					r.Dispellable = cursor.NextBool()
				}
			}
		default:
