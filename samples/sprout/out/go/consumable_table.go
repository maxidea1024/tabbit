...
func (t *ConsumableTable) Count() int { return len(t.records) }
...
func (t *ConsumableTable) All() iter.Seq[*ConsumableRecord] {
	records := t.records

	return func(yield func(*ConsumableRecord) bool) {
		for i := range records {
			if !yield(&records[i]) {
				return
			}
...
func (t *ConsumableTable) Entries() iter.Seq2[int32, *ConsumableRecord] {
	records := t.records

	return func(yield func(int32, *ConsumableRecord) bool) {
		for i := range records {
