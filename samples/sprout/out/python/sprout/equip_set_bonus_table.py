...
class EquipSetBonusRecord:
    ...
    def __repr__(self):
        return "EquipSetBonusRecord(id=%r, set_id=%r, pieces=%r, stat=%r, bonus=%r)" % (self.id, self.set_id, self.pieces, self.stat, self.bonus)
...
class EquipSetBonusTable:
    ...
    def read(self, filename):
        ...
        records = [EquipSetBonusRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSetBonus.Id")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSetBonus.SetId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSetBonus.Pieces")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSetBonus.Stat")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSetBonus.Bonus")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
