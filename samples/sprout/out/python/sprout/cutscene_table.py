...
class CutsceneRecord:
    ...
    __slots__ = ("id", "timeline", "length_ms", "skip_after_ms")

    def __init__(self):
        self.id = 0
        self.timeline = ""
        self.length_ms = 0
        self.skip_after_ms = 0

    def __repr__(self):
        return "CutsceneRecord(id=%r, timeline=%r, length_ms=%r, skip_after_ms=%r)" % (self.id, self.timeline, self.length_ms, self.skip_after_ms)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Cutscene.Timeline")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Cutscene.LengthMs")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Cutscene.SkipAfterMs")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
