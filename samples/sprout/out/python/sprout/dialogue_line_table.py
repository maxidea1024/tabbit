...
class DialogueLineRecord:
    ...
    def __init__(self):
        ...
        self.dialogue_id = 0
        self.line_order = 0
        self.speaker = DialogueSpeaker(0)
        self.portrait = ""
        self.line_key = ""

    def __repr__(self):
        return "DialogueLineRecord(id=%r, dialogue_id=%r, line_order=%r, speaker=%r, portrait=%r, line_key=%r)" % (self.id, self.dialogue_id, self.line_order, self.speaker, self.portrait, self.line_key)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "DialogueLine.DialogueId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "DialogueLine.LineOrder")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "DialogueLine.Speaker")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "DialogueLine.Portrait")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "DialogueLine.LineKey")
                at = 0
                while at < count:
                    n, value = cursor.next_same_string(count - at)
                    for i in range(at, at + n):
