...
class CharacterSkinRecord:
    ...
    def __repr__(self):
        return "CharacterSkinRecord(id=%r, character_id=%r, name_key=%r, model=%r, price=%r, is_default=%r)" % (self.id, self.character_id, self.name_key, self.model, self.price, self.is_default)
...
class CharacterSkinTable:
    ...
    def read(self, filename):
        ...
        records = [CharacterSkinRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.Id")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.CharacterId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.NameKey")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.Model")
                at = 0
                while at < count:
                    n, value = cursor.next_same_string(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.Price")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "CharacterSkin.IsDefault")
