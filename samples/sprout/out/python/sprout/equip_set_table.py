...
class EquipSetRecord:
    ...
    def __repr__(self):
        return "EquipSetRecord(id=%r, name_key=%r, member_ids=%r)" % (self.id, self.name_key, self.member_ids)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSet.NameKey")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "EquipSet.MemberIds")
                for record in records:
                    element_count = cursor.next_length()
                    record.member_ids = [cursor.next_i32() for _ in range(element_count)]
            else:
