...
class RaidRecord:
    ...
    def __repr__(self):
        return "RaidRecord(id=%r, name_key=%r, boss_id=%r, boss_health=%r, turn_limit=%r, season_days=%r)" % (self.id, self.name_key, self.boss_id, self.boss_health, self.turn_limit, self.season_days)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Raid.NameKey")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Raid.BossId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Raid.BossHealth")
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Raid.TurnLimit")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Raid.SeasonDays")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
