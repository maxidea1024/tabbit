...
class PowerScoreRecord:
    ...
    def __repr__(self):
        return "PowerScoreRecord(id=%r, stat=%r, weight=%r)" % (self.id, self.stat, self.weight)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "PowerScore.Stat")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "PowerScore.Weight")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
