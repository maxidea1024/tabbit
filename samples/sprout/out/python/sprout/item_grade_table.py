...
class ItemGradeRecord:
    ...
    __slots__ = ("id", "grade", "frame", "sell_scale")
    ...
    def __repr__(self):
        return "ItemGradeRecord(id=%r, grade=%r, frame=%r, sell_scale=%r)" % (self.id, self.grade, self.frame, self.sell_scale)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ItemGrade.Grade")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ItemGrade.Frame")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "ItemGrade.SellScale")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
