...
class OfflineRewardRecord:
    ...
    def __repr__(self):
        return "OfflineRewardRecord(id=%r, account_level=%r, gold_per_hour=%r, exp_per_hour=%r, loot_group_id=%r)" % (self.id, self.account_level, self.gold_per_hour, self.exp_per_hour, self.loot_group_id)
...
class OfflineRewardTable:
    ...
    def read(self, filename):
        ...
        records = [OfflineRewardRecord() for _ in range(count)]
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "OfflineReward.Id")
                at = 0
                while at < count:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "OfflineReward.AccountLevel")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "OfflineReward.GoldPerHour")
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "OfflineReward.ExpPerHour")
                for record in records:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "OfflineReward.LootGroupId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
