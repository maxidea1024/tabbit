...
class SkillEffectRecord:
    ...
    def __init__(self):
        self.id = 0
        self.kind = BuffKind(0)
        self.stat = StatType(0)
        self.magnitude = 0
        self.duration = 0
        self.chance = 0

    def __repr__(self):
        return "SkillEffectRecord(id=%r, kind=%r, stat=%r, magnitude=%r, duration=%r, chance=%r)" % (self.id, self.kind, self.stat, self.magnitude, self.duration, self.chance)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "SkillEffect.Kind")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "SkillEffect.Stat")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "SkillEffect.Magnitude")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "SkillEffect.Duration")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "SkillEffect.Chance")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
