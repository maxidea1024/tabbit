...
class WeeklyQuestRecord:
    ...
    def __init__(self):
        ...
        self.quest_id = 0
        self.points = 0
        self.reset_weekday = 0

    def __repr__(self):
        return "WeeklyQuestRecord(id=%r, quest_id=%r, points=%r, reset_weekday=%r)" % (self.id, self.quest_id, self.points, self.reset_weekday)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "WeeklyQuest.QuestId")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "WeeklyQuest.Points")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "WeeklyQuest.ResetWeekday")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
