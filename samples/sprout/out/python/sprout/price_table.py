...
class PriceRecord:
    ...
    __slots__ = ("id", "currency", "amount", "discount")

    def __init__(self):
        self.id = 0
        self.currency = CurrencyType(0)
        self.amount = 0
        self.discount = 0

    def __repr__(self):
        return "PriceRecord(id=%r, currency=%r, amount=%r, discount=%r)" % (self.id, self.currency, self.amount, self.discount)
    ...
    def read(self, filename):
        ...
        for column in columns:
            ...
            if column.tag == 1:
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Price.Currency")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Price.Amount")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
                ...
                cursor = tabbit.ColumnCursor(reader, column, count, "Price.Discount")
                at = 0
                while at < count:
                    n, value = cursor.next_same_i32(count - at)
                    for i in range(at, at + n):
