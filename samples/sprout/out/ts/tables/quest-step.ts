...
export class QuestStepRecord {
  ...
  /** step order */
  public get stepOrder(): number { return this._stepOrder }

  /** completion condition */
  public get conditionId(): number { return this._conditionId }

  /** target count */
  public get targetCount(): number { return this._targetCount }
  ...
  public _stepOrder: number = 0
  public _conditionId: number = 0
  public _targetCount: number = 0
  ...
  public populateFieldValues(dataRow: IDataRow): void {
    ...
    this._stepOrder = dataRow.stepOrder
    this._conditionId = dataRow.conditionId
    this._targetCount = dataRow.targetCount
  ...
  public populateFieldValuesCompact(dataRow: any[]): void {
    ...
    this._stepOrder = dataRow[offset++]
    this._conditionId = dataRow[offset++]
    this._targetCount = dataRow[offset++]
...
export class QuestStepTable {
  ...
  /** All records. */
  public get records(): QuestStepRecord[] { return this._records }
  private _records: QuestStepRecord[] = []
   ...
   */
  public [Symbol.iterator](): IterableIterator<QuestStepRecord> {
    return this._records[Symbol.iterator]()
  }

  // Indexing by 'id'
  public get recordsById(): Map<number, QuestStepRecord> { return this._recordsById }
  private _recordsById: Map<number, QuestStepRecord> = new Map<number, QuestStepRecord>()
   ...
   */
  public findById(key: number): QuestStepRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): QuestStepRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "QuestStep" that corresponds to field "id" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, QuestStepRecord]> {
  ...
  private readFromJson(json: string): void {
    ...
    const records: QuestStepRecord[] = []

    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new QuestStepRecord()
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (let i = 0; i < rowCount; ++i)
      records.push(new QuestStepRecord())
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'QuestStep.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'QuestStep.QuestId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.QuestId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'QuestStep.StepOrder', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.StepOrder')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._stepOrder = value
          }
          break
        case 4:
          tabbit.checkColumn(column, 'QuestStep.ConditionId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.ConditionId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'QuestStep.TargetCount', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.TargetCount')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._targetCount = value
          }
          break
        case 6:
          tabbit.checkColumn(column, 'QuestStep.DialogueId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'QuestStep.DialogueId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
   ...
   */
  private publish(records: QuestStepRecord[]): void {
    const recordsById = new Map<number, QuestStepRecord>()
