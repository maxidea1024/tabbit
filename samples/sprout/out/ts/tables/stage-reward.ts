...
export class StageRewardRecord {
  ...
  /** reward kind */
  public get type(): RewardType { return this._type }
  ...
  public _type: RewardType = 0 as RewardType
...
export class StageRewardTable {
  ...
  // Indexing by 'id'
  public get recordsById(): Map<number, StageRewardRecord> { return this._recordsById }
  private _recordsById: Map<number, StageRewardRecord> = new Map<number, StageRewardRecord>()
   ...
   */
  public findById(key: number): StageRewardRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): StageRewardRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "StageReward" that corresponds to field "id" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, StageRewardRecord]> {
  ...
  public readBinaryFrom(fileBytes: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'StageReward.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'StageReward.StageId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.StageId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'StageReward.Type', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.Type')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._type = value as RewardType
          }
          break
        case 4:
          tabbit.checkColumn(column, 'StageReward.ItemId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.ItemId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'StageReward.Count', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.Count')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 6:
          tabbit.checkColumn(column, 'StageReward.Chance', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'StageReward.Chance')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
  ...
  private publish(records: StageRewardRecord[]): void {
    const recordsById = new Map<number, StageRewardRecord>()
