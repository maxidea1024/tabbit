...
export class SkillRecord {
  ...
  /** target rule */
  public get target(): TargetType { return this._target }

  /** cooldown in turns */
  public get cooldown(): number { return this._cooldown }

  /** effect ids */
  public get effectIds(): number[] { return this._effectIds }
  ...
  public _icon: string = ''
  public _target: TargetType = 0 as TargetType
  public _cooldown: number = 0
  public _effectIds: number[] = []
  ...
  public populateFieldValues(dataRow: IDataRow): void {
    ...
    this._target = dataRow.target
    this._cooldown = dataRow.cooldown
    this._effectIds = dataRow.effectIds
  ...
  public populateFieldValuesCompact(dataRow: any[]): void {
    ...
    this._target = dataRow[offset++]
    this._cooldown = dataRow[offset++]
    this._effectIds = dataRow[offset++]
...
export class SkillTable {
   ...
   */
  public [Symbol.iterator](): IterableIterator<SkillRecord> {
   ...
   */
  public *entries(): IterableIterator<[number, SkillRecord]> {
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Skill.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Skill.NameKey', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.NameKey')
          for (let i = 0; i < rowCount; ) {
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Skill.DescKey', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.DescKey')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameString(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 4:
          tabbit.checkColumn(column, 'Skill.Icon', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.Icon')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameString(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'Skill.Target', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.Target')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._target = value as TargetType
          }
          break
        case 6:
          tabbit.checkColumn(column, 'Skill.Cooldown', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.Cooldown')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._cooldown = value
          }
          break
        case 7:
          tabbit.checkColumn(column, 'Skill.EffectIds', tabbit.KIND_ARRAY, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.EffectIds')
          for (let i = 0; i < rowCount; ++i) {
            const record = records[i]
            const elementCount = cursor.nextLength()
            record._effectIds = []
            for (let j = 0; j < elementCount; ++j) {
              record._effectIds.push(cursor.nextI32())
            }
          }
          break
        case 8:
          tabbit.checkColumn(column, 'Skill.MaxLevel', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Skill.MaxLevel')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
