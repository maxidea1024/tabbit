...
export class AchievementTable {
  ...
  // Indexing by 'id'
  public get recordsById(): Map<number, AchievementRecord> { return this._recordsById }
  private _recordsById: Map<number, AchievementRecord> = new Map<number, AchievementRecord>()
   ...
   */
  public findById(key: number): AchievementRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): AchievementRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "Achievement" that corresponds to field "id" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, AchievementRecord]> {
  ...
  public readBinaryFrom(data: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Achievement.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Achievement.TitleKey', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.TitleKey')
          for (let i = 0; i < rowCount; ) {
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'Achievement.ConditionId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.ConditionId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 4:
          tabbit.checkColumn(column, 'Achievement.TargetCount', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.TargetCount')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'Achievement.RewardId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.RewardId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 6:
          tabbit.checkColumn(column, 'Achievement.Badge', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Achievement.Badge')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameString(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._badge = value
          }
          break
        default:
  ...
  private publish(records: AchievementRecord[]): void {
    const recordsById = new Map<number, AchievementRecord>()
