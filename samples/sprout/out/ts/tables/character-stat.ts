...
export class CharacterStatRecord {
  ...
  /** required experience */
  public get requiredExp(): bigint { return this._requiredExp }
  ...
  public _requiredExp: bigint = 0n
  public _attack: number = 0
  public _defense: number = 0
  public _health: number = 0
  ...
  public populateFieldValues(dataRow: IDataRow): void {
    ...
    this._requiredExp = BigInt(dataRow.requiredExp)
    this._attack = dataRow.attack
    this._defense = dataRow.defense
    this._health = dataRow.health
  }
  ...
  public populateFieldValuesCompact(dataRow: any[]): void {
    ...
    this._requiredExp = BigInt(dataRow[offset++])
    this._attack = dataRow[offset++]
    this._defense = dataRow[offset++]
    this._health = dataRow[offset++]
  }
}
...
export class CharacterStatTable {
  ...
  /** All records. */
  public get records(): CharacterStatRecord[] { return this._records }
  private _records: CharacterStatRecord[] = []
   ...
   */
  public [Symbol.iterator](): IterableIterator<CharacterStatRecord> {
    return this._records[Symbol.iterator]()
  }

  // Indexing by 'id'
  public get recordsById(): Map<number, CharacterStatRecord> { return this._recordsById }
  private _recordsById: Map<number, CharacterStatRecord> = new Map<number, CharacterStatRecord>()
   ...
   */
  public findById(key: number): CharacterStatRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): CharacterStatRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "CharacterStat" that corresponds to field "id" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, CharacterStatRecord]> {
  ...
  public readJsonFrom(json: string): void {
    ...
    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new CharacterStatRecord()
  ...
  public readBinaryFrom(fileBytes: Uint8Array): void {
    ...
    for (let i = 0; i < rowCount; ++i)
      records.push(new CharacterStatRecord())
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'CharacterStat.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'CharacterStat.CharacterId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.CharacterId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'CharacterStat.Level', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.Level')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 4:
          tabbit.checkColumn(column, 'CharacterStat.RequiredExp', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I64, tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.RequiredExp')
          for (let i = 0; i < rowCount; ++i) {
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'CharacterStat.Attack', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.Attack')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 6:
          tabbit.checkColumn(column, 'CharacterStat.Defense', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.Defense')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 7:
          tabbit.checkColumn(column, 'CharacterStat.Health', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'CharacterStat.Health')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._health = value
          }
          break
        default:
   ...
   */
  private publish(records: CharacterStatRecord[]): void {
    const recordsById = new Map<number, CharacterStatRecord>()
