...
export class ConditionRecord {
  ...
  /** condition kind */
  public get type(): ConditionType { return this._type }
  ...
  public _id: number = 0
  public _type: ConditionType = 0 as ConditionType
...
export class ConditionTable {
   ...
   */
  public [Symbol.iterator](): IterableIterator<ConditionRecord> {
   ...
   */
  public *entries(): IterableIterator<[number, ConditionRecord]> {
  ...
  public readBinaryFrom(fileBytes: Uint8Array): void {
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'Condition.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Condition.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'Condition.Type', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Condition.Type')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._type = value as ConditionType
          }
          break
        case 3:
          tabbit.checkColumn(column, 'Condition.Value', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Condition.Value')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 4:
          tabbit.checkColumn(column, 'Condition.TargetId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Condition.TargetId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._targetId = value
          }
          break
        case 5:
          tabbit.checkColumn(column, 'Condition.DescKey', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_STRING])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'Condition.DescKey')
          for (let i = 0; i < rowCount; ) {
