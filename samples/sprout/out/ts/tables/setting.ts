...
export class SettingTable {
   ...
   */
  public [Symbol.iterator](): IterableIterator<SettingRecord> {
   ...
   * which column the key is: settingKey here, something else in the next table.
   *
   ...
   */
  public *entries(): IterableIterator<[string, SettingRecord]> {
    for (const record of this._records) {
      yield [record.settingKey, record]
    }
  }
