...
export class EquipSetBonusRecord {
  ...
  /** pieces required */
  public get pieces(): number { return this._pieces }
...
export class EquipSetBonusTable {
  ...
  /** All records. */
  public get records(): EquipSetBonusRecord[] { return this._records }
  private _records: EquipSetBonusRecord[] = []
   ...
   */
  public [Symbol.iterator](): IterableIterator<EquipSetBonusRecord> {
    return this._records[Symbol.iterator]()
  }

  // Indexing by 'id'
  public get recordsById(): Map<number, EquipSetBonusRecord> { return this._recordsById }
  private _recordsById: Map<number, EquipSetBonusRecord> = new Map<number, EquipSetBonusRecord>()
   ...
   */
  public findById(key: number): EquipSetBonusRecord | undefined {
   ...
   */
  public getByIdOrThrow(key: number): EquipSetBonusRecord {
    const found = this._recordsById.get(key)
    if (!found)
      throw new Error(`There is no record in table "EquipSetBonus" that corresponds to field "id" value ${key}`)
   ...
   */
  public *entries(): IterableIterator<[number, EquipSetBonusRecord]> {
  ...
  public readJsonFrom(json: string): void {
    ...
    const records: EquipSetBonusRecord[] = []

    if (this.isCompactRowFormatted(dataRows)) {
      for (const dataRow of dataRows) {
        const record = new EquipSetBonusRecord()
  ...
  public readBinaryFrom(fileBytes: Uint8Array): void {
    ...
    for (let i = 0; i < rowCount; ++i)
      records.push(new EquipSetBonusRecord())
    ...
    for (const column of columns) {
      ...
      switch (column.tag) {
        case 1:
          tabbit.checkColumn(column, 'EquipSetBonus.Id', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'EquipSetBonus.Id')
          ...
          break
        case 2:
          tabbit.checkColumn(column, 'EquipSetBonus.SetId', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'EquipSetBonus.SetId')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 3:
          tabbit.checkColumn(column, 'EquipSetBonus.Pieces', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'EquipSetBonus.Pieces')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
              records[i]._pieces = value
          }
          break
        case 4:
          tabbit.checkColumn(column, 'EquipSetBonus.Stat', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'EquipSetBonus.Stat')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
          ...
          break
        case 5:
          tabbit.checkColumn(column, 'EquipSetBonus.Bonus', tabbit.KIND_SCALAR, false, [tabbit.ELEMENT_I32, tabbit.ELEMENT_VARINT])
          cursor = new tabbit.TcbColumnCursor(reader, column, rowCount, 'EquipSetBonus.Bonus')
          for (let i = 0; i < rowCount; ) {
            const { n, value } = cursor.nextSameI32(rowCount - i)
            for (let left = n; left > 0; --left, ++i)
   ...
   */
  private publish(records: EquipSetBonusRecord[]): void {
    const recordsById = new Map<number, EquipSetBonusRecord>()
