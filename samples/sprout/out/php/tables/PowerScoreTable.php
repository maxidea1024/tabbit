...
final class PowerScoreTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, PowerScoreRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?PowerScoreRecord
    {
    ...
    {
        throw new \LogicException('PowerScoreTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PowerScoreRecord>
     */
