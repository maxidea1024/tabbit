...
final class ConsumableTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ConsumableRecord> */
     ...
     *
     * @return \Traversable<int, ConsumableRecord>
     */
    ...
    /** @var array<int, ConsumableRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?ConsumableRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): ConsumableRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?ConsumableRecord
    {
    ...
    {
        throw new \LogicException('ConsumableTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ConsumableRecord>
     */
