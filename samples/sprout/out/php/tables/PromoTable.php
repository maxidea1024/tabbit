...
/** Every row of Promo. */
final class PromoTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<PromoRecord> */
     ...
     *
     * @return \Traversable<int, PromoRecord>
     */
     ...
     */
    public function findById(int $key): ?PromoRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): PromoRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?PromoRecord
    {
    ...
    {
        throw new \LogicException('PromoTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PromoRecord>
     */
