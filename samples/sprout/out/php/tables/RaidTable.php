...
final class RaidRecord
{
    ...
    public int $seasonDays = 0;
}

/** Every row of Raid. */
final class RaidTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<RaidRecord> */
     ...
     *
     * @return \Traversable<int, RaidRecord>
     */
     ...
     */
    public function findById(int $key): ?RaidRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): RaidRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?RaidRecord
    {
    ...
    {
        throw new \LogicException('RaidTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, RaidRecord>
     */
