...
final class ItemGradeRecord
{
    ...
    public int $sellScale = 0;
}

/** Every row of ItemGrade. */
final class ItemGradeTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<ItemGradeRecord> */
     ...
     *
     * @return \Traversable<int, ItemGradeRecord>
     */
     ...
     */
    public function findById(int $key): ?ItemGradeRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): ItemGradeRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?ItemGradeRecord
    {
    ...
    {
        throw new \LogicException('ItemGradeTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ItemGradeRecord>
     */
