...
final class LootGroupTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<LootGroupRecord> */
     ...
     *
     * @return \Traversable<int, LootGroupRecord>
     */
     ...
     */
    public function findById(int $key): ?LootGroupRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): LootGroupRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?LootGroupRecord
    {
    ...
    {
        throw new \LogicException('LootGroupTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, LootGroupRecord>
     */
