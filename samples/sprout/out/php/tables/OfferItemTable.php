...
final class OfferItemTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<OfferItemRecord> */
     ...
     *
     * @return \Traversable<int, OfferItemRecord>
     */
     ...
     */
    public function findById(int $key): ?OfferItemRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): OfferItemRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?OfferItemRecord
    {
    ...
    {
        throw new \LogicException('OfferItemTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, OfferItemRecord>
     */
