...
final class MailRewardTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<MailRewardRecord> */
     ...
     *
     * @return \Traversable<int, MailRewardRecord>
     */
    ...
    /** @var array<int, MailRewardRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?MailRewardRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): MailRewardRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?MailRewardRecord
    {
    ...
    {
        throw new \LogicException('MailRewardTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, MailRewardRecord>
     */
