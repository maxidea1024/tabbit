...
final class AchievementTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, AchievementRecord>
     */
    ...
    /** @var array<int, AchievementRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?AchievementRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): AchievementRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?AchievementRecord
    {
    ...
    {
        throw new \LogicException('AchievementTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, AchievementRecord>
     */
