...
final class CutsceneRecord
{
    ...
    public int $lengthMs = 0;
    /** skippable after milliseconds */
    public int $skipAfterMs = 0;
}

/** Every row of Cutscene. */
final class CutsceneTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<CutsceneRecord> */
     ...
     *
     * @return \Traversable<int, CutsceneRecord>
     */
     ...
     */
    public function findById(int $key): ?CutsceneRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): CutsceneRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?CutsceneRecord
    {
    ...
    {
        throw new \LogicException('CutsceneTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, CutsceneRecord>
     */
