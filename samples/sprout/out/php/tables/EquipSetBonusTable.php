 ...
 */
final class EquipSetBonusRecord
{
    /** primary index */
    public int $id = 0;
    /** owning set */
...
final class EquipSetBonusTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<EquipSetBonusRecord> */
     ...
     *
     * @return \Traversable<int, EquipSetBonusRecord>
     */
    ...
    /** @var array<int, EquipSetBonusRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?EquipSetBonusRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): EquipSetBonusRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?EquipSetBonusRecord
    {
    ...
    {
        throw new \LogicException('EquipSetBonusTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, EquipSetBonusRecord>
     */
    ...
    public function read(string $filename): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            $records[] = new EquipSetBonusRecord();
        }
