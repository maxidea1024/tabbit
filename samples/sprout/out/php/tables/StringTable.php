...
final class StringTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     */
    public function findByStringKey(string $key): ?StringRecord
    {
        return $this->byStringKey[$key] ?? null;
    }
     ...
     */
    public function getByStringKeyOrThrow(string $key): StringRecord
    {
        $record = $this->byStringKey[$key] ?? null;
    ...
    public function read(string $filename): void
    {
        ...
        foreach ($records as $record) {
            $byStringKey[$record->stringKey] = $record;
        }

        // Published, now that every column read.
        $this->records = $records;
        $this->byStringKey = $byStringKey;
    }
}
