...
final class StageWaveRecord
{
    ...
    /** monster levels */
    /** @var list<int> */
    public array $monsterLevels = [];
}

/** Every row of StageWave. */
final class StageWaveTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<StageWaveRecord> */
     ...
     *
     * @return \Traversable<int, StageWaveRecord>
     */
     ...
     */
    public function findById(int $key): ?StageWaveRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): StageWaveRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?StageWaveRecord
    {
    ...
    {
        throw new \LogicException('StageWaveTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, StageWaveRecord>
     */
            ...
            switch ($column['tag']) {
                ...
                case 4:
                    ...
                    foreach ($records as $record) {
                        ...
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->monsterIds[] = $cursor->nextI32();
                        }
                    }
                    break;
                ...
                case 5:
                    ...
                    foreach ($records as $record) {
                        ...
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->monsterLevels[] = $cursor->nextI32();
                        }
                    }
                    break;
