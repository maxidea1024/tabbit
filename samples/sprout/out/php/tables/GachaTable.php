...
/** Every row of Gacha. */
final class GachaTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<GachaRecord> */
     ...
     *
     * @return \Traversable<int, GachaRecord>
     */
     ...
     */
    public function findById(int $key): ?GachaRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): GachaRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?GachaRecord
    {
    ...
    {
        throw new \LogicException('GachaTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, GachaRecord>
     */
    ...
    public function read(string $filename): void
    {
        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                case 1:
                    TcbReader::checkColumn($column, 'Gacha.Id', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_I32, TcbReader::ELEMENT_VARINT]);
                ...
                case 2:
                    TcbReader::checkColumn($column, 'Gacha.Type', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_VARINT]);
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'Gacha.Type');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                            $records[$i]->type = GachaType::tryFrom($value) ?? GachaType::None;
                        }
                    }
                    break;

                case 3:
                    TcbReader::checkColumn($column, 'Gacha.NameKey', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_STRING]);
                ...
                case 4:
                    TcbReader::checkColumn($column, 'Gacha.Banner', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_STRING]);
                ...
                case 5:
                    TcbReader::checkColumn($column, 'Gacha.PriceId', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_I32, TcbReader::ELEMENT_VARINT]);
                ...
                case 6:
                    TcbReader::checkColumn($column, 'Gacha.PityId', TcbReader::KIND_SCALAR, false, [TcbReader::ELEMENT_I32, TcbReader::ELEMENT_VARINT]);
