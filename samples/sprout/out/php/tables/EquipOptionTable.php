...
final class EquipOptionTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<EquipOptionRecord> */
     ...
     *
     * @return \Traversable<int, EquipOptionRecord>
     */
    ...
    /** @var array<int, EquipOptionRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?EquipOptionRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): EquipOptionRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?EquipOptionRecord
    {
    ...
    {
        throw new \LogicException('EquipOptionTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, EquipOptionRecord>
     */
