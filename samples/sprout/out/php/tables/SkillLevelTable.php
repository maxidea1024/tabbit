...
final class SkillLevelTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<SkillLevelRecord> */
     ...
     *
     * @return \Traversable<int, SkillLevelRecord>
     */
    ...
    /** @var array<int, SkillLevelRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?SkillLevelRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): SkillLevelRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?SkillLevelRecord
    {
    ...
    {
        throw new \LogicException('SkillLevelTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, SkillLevelRecord>
     */
