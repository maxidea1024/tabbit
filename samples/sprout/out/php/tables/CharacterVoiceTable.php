 ...
 */
final class CharacterVoiceRecord
{
    /** primary index */
    public int $id = 0;
    /** owning character */
...
final class CharacterVoiceTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<CharacterVoiceRecord> */
     ...
     *
     * @return \Traversable<int, CharacterVoiceRecord>
     */
    ...
    /** @var array<int, CharacterVoiceRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?CharacterVoiceRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): CharacterVoiceRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?CharacterVoiceRecord
    {
    ...
    {
        throw new \LogicException('CharacterVoiceTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, CharacterVoiceRecord>
     */
    ...
    public function read(string $filename): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            $records[] = new CharacterVoiceRecord();
        }
