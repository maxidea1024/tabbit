...
final class PriceRecord
{
    ...
    public int $id = 0;
    /** currency */
    public CurrencyType $currency = CurrencyType::None;
    /** amount */
    public int $amount = 0;
...
/** Every row of Price. */
final class PriceTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, PriceRecord>
     */
     ...
     */
    public function findById(int $key): ?PriceRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): PriceRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?PriceRecord
    {
    ...
    {
        throw new \LogicException('PriceTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PriceRecord>
     */
            ...
            switch ($column['tag']) {
                ...
                case 2:
                    ...
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                            $records[$i]->currency = CurrencyType::tryFrom($value) ?? CurrencyType::None;
                        }
                    }
                    break;
