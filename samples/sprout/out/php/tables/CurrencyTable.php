...
final class CurrencyTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     */
    public function offsetGet(mixed $offset): ?CurrencyRecord
    {
    ...
    {
        throw new \LogicException('CurrencyTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, CurrencyRecord>
     */
