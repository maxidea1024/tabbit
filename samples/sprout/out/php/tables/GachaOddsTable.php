...
final class GachaOddsTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<GachaOddsRecord> */
     ...
     *
     * @return \Traversable<int, GachaOddsRecord>
     */
     ...
     */
    public function findById(int $key): ?GachaOddsRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): GachaOddsRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?GachaOddsRecord
    {
    ...
    {
        throw new \LogicException('GachaOddsTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, GachaOddsRecord>
     */
