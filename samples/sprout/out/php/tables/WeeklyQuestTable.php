...
final class WeeklyQuestRecord
{
    ...
    public int $resetWeekday = 0;
}

/** Every row of WeeklyQuest. */
final class WeeklyQuestTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<WeeklyQuestRecord> */
     ...
     *
     * @return \Traversable<int, WeeklyQuestRecord>
     */
    ...
    /** @var array<int, WeeklyQuestRecord> */
    private array $byId = [];
     ...
     */
    public function findById(int $key): ?WeeklyQuestRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): WeeklyQuestRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?WeeklyQuestRecord
    {
    ...
    {
        throw new \LogicException('WeeklyQuestTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, WeeklyQuestRecord>
     */
