...
/** Every row of Table. */
final class TableTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, TableRecord>
     */
     ...
     */
    public function findById(int $key): ?TableRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): TableRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?TableRecord
    {
    ...
    {
        throw new \LogicException('TableTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, TableRecord>
     */
