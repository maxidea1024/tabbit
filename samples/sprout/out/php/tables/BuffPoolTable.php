...
final class BuffPoolTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<BuffPoolRecord> */
     ...
     *
     * @return \Traversable<int, BuffPoolRecord>
     */
     ...
     */
    public function findById(int $key): ?BuffPoolRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): BuffPoolRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?BuffPoolRecord
    {
    ...
    {
        throw new \LogicException('BuffPoolTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, BuffPoolRecord>
     */
