...
final class AfkBonusTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<AfkBonusRecord> */
     ...
     *
     * @return \Traversable<int, AfkBonusRecord>
     */
     ...
     */
    public function findById(int $key): ?AfkBonusRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): AfkBonusRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?AfkBonusRecord
    {
    ...
    {
        throw new \LogicException('AfkBonusTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, AfkBonusRecord>
     */
        ...
        foreach ($columns as $column) {
            ...
            switch ($column['tag']) {
                case 1:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'AfkBonus.Id');
                    for ($i = 0; $i < $count; ) {
                ...
                case 2:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'AfkBonus.Hours');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                ...
                case 3:
                    ...
                    $cursor = new TcbColumnCursor($reader, $column, $count, 'AfkBonus.Bonus');
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
