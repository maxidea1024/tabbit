...
final class ConditionTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
     ...
     *
     * @return \Traversable<int, ConditionRecord>
     */
     ...
     */
    public function offsetGet(mixed $offset): ?ConditionRecord
    {
    ...
    {
        throw new \LogicException('ConditionTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, ConditionRecord>
     */
            ...
            switch ($column['tag']) {
                ...
                case 2:
                    ...
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                            $records[$i]->type = ConditionType::tryFrom($value) ?? ConditionType::None;
                        }
                    }
                    break;
