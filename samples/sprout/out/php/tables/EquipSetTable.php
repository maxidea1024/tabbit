...
final class EquipSetTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<EquipSetRecord> */
     ...
     *
     * @return \Traversable<int, EquipSetRecord>
     */
     ...
     */
    public function findById(int $key): ?EquipSetRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): EquipSetRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?EquipSetRecord
    {
    ...
    {
        throw new \LogicException('EquipSetTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, EquipSetRecord>
     */
                ...
                case 3:
                    ...
                    foreach ($records as $record) {
                        ...
                        for ($j = 0; $j < $elementCount; $j++) {
                            $record->memberIds[] = $cursor->nextI32();
                        }
                    }
                    break;
