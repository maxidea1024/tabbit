...
final class CodexTierTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<CodexTierRecord> */
     ...
     *
     * @return \Traversable<int, CodexTierRecord>
     */
     ...
     */
    public function findById(int $key): ?CodexTierRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): CodexTierRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?CodexTierRecord
    {
    ...
    {
        throw new \LogicException('CodexTierTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, CodexTierRecord>
     */
