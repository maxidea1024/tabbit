...
/** Every row of Pity. */
final class PityTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<PityRecord> */
     ...
     *
     * @return \Traversable<int, PityRecord>
     */
     ...
     */
    public function findById(int $key): ?PityRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): PityRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?PityRecord
    {
    ...
    {
        throw new \LogicException('PityTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, PityRecord>
     */
