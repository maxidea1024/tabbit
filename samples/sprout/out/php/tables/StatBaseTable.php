...
final class StatBaseTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<StatBaseRecord> */
     ...
     *
     * @return \Traversable<int, StatBaseRecord>
     */
     ...
     */
    public function findById(int $key): ?StatBaseRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): StatBaseRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?StatBaseRecord
    {
    ...
    {
        throw new \LogicException('StatBaseTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, StatBaseRecord>
     */
