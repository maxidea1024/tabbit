...
final class UnlockRecord
{
    ...
    public int $id = 0;
    /** unlock kind */
    public UnlockType $type = UnlockType::None;
    /** condition */
...
/** Every row of Unlock. */
final class UnlockTable implements \Countable, \IteratorAggregate, \ArrayAccess
{
    /** @var list<UnlockRecord> */
     ...
     *
     * @return \Traversable<int, UnlockRecord>
     */
     ...
     */
    public function findById(int $key): ?UnlockRecord
    {
     ...
     */
    public function getByIdOrThrow(int $key): UnlockRecord
    {
     ...
     */
    public function offsetGet(mixed $offset): ?UnlockRecord
    {
    ...
    {
        throw new \LogicException('UnlockTable is read-only.');
    }
     ...
     *
     * @return \Generator<int, UnlockRecord>
     */
            ...
            switch ($column['tag']) {
                ...
                case 2:
                    ...
                    for ($i = 0; $i < $count; ) {
                        [$n, $value] = $cursor->nextSameI32($count - $i);
                        for (; $n > 0; $n--, $i++) {
                            $records[$i]->type = UnlockType::tryFrom($value) ?? UnlockType::None;
                        }
                    }
                    break;
