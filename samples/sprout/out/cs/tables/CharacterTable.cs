...
namespace Sprout.Tables
{
    ...
    public partial class CharacterTable : IEnumerable<CharacterTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Portrait", "Role", "Element", "Grade", "Rarity", "SkillIds", "MaxLevel", "Released" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Portrait, r.Role, r.Element, r.Grade, r.Rarity, r.SkillIds, r.MaxLevel, r.Released });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Character.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Character.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Character.Portrait", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Character.Role", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._role = (global::Sprout.Tables.RoleType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "Character.Element", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Character.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "Character.Rarity", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._rarity = (global::Sprout.Tables.RarityType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 8:
                        TcbTable.CheckColumn(column, "Character.SkillIds", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 9:
                        TcbTable.CheckColumn(column, "Character.MaxLevel", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 10:
                        TcbTable.CheckColumn(column, "Character.Released", TcbTable.KindScalar, false, TcbTable.ElementBool);
