...
namespace Sprout.Tables
{
    ...
    public partial class ElementAffinityRecord
    {
        ...
        /// attacking element
        /// </summary>
        public global::Sprout.Tables.ElementType Attacker => _attacker;

        /// <summary>
        /// defending element
        /// </summary>
        public global::Sprout.Tables.ElementType Defender => _defender;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.ElementType _attacker;
        internal global::Sprout.Tables.ElementType _defender;
        internal int _rate;
        #endregion
    ...
    public partial class ElementAffinityTable : IEnumerable<ElementAffinityRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Attacker", "Defender", "Rate" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Attacker, r.Defender, r.Rate });
        ...
        public Dictionary<int, ElementAffinityRecord> RecordsById => _recordsById;
        private Dictionary<int, ElementAffinityRecord> _recordsById = new Dictionary<int, ElementAffinityRecord>();
        ...
        public ElementAffinityRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ElementAffinityRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out ElementAffinityRecord record))
                throw new TabbitException($"There is no record in table `ElementAffinity` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<ElementAffinityRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ElementAffinityRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ElementAffinityRecord Row) Current
        ...
        /// </remarks>
        public ElementAffinityRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "ElementAffinity.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "ElementAffinity.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._attacker = (global::Sprout.Tables.ElementType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 3:
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._defender = (global::Sprout.Tables.ElementType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "ElementAffinity.Rate", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "ElementAffinity.Rate");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, ElementAffinityRecord>(count);
