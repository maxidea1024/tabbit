...
{
    [System.Serializable]
    public partial class EquipSetRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int[] MemberIds => _memberIds;
        #endregion

        #region Storage
        internal int _id;
        internal string _nameKey = "";
        internal int[] _memberIds = System.Array.Empty<int>();
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"MemberIds\":"); ToStringHelper.ToString(MemberIds, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class EquipSetTable : IEnumerable<EquipSetRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "MemberIds" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.MemberIds });
        ...
        /// </remarks>
        public List<EquipSetRecord> Records => _records;
        private List<EquipSetRecord> _records = new List<EquipSetRecord>();
        ...
        /// </remarks>
        public List<EquipSetRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipSetRecord> IEnumerable<EquipSetRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipSetRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipSetRecord> _recordsById = new Dictionary<int, EquipSetRecord>();
        ...
        /// </remarks>
        public EquipSetRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipSetRecord record) ? record : null;
        ...
        /// </remarks>
        public EquipSetRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out EquipSetRecord record))
                throw new TabbitException($"There is no record in table `EquipSet` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipSetRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipSetRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipSetRecord Row) Current
        ...
        /// </remarks>
        public EquipSetRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipSetRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipSetRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "EquipSet.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSet.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "EquipSet.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSet.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "EquipSet.MemberIds", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSet.MemberIds");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            int elementCount;
                            elementCount = cursor.NextLength();
                            record._memberIds = new int[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._memberIds[j] = cursor.NextI32();
                            }
                        }
                        break;
            ...
            var recordsById = new Dictionary<int, EquipSetRecord>(count);
