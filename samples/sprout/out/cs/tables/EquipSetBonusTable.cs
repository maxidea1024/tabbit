...
{
    [System.Serializable]
    public partial class EquipSetBonusRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Pieces\":"); ToStringHelper.ToString(Pieces, sb);
    ...
    [System.Serializable]
    public partial class EquipSetBonusTable : IEnumerable<EquipSetBonusRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "SetId", "Pieces", "Stat", "Bonus" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.SetId, r.Pieces, r.Stat, r.Bonus });
        ...
        /// </remarks>
        public List<EquipSetBonusRecord> Records => _records;
        private List<EquipSetBonusRecord> _records = new List<EquipSetBonusRecord>();
        ...
        /// </remarks>
        public List<EquipSetBonusRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipSetBonusRecord> IEnumerable<EquipSetBonusRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipSetBonusRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipSetBonusRecord> _recordsById = new Dictionary<int, EquipSetBonusRecord>();
        ...
        /// </remarks>
        public EquipSetBonusRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipSetBonusRecord record) ? record : null;
        ...
        /// </remarks>
        public EquipSetBonusRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out EquipSetBonusRecord record))
                throw new TabbitException($"There is no record in table `EquipSetBonus` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipSetBonusRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipSetBonusRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipSetBonusRecord Row) Current
        ...
        /// </remarks>
        public EquipSetBonusRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipSetBonusRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipSetBonusRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "EquipSetBonus.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSetBonus.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "EquipSetBonus.SetId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSetBonus.SetId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "EquipSetBonus.Pieces", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSetBonus.Pieces");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._pieces = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "EquipSetBonus.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSetBonus.Stat");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "EquipSetBonus.Bonus", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipSetBonus.Bonus");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, EquipSetBonusRecord>(count);
