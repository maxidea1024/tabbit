...
{
    [System.Serializable]
    public partial class WeeklyQuestRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int ResetWeekday => _resetWeekday;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Points\":"); ToStringHelper.ToString(Points, sb);
            sb.Append(",\"ResetWeekday\":"); ToStringHelper.ToString(ResetWeekday, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class WeeklyQuestTable : IEnumerable<WeeklyQuestRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "QuestId", "Points", "ResetWeekday" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.QuestId, r.Points, r.ResetWeekday });
        ...
        /// </remarks>
        public List<WeeklyQuestRecord> Records => _records;
        private List<WeeklyQuestRecord> _records = new List<WeeklyQuestRecord>();
        ...
        /// </remarks>
        public List<WeeklyQuestRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<WeeklyQuestRecord> IEnumerable<WeeklyQuestRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, WeeklyQuestRecord> RecordsById => _recordsById;
        private Dictionary<int, WeeklyQuestRecord> _recordsById = new Dictionary<int, WeeklyQuestRecord>();
        ...
        /// </remarks>
        public WeeklyQuestRecord FindById(int key)
            => _recordsById.TryGetValue(key, out WeeklyQuestRecord record) ? record : null;
        ...
        /// </remarks>
        public WeeklyQuestRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out WeeklyQuestRecord record))
                throw new TabbitException($"There is no record in table `WeeklyQuest` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<WeeklyQuestRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<WeeklyQuestRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, WeeklyQuestRecord Row) Current
        ...
        /// </remarks>
        public WeeklyQuestRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<WeeklyQuestRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new WeeklyQuestRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "WeeklyQuest.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "WeeklyQuest.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "WeeklyQuest.QuestId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "WeeklyQuest.QuestId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "WeeklyQuest.Points", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "WeeklyQuest.Points");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._points = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "WeeklyQuest.ResetWeekday", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "WeeklyQuest.ResetWeekday");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, WeeklyQuestRecord>(count);
