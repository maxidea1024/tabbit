...
{
    [System.Serializable]
    public partial class GachaRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class GachaTable : IEnumerable<GachaRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<GachaRecord> Records => _records;
        private List<GachaRecord> _records = new List<GachaRecord>();
        ...
        /// </remarks>
        public List<GachaRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<GachaRecord> IEnumerable<GachaRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, GachaRecord> RecordsById => _recordsById;
        private Dictionary<int, GachaRecord> _recordsById = new Dictionary<int, GachaRecord>();
        ...
        /// </remarks>
        public GachaRecord FindById(int key)
            => _recordsById.TryGetValue(key, out GachaRecord record) ? record : null;
        ...
        /// </remarks>
        public GachaRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out GachaRecord record))
        ...
        {
            private readonly List<GachaRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<GachaRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, GachaRecord Row) Current
        ...
        /// </remarks>
        public GachaRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<GachaRecord>(count);
            ...
            var recordsById = new Dictionary<int, GachaRecord>(count);
