...
{
    [System.Serializable]
    public partial class DungeonFloorRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"DungeonId\":"); ToStringHelper.ToString(DungeonId, sb);
    ...
    [System.Serializable]
    public partial class DungeonFloorTable : IEnumerable<DungeonFloorRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "DungeonId", "Floor", "Power", "Stamina", "RewardId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.DungeonId, r.Floor, r.Power, r.Stamina, r.RewardId });
        ...
        /// </remarks>
        public List<DungeonFloorRecord> Records => _records;
        private List<DungeonFloorRecord> _records = new List<DungeonFloorRecord>();
        ...
        /// </remarks>
        public List<DungeonFloorRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DungeonFloorRecord> IEnumerable<DungeonFloorRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DungeonFloorRecord> RecordsById => _recordsById;
        private Dictionary<int, DungeonFloorRecord> _recordsById = new Dictionary<int, DungeonFloorRecord>();
        ...
        public DungeonFloorRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DungeonFloorRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out DungeonFloorRecord record))
                throw new TabbitException($"There is no record in table `DungeonFloor` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DungeonFloorRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DungeonFloorRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DungeonFloorRecord Row) Current
        ...
        /// </remarks>
        public DungeonFloorRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DungeonFloorRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new DungeonFloorRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "DungeonFloor.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "DungeonFloor.DungeonId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._dungeonId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "DungeonFloor.Floor", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "DungeonFloor.Power", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "DungeonFloor.Stamina", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "DungeonFloor.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, DungeonFloorRecord>(count);
