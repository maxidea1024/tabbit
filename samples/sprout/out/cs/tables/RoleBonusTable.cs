...
{
    [System.Serializable]
    public partial class RoleBonusRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class RoleBonusTable : IEnumerable<RoleBonusRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Role", "Stat", "Bonus" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Role, r.Stat, r.Bonus });
        ...
        /// </remarks>
        public List<RoleBonusRecord> Records => _records;
        private List<RoleBonusRecord> _records = new List<RoleBonusRecord>();
        ...
        /// </remarks>
        public List<RoleBonusRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<RoleBonusRecord> IEnumerable<RoleBonusRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, RoleBonusRecord> RecordsById => _recordsById;
        private Dictionary<int, RoleBonusRecord> _recordsById = new Dictionary<int, RoleBonusRecord>();
        ...
        /// </remarks>
        public RoleBonusRecord FindById(int key)
            => _recordsById.TryGetValue(key, out RoleBonusRecord record) ? record : null;
        ...
        /// </remarks>
        public RoleBonusRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out RoleBonusRecord record))
                throw new TabbitException($"There is no record in table `RoleBonus` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<RoleBonusRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<RoleBonusRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, RoleBonusRecord Row) Current
        ...
        /// </remarks>
        public RoleBonusRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<RoleBonusRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new RoleBonusRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "RoleBonus.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "RoleBonus.Role", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "RoleBonus.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "RoleBonus.Bonus", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, RoleBonusRecord>(count);
