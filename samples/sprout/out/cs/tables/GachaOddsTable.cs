...
{
    [System.Serializable]
    public partial class GachaOddsRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class GachaOddsTable : IEnumerable<GachaOddsRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "GachaId", "Grade", "Rate" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.GachaId, r.Grade, r.Rate });
        ...
        /// </remarks>
        public List<GachaOddsRecord> Records => _records;
        private List<GachaOddsRecord> _records = new List<GachaOddsRecord>();
        ...
        /// </remarks>
        public List<GachaOddsRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<GachaOddsRecord> IEnumerable<GachaOddsRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, GachaOddsRecord> RecordsById => _recordsById;
        private Dictionary<int, GachaOddsRecord> _recordsById = new Dictionary<int, GachaOddsRecord>();
        ...
        /// </remarks>
        public GachaOddsRecord FindById(int key)
            => _recordsById.TryGetValue(key, out GachaOddsRecord record) ? record : null;
        ...
        /// </remarks>
        public GachaOddsRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out GachaOddsRecord record))
                throw new TabbitException($"There is no record in table `GachaOdds` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<GachaOddsRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<GachaOddsRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, GachaOddsRecord Row) Current
        ...
        /// </remarks>
        public GachaOddsRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<GachaOddsRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new GachaOddsRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "GachaOdds.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "GachaOdds.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "GachaOdds.GachaId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "GachaOdds.GachaId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "GachaOdds.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "GachaOdds.Grade");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "GachaOdds.Rate", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "GachaOdds.Rate");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, GachaOddsRecord>(count);
