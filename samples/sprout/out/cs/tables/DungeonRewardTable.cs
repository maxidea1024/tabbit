...
{
    [System.Serializable]
    public partial class DungeonRewardRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class DungeonRewardTable : IEnumerable<DungeonRewardRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "ItemId", "MinCount", "MaxCount", "Chance" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.ItemId, r.MinCount, r.MaxCount, r.Chance });
        ...
        /// </remarks>
        public List<DungeonRewardRecord> Records => _records;
        private List<DungeonRewardRecord> _records = new List<DungeonRewardRecord>();
        ...
        /// </remarks>
        public List<DungeonRewardRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DungeonRewardRecord> IEnumerable<DungeonRewardRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DungeonRewardRecord> RecordsById => _recordsById;
        private Dictionary<int, DungeonRewardRecord> _recordsById = new Dictionary<int, DungeonRewardRecord>();
        ...
        public DungeonRewardRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DungeonRewardRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out DungeonRewardRecord record))
                throw new TabbitException($"There is no record in table `DungeonReward` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DungeonRewardRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DungeonRewardRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DungeonRewardRecord Row) Current
        ...
        /// </remarks>
        public DungeonRewardRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DungeonRewardRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new DungeonRewardRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "DungeonReward.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "DungeonReward.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "DungeonReward.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "DungeonReward.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "DungeonReward.MinCount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "DungeonReward.MinCount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "DungeonReward.MaxCount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "DungeonReward.MaxCount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "DungeonReward.Chance", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "DungeonReward.Chance");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, DungeonRewardRecord>(count);
