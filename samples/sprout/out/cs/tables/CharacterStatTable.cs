...
namespace Sprout.Tables
{
    ...
    public partial class CharacterStatRecord
    {
        ...
        /// required experience
        /// </summary>
        public long RequiredExp => _requiredExp;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"RequiredExp\":"); ToStringHelper.ToString(RequiredExp, sb);
    ...
    [System.Serializable]
    public partial class CharacterStatTable : IEnumerable<CharacterStatRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "CharacterId", "Level", "RequiredExp", "Attack", "Defense", "Health" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.CharacterId, r.Level, r.RequiredExp, r.Attack, r.Defense, r.Health });
        ...
        /// </remarks>
        public List<CharacterStatRecord> Records => _records;
        private List<CharacterStatRecord> _records = new List<CharacterStatRecord>();
        ...
        /// </remarks>
        public List<CharacterStatRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<CharacterStatRecord> IEnumerable<CharacterStatRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, CharacterStatRecord> RecordsById => _recordsById;
        private Dictionary<int, CharacterStatRecord> _recordsById = new Dictionary<int, CharacterStatRecord>();
        ...
        public CharacterStatRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CharacterStatRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out CharacterStatRecord record))
                throw new TabbitException($"There is no record in table `CharacterStat` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<CharacterStatRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<CharacterStatRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, CharacterStatRecord Row) Current
        ...
        /// </remarks>
        public CharacterStatRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<CharacterStatRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "CharacterStat.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "CharacterStat.CharacterId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.CharacterId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "CharacterStat.Level", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.Level");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "CharacterStat.RequiredExp", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.RequiredExp");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            record._requiredExp = cursor.NextI64();
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "CharacterStat.Attack", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.Attack");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "CharacterStat.Defense", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.Defense");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "CharacterStat.Health", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterStat.Health");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, CharacterStatRecord>(count);
