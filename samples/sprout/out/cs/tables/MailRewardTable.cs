...
{
    [System.Serializable]
    public partial class MailRewardRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// expiry in days
        /// </summary>
        public int ExpiryDays => _expiryDays;
        #endregion

        #region Storage
        internal int _id;
        internal string _titleKey = "";
        internal string _bodyKey = "";
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"TitleKey\":"); ToStringHelper.ToString(TitleKey, sb);
            sb.Append(",\"BodyKey\":"); ToStringHelper.ToString(BodyKey, sb);
            sb.Append(",\"RewardId\":"); ToStringHelper.ToString(RewardId, sb);
            sb.Append(",\"ExpiryDays\":"); ToStringHelper.ToString(ExpiryDays, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class MailRewardTable : IEnumerable<MailRewardRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "TitleKey", "BodyKey", "RewardId", "ExpiryDays" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.TitleKey, r.BodyKey, r.RewardId, r.ExpiryDays });
        ...
        /// </remarks>
        public List<MailRewardRecord> Records => _records;
        private List<MailRewardRecord> _records = new List<MailRewardRecord>();
        ...
        /// </remarks>
        public List<MailRewardRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<MailRewardRecord> IEnumerable<MailRewardRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, MailRewardRecord> RecordsById => _recordsById;
        private Dictionary<int, MailRewardRecord> _recordsById = new Dictionary<int, MailRewardRecord>();
        ...
        /// </remarks>
        public MailRewardRecord FindById(int key)
            => _recordsById.TryGetValue(key, out MailRewardRecord record) ? record : null;
        ...
        /// </remarks>
        public MailRewardRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out MailRewardRecord record))
                throw new TabbitException($"There is no record in table `MailReward` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<MailRewardRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<MailRewardRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, MailRewardRecord Row) Current
        ...
        /// </remarks>
        public MailRewardRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<MailRewardRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new MailRewardRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "MailReward.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "MailReward.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "MailReward.TitleKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "MailReward.TitleKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._titleKey = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "MailReward.BodyKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "MailReward.BodyKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._bodyKey = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "MailReward.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "MailReward.RewardId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "MailReward.ExpiryDays", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "MailReward.ExpiryDays");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, MailRewardRecord>(count);
