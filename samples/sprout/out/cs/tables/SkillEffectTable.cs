...
namespace Sprout.Tables
{
    ...
    public partial class SkillEffectTable : IEnumerable<SkillEffectRecord>
    {
        ...
        public Dictionary<int, SkillEffectRecord> RecordsById => _recordsById;
        private Dictionary<int, SkillEffectRecord> _recordsById = new Dictionary<int, SkillEffectRecord>();
        ...
        /// </remarks>
        public SkillEffectRecord FindById(int key)
            => _recordsById.TryGetValue(key, out SkillEffectRecord record) ? record : null;
        ...
        /// </remarks>
        public SkillEffectRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out SkillEffectRecord record))
        ...
        {
            private readonly List<SkillEffectRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<SkillEffectRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, SkillEffectRecord Row) Current
        ...
        /// </remarks>
        public SkillEffectRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var recordsById = new Dictionary<int, SkillEffectRecord>(count);
