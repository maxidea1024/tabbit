...
namespace Sprout.Tables
{
    ...
    public partial class ShopRecord
    {
        ...
        /// shop kind
        /// </summary>
        public global::Sprout.Tables.ShopType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.ShopType _type;
    ...
    public partial class ShopTable : IEnumerable<ShopRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "NameKey", "RefreshHours", "FreeRefresh" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.NameKey, r.RefreshHours, r.FreeRefresh });
        ...
        public Dictionary<int, ShopRecord> RecordsById => _recordsById;
        private Dictionary<int, ShopRecord> _recordsById = new Dictionary<int, ShopRecord>();
        ...
        /// </remarks>
        public ShopRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ShopRecord record) ? record : null;
        ...
        /// </remarks>
        public ShopRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out ShopRecord record))
                throw new TabbitException($"There is no record in table `Shop` that corresponds to field `Id` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, ShopRecord Row) Current
        ...
        /// </remarks>
        public ShopRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Shop.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Shop.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.ShopType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Shop.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Shop.RefreshHours", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._refreshHours = value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "Shop.FreeRefresh", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, ShopRecord>(count);
