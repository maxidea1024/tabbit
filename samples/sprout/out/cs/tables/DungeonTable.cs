...
{
    [System.Serializable]
    public partial class DungeonRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// dungeon kind
        /// </summary>
        public global::Sprout.Tables.DungeonType Type => _type;
        ...
        /// daily entries
        /// </summary>
        public int DailyEntries => _dailyEntries;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"DailyEntries\":"); ToStringHelper.ToString(DailyEntries, sb);
    ...
    [System.Serializable]
    public partial class DungeonTable : IEnumerable<DungeonRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "NameKey", "Element", "DailyEntries", "UnlockId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.NameKey, r.Element, r.DailyEntries, r.UnlockId });
        ...
        /// </remarks>
        public List<DungeonRecord> Records => _records;
        private List<DungeonRecord> _records = new List<DungeonRecord>();
        ...
        /// </remarks>
        public List<DungeonRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DungeonRecord> IEnumerable<DungeonRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DungeonRecord> RecordsById => _recordsById;
        private Dictionary<int, DungeonRecord> _recordsById = new Dictionary<int, DungeonRecord>();
        ...
        /// </remarks>
        public DungeonRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DungeonRecord record) ? record : null;
        ...
        /// </remarks>
        public DungeonRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out DungeonRecord record))
                throw new TabbitException($"There is no record in table `Dungeon` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DungeonRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DungeonRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DungeonRecord Row) Current
        ...
        /// </remarks>
        public DungeonRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DungeonRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new DungeonRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Dungeon.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Dungeon.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.Type");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.DungeonType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Dungeon.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Dungeon.Element", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.Element");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Dungeon.DailyEntries", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.DailyEntries");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._dailyEntries = value;
                            } while (--n > 0);
                        }
                        break;

                    case 6:
                        TcbTable.CheckColumn(column, "Dungeon.UnlockId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Dungeon.UnlockId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, DungeonRecord>(count);
