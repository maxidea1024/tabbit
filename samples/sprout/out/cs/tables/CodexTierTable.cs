...
{
    [System.Serializable]
    public partial class CodexTierRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Required\":"); ToStringHelper.ToString(Required, sb);
    ...
    [System.Serializable]
    public partial class CodexTierTable : IEnumerable<CodexTierRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "CodexId", "Required", "RewardId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.CodexId, r.Required, r.RewardId });
        ...
        /// </remarks>
        public List<CodexTierRecord> Records => _records;
        private List<CodexTierRecord> _records = new List<CodexTierRecord>();
        ...
        /// </remarks>
        public List<CodexTierRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<CodexTierRecord> IEnumerable<CodexTierRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, CodexTierRecord> RecordsById => _recordsById;
        private Dictionary<int, CodexTierRecord> _recordsById = new Dictionary<int, CodexTierRecord>();
        ...
        /// </remarks>
        public CodexTierRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CodexTierRecord record) ? record : null;
        ...
        /// </remarks>
        public CodexTierRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out CodexTierRecord record))
                throw new TabbitException($"There is no record in table `CodexTier` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<CodexTierRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<CodexTierRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, CodexTierRecord Row) Current
        ...
        /// </remarks>
        public CodexTierRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<CodexTierRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new CodexTierRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "CodexTier.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CodexTier.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "CodexTier.CodexId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CodexTier.CodexId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "CodexTier.Required", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CodexTier.Required");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._required = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "CodexTier.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CodexTier.RewardId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, CodexTierRecord>(count);
