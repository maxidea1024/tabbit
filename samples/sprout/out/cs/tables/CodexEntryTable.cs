...
{
    [System.Serializable]
    public partial class CodexEntryRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// owning codex
        /// </summary>
        public int CodexId => _codexId;

        /// <summary>
        /// entry order
        /// </summary>
        public int EntryOrder => _entryOrder;
        ...
        #region Storage
        internal int _id;
        internal int _codexId;
        internal int _entryOrder;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"CodexId\":"); ToStringHelper.ToString(CodexId, sb);
            sb.Append(",\"EntryOrder\":"); ToStringHelper.ToString(EntryOrder, sb);
    ...
    [System.Serializable]
    public partial class CodexEntryTable : IEnumerable<CodexEntryRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "CodexId", "EntryOrder", "ConditionId", "Stat", "Bonus" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.CodexId, r.EntryOrder, r.ConditionId, r.Stat, r.Bonus });
        ...
        /// </remarks>
        public List<CodexEntryRecord> Records => _records;
        private List<CodexEntryRecord> _records = new List<CodexEntryRecord>();
        ...
        /// </remarks>
        public List<CodexEntryRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<CodexEntryRecord> IEnumerable<CodexEntryRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, CodexEntryRecord> RecordsById => _recordsById;
        private Dictionary<int, CodexEntryRecord> _recordsById = new Dictionary<int, CodexEntryRecord>();
        ...
        public CodexEntryRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CodexEntryRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out CodexEntryRecord record))
                throw new TabbitException($"There is no record in table `CodexEntry` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<CodexEntryRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<CodexEntryRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, CodexEntryRecord Row) Current
        ...
        /// </remarks>
        public CodexEntryRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<CodexEntryRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new CodexEntryRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "CodexEntry.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "CodexEntry.CodexId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._codexId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "CodexEntry.EntryOrder", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._entryOrder = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "CodexEntry.ConditionId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "CodexEntry.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "CodexEntry.Bonus", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, CodexEntryRecord>(count);
