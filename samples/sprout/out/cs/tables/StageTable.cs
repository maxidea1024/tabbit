...
namespace Sprout.Tables
{
    ...
    public partial class StageRecord
    {
        ...
        /// stage kind
        /// </summary>
        public global::Sprout.Tables.StageType Type => _type;
        ...
        /// first clear reward
        /// </summary>
        public int FirstReward => _firstReward;

        /// <summary>
        /// repeat reward
        /// </summary>
        public int RepeatReward => _repeatReward;
        ...
        internal global::Sprout.Tables.StageType _type;
        internal string _nameKey = "";
        internal string _background = "";
        internal int _stamina;
        internal int _power;
        internal int _firstReward;
        internal int _repeatReward;
        internal int _unlockId;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"ChapterId\":"); ToStringHelper.ToString(ChapterId, sb);
            ...
            sb.Append(",\"Stamina\":"); ToStringHelper.ToString(Stamina, sb);
            sb.Append(",\"Power\":"); ToStringHelper.ToString(Power, sb);
            sb.Append(",\"FirstReward\":"); ToStringHelper.ToString(FirstReward, sb);
            sb.Append(",\"RepeatReward\":"); ToStringHelper.ToString(RepeatReward, sb);
            sb.Append(",\"UnlockId\":"); ToStringHelper.ToString(UnlockId, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    public partial class StageTable : IEnumerable<StageRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "ChapterId", "Type", "NameKey", "Background", "Stamina", "Power", "FirstReward", "RepeatReward", "UnlockId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.ChapterId, r.Type, r.NameKey, r.Background, r.Stamina, r.Power, r.FirstReward, r.RepeatReward, r.UnlockId });
        ...
        public Dictionary<int, StageRecord> RecordsById => _recordsById;
        private Dictionary<int, StageRecord> _recordsById = new Dictionary<int, StageRecord>();
        ...
        public StageRecord FindById(int key)
            => _recordsById.TryGetValue(key, out StageRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out StageRecord record))
                throw new TabbitException($"There is no record in table `Stage` that corresponds to field `Id` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, StageRecord Row) Current
        ...
        /// </remarks>
        public StageRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Stage.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Stage.ChapterId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._chapterId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Stage.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.StageType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Stage.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Stage.Background", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Stage.Stamina", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._stamina = value;
                            } while (--n > 0);
                        }
                        break;

                    case 7:
                        TcbTable.CheckColumn(column, "Stage.Power", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 8:
                        TcbTable.CheckColumn(column, "Stage.FirstReward", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._firstReward = value;
                            } while (--n > 0);
                        }
                        break;

                    case 9:
                        TcbTable.CheckColumn(column, "Stage.RepeatReward", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._repeatReward = value;
                            } while (--n > 0);
                        }
                        break;

                    case 10:
                        TcbTable.CheckColumn(column, "Stage.UnlockId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, StageRecord>(count);
