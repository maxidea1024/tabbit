...
{
    [System.Serializable]
    public partial class ChapterRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"WorldId\":"); ToStringHelper.ToString(WorldId, sb);
    ...
    [System.Serializable]
    public partial class ChapterTable : IEnumerable<ChapterRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "WorldId", "NameKey", "SortOrder", "UnlockId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.WorldId, r.NameKey, r.SortOrder, r.UnlockId });
        ...
        /// </remarks>
        public List<ChapterRecord> Records => _records;
        private List<ChapterRecord> _records = new List<ChapterRecord>();
        ...
        /// </remarks>
        public List<ChapterRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ChapterRecord> IEnumerable<ChapterRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, ChapterRecord> RecordsById => _recordsById;
        private Dictionary<int, ChapterRecord> _recordsById = new Dictionary<int, ChapterRecord>();
        ...
        public ChapterRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ChapterRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out ChapterRecord record))
                throw new TabbitException($"There is no record in table `Chapter` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<ChapterRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ChapterRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ChapterRecord Row) Current
        ...
        /// </remarks>
        public ChapterRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ChapterRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ChapterRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Chapter.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Chapter.WorldId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._worldId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Chapter.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Chapter.SortOrder", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Chapter.UnlockId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, ChapterRecord>(count);
