...
{
    [System.Serializable]
    public partial class CodexRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// collection kind
        /// </summary>
        public global::Sprout.Tables.CollectionType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.CollectionType _type;
    ...
    [System.Serializable]
    public partial class CodexTable : IEnumerable<CodexRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "NameKey", "Icon", "RewardId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.NameKey, r.Icon, r.RewardId });
        ...
        /// </remarks>
        public List<CodexRecord> Records => _records;
        private List<CodexRecord> _records = new List<CodexRecord>();
        ...
        /// </remarks>
        public List<CodexRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<CodexRecord> IEnumerable<CodexRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, CodexRecord> RecordsById => _recordsById;
        private Dictionary<int, CodexRecord> _recordsById = new Dictionary<int, CodexRecord>();
        ...
        /// </remarks>
        public CodexRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CodexRecord record) ? record : null;
        ...
        /// </remarks>
        public CodexRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out CodexRecord record))
                throw new TabbitException($"There is no record in table `Codex` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<CodexRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<CodexRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, CodexRecord Row) Current
        ...
        /// </remarks>
        public CodexRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<CodexRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new CodexRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Codex.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Codex.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.CollectionType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Codex.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Codex.Icon", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Codex.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, CodexRecord>(count);
