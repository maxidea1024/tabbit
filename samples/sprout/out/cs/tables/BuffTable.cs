...
namespace Sprout.Tables
{
    ...
    public partial class BuffRecord
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"StackLimit\":"); ToStringHelper.ToString(StackLimit, sb);
            sb.Append(",\"Dispellable\":"); ToStringHelper.ToString(Dispellable, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class BuffTable : IEnumerable<BuffRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Kind", "Icon", "StackLimit", "Dispellable" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Kind, r.Icon, r.StackLimit, r.Dispellable });
        ...
        /// </remarks>
        public List<BuffRecord> Records => _records;
        private List<BuffRecord> _records = new List<BuffRecord>();
        ...
        /// </remarks>
        public List<BuffRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<BuffRecord> IEnumerable<BuffRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, BuffRecord> RecordsById => _recordsById;
        private Dictionary<int, BuffRecord> _recordsById = new Dictionary<int, BuffRecord>();
        ...
        public BuffRecord FindById(int key)
            => _recordsById.TryGetValue(key, out BuffRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out BuffRecord record))
                throw new TabbitException($"There is no record in table `Buff` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<BuffRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<BuffRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, BuffRecord Row) Current
        ...
        /// </remarks>
        public BuffRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Buff.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Buff.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Buff.Kind", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.Kind");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Buff.Icon", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.Icon");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Buff.StackLimit", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.StackLimit");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._stackLimit = value;
                            } while (--n > 0);
                        }
                        break;

                    case 6:
                        TcbTable.CheckColumn(column, "Buff.Dispellable", TcbTable.KindScalar, false, TcbTable.ElementBool);
                        cursor = new TcbColumnCursor(reader, column, count, "Buff.Dispellable");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsById = new Dictionary<int, BuffRecord>(count);
