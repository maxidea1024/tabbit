...
namespace Sprout.Tables
{
    ...
    public partial class QuestRecord
    {
        ...
        /// quest kind
        /// </summary>
        public global::Sprout.Tables.QuestType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.QuestType _type;
        internal string _titleKey = "";
        internal string _summaryKey = "";
        internal int _rewardId;
        internal int _unlockId;
        internal bool _repeatable;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"SummaryKey\":"); ToStringHelper.ToString(SummaryKey, sb);
            sb.Append(",\"RewardId\":"); ToStringHelper.ToString(RewardId, sb);
            sb.Append(",\"UnlockId\":"); ToStringHelper.ToString(UnlockId, sb);
            sb.Append(",\"Repeatable\":"); ToStringHelper.ToString(Repeatable, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    public partial class QuestTable : IEnumerable<QuestRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "TitleKey", "SummaryKey", "RewardId", "UnlockId", "Repeatable" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.TitleKey, r.SummaryKey, r.RewardId, r.UnlockId, r.Repeatable });
        ...
        public Dictionary<int, QuestRecord> RecordsById => _recordsById;
        private Dictionary<int, QuestRecord> _recordsById = new Dictionary<int, QuestRecord>();
        ...
        public QuestRecord FindById(int key)
            => _recordsById.TryGetValue(key, out QuestRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out QuestRecord record))
                throw new TabbitException($"There is no record in table `Quest` that corresponds to field `Id` value {key}");
        ...
        /// </remarks>
        public QuestRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Quest.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Quest.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.QuestType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Quest.TitleKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Quest.SummaryKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._summaryKey = value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "Quest.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Quest.UnlockId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "Quest.Repeatable", TcbTable.KindScalar, false, TcbTable.ElementBool);
            ...
            var recordsById = new Dictionary<int, QuestRecord>(count);
