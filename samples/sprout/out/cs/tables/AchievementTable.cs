...
namespace Sprout.Tables
{
    ...
    public partial class AchievementRecord
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Badge\":"); ToStringHelper.ToString(Badge, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    public partial class AchievementTable : IEnumerable<AchievementRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "TitleKey", "ConditionId", "TargetCount", "RewardId", "Badge" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.TitleKey, r.ConditionId, r.TargetCount, r.RewardId, r.Badge });
        ...
        public Dictionary<int, AchievementRecord> RecordsById => _recordsById;
        private Dictionary<int, AchievementRecord> _recordsById = new Dictionary<int, AchievementRecord>();
        ...
        public AchievementRecord FindById(int key)
            => _recordsById.TryGetValue(key, out AchievementRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out AchievementRecord record))
                throw new TabbitException($"There is no record in table `Achievement` that corresponds to field `Id` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, AchievementRecord Row) Current
        ...
        /// </remarks>
        public AchievementRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Achievement.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Achievement.TitleKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.TitleKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Achievement.ConditionId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.ConditionId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Achievement.TargetCount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.TargetCount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Achievement.RewardId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.RewardId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Achievement.Badge", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Achievement.Badge");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, AchievementRecord>(count);
