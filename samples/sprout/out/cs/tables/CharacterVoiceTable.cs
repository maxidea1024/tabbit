...
namespace Sprout.Tables
{
    ...
    public partial class CharacterVoiceRecord
    {
        ...
        /// subtitle key
        /// </summary>
        public string SubtitleKey => _subtitleKey;
        #endregion
        ...
        internal string _clip = "";
        internal string _subtitleKey = "";
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Clip\":"); ToStringHelper.ToString(Clip, sb);
            sb.Append(",\"SubtitleKey\":"); ToStringHelper.ToString(SubtitleKey, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class CharacterVoiceTable : IEnumerable<CharacterVoiceRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "CharacterId", "Cue", "Clip", "SubtitleKey" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.CharacterId, r.Cue, r.Clip, r.SubtitleKey });
        ...
        /// </remarks>
        public List<CharacterVoiceRecord> Records => _records;
        private List<CharacterVoiceRecord> _records = new List<CharacterVoiceRecord>();
        ...
        /// </remarks>
        public List<CharacterVoiceRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<CharacterVoiceRecord> IEnumerable<CharacterVoiceRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, CharacterVoiceRecord> RecordsById => _recordsById;
        private Dictionary<int, CharacterVoiceRecord> _recordsById = new Dictionary<int, CharacterVoiceRecord>();
        ...
        /// </remarks>
        public CharacterVoiceRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CharacterVoiceRecord record) ? record : null;
        ...
        /// </remarks>
        public CharacterVoiceRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out CharacterVoiceRecord record))
                throw new TabbitException($"There is no record in table `CharacterVoice` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<CharacterVoiceRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<CharacterVoiceRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, CharacterVoiceRecord Row) Current
        ...
        /// </remarks>
        public CharacterVoiceRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<CharacterVoiceRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new CharacterVoiceRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "CharacterVoice.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterVoice.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "CharacterVoice.CharacterId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterVoice.CharacterId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "CharacterVoice.Cue", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterVoice.Cue");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "CharacterVoice.Clip", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterVoice.Clip");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "CharacterVoice.SubtitleKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "CharacterVoice.SubtitleKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, CharacterVoiceRecord>(count);
