...
{
    [System.Serializable]
    public partial class EquipOptionRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int MinRoll => _minRoll;

        /// <summary>
        /// highest roll in permille
        /// </summary>
        public int MaxRoll => _maxRoll;
        ...
        internal int _minRoll;
        internal int _maxRoll;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"MinRoll\":"); ToStringHelper.ToString(MinRoll, sb);
            sb.Append(",\"MaxRoll\":"); ToStringHelper.ToString(MaxRoll, sb);
    ...
    [System.Serializable]
    public partial class EquipOptionTable : IEnumerable<EquipOptionRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Stat", "MinRoll", "MaxRoll", "Weight" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Stat, r.MinRoll, r.MaxRoll, r.Weight });
        ...
        /// </remarks>
        public List<EquipOptionRecord> Records => _records;
        private List<EquipOptionRecord> _records = new List<EquipOptionRecord>();
        ...
        /// </remarks>
        public List<EquipOptionRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipOptionRecord> IEnumerable<EquipOptionRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipOptionRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipOptionRecord> _recordsById = new Dictionary<int, EquipOptionRecord>();
        ...
        /// </remarks>
        public EquipOptionRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipOptionRecord record) ? record : null;
        ...
        /// </remarks>
        public EquipOptionRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out EquipOptionRecord record))
                throw new TabbitException($"There is no record in table `EquipOption` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipOptionRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipOptionRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipOptionRecord Row) Current
        ...
        /// </remarks>
        public EquipOptionRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipOptionRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipOptionRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "EquipOption.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipOption.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "EquipOption.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipOption.Stat");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "EquipOption.MinRoll", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipOption.MinRoll");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._minRoll = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "EquipOption.MaxRoll", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipOption.MaxRoll");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._maxRoll = value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "EquipOption.Weight", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "EquipOption.Weight");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, EquipOptionRecord>(count);
