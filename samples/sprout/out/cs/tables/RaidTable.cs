...
namespace Sprout.Tables
{
    ...
    [System.Serializable]
    public partial class RaidTable : IEnumerable<RaidRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<RaidRecord> Records => _records;
        private List<RaidRecord> _records = new List<RaidRecord>();
        ...
        /// </remarks>
        public List<RaidRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<RaidRecord> IEnumerable<RaidRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, RaidRecord> RecordsById => _recordsById;
        private Dictionary<int, RaidRecord> _recordsById = new Dictionary<int, RaidRecord>();
        ...
        /// </remarks>
        public RaidRecord FindById(int key)
            => _recordsById.TryGetValue(key, out RaidRecord record) ? record : null;
        ...
        /// </remarks>
        public RaidRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out RaidRecord record))
        ...
        {
            private readonly List<RaidRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<RaidRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, RaidRecord Row) Current
        ...
        /// </remarks>
        public RaidRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<RaidRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new RaidRecord());
            ...
            var recordsById = new Dictionary<int, RaidRecord>(count);
