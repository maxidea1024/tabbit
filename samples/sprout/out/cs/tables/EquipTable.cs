...
{
    [System.Serializable]
    public partial class EquipRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// slot
        /// </summary>
        public global::Sprout.Tables.EquipSlot Slot => _slot;
        ...
        internal global::Sprout.Tables.EquipSlot _slot;
    ...
    [System.Serializable]
    public partial class EquipTable : IEnumerable<EquipRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Slot", "Grade", "Model", "SetId", "Attack", "Defense", "MaxLevel" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Slot, r.Grade, r.Model, r.SetId, r.Attack, r.Defense, r.MaxLevel });
        ...
        /// </remarks>
        public List<EquipRecord> Records => _records;
        private List<EquipRecord> _records = new List<EquipRecord>();
        ...
        /// </remarks>
        public List<EquipRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipRecord> IEnumerable<EquipRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipRecord> _recordsById = new Dictionary<int, EquipRecord>();
        ...
        public EquipRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out EquipRecord record))
                throw new TabbitException($"There is no record in table `Equip` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipRecord Row) Current
        ...
        /// </remarks>
        public EquipRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Equip.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Equip.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Equip.Slot", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Slot");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._slot = (global::Sprout.Tables.EquipSlot)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Equip.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Grade");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Equip.Model", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Model");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Equip.SetId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.SetId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "Equip.Attack", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Attack");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 8:
                        TcbTable.CheckColumn(column, "Equip.Defense", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.Defense");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 9:
                        TcbTable.CheckColumn(column, "Equip.MaxLevel", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Equip.MaxLevel");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, EquipRecord>(count);
