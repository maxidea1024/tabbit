...
namespace Sprout.Tables
{
    ...
    public partial class DialogueRecord
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"SceneKey\":"); ToStringHelper.ToString(SceneKey, sb);
            sb.Append(",\"CutsceneId\":"); ToStringHelper.ToString(CutsceneId, sb);
    ...
    [System.Serializable]
    public partial class DialogueTable : IEnumerable<DialogueRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "SceneKey", "CutsceneId", "Skippable" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.SceneKey, r.CutsceneId, r.Skippable });
        ...
        /// </remarks>
        public List<DialogueRecord> Records => _records;
        private List<DialogueRecord> _records = new List<DialogueRecord>();
        ...
        /// </remarks>
        public List<DialogueRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DialogueRecord> IEnumerable<DialogueRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DialogueRecord> RecordsById => _recordsById;
        private Dictionary<int, DialogueRecord> _recordsById = new Dictionary<int, DialogueRecord>();
        ...
        /// </remarks>
        public DialogueRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DialogueRecord record) ? record : null;
        ...
        /// </remarks>
        public DialogueRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out DialogueRecord record))
                throw new TabbitException($"There is no record in table `Dialogue` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DialogueRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DialogueRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DialogueRecord Row) Current
        ...
        /// </remarks>
        public DialogueRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DialogueRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Dialogue.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Dialogue.SceneKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._sceneKey = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Dialogue.CutsceneId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._cutsceneId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Dialogue.Skippable", TcbTable.KindScalar, false, TcbTable.ElementBool);
            ...
            var recordsById = new Dictionary<int, DialogueRecord>(count);
