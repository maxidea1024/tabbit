...
{
    [System.Serializable]
    public partial class PromoRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// available days
        /// </summary>
        public int AvailableDays => _availableDays;
        #endregion

        #region Storage
        internal int _id;
        internal int _offerId;
        internal string _banner = "";
        internal int _availableDays;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"OfferId\":"); ToStringHelper.ToString(OfferId, sb);
            sb.Append(",\"Banner\":"); ToStringHelper.ToString(Banner, sb);
            sb.Append(",\"AvailableDays\":"); ToStringHelper.ToString(AvailableDays, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class PromoTable : IEnumerable<PromoRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "OfferId", "Banner", "AvailableDays" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.OfferId, r.Banner, r.AvailableDays });
        ...
        /// </remarks>
        public List<PromoRecord> Records => _records;
        private List<PromoRecord> _records = new List<PromoRecord>();
        ...
        /// </remarks>
        public List<PromoRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PromoRecord> IEnumerable<PromoRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, PromoRecord> RecordsById => _recordsById;
        private Dictionary<int, PromoRecord> _recordsById = new Dictionary<int, PromoRecord>();
        ...
        public PromoRecord FindById(int key)
            => _recordsById.TryGetValue(key, out PromoRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out PromoRecord record))
                throw new TabbitException($"There is no record in table `Promo` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<PromoRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PromoRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PromoRecord Row) Current
        ...
        /// </remarks>
        public PromoRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<PromoRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new PromoRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Promo.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Promo.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Promo.OfferId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Promo.OfferId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._offerId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Promo.Banner", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Promo.Banner");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Promo.AvailableDays", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Promo.AvailableDays");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, PromoRecord>(count);
