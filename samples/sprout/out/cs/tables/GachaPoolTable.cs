...
{
    [System.Serializable]
    public partial class GachaPoolRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        #region Storage
        internal int _id;
        internal int _gachaId;
        internal int _characterId;
        internal int _equipId;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"GachaId\":"); ToStringHelper.ToString(GachaId, sb);
            sb.Append(",\"CharacterId\":"); ToStringHelper.ToString(CharacterId, sb);
            sb.Append(",\"EquipId\":"); ToStringHelper.ToString(EquipId, sb);
    ...
    [System.Serializable]
    public partial class GachaPoolTable : IEnumerable<GachaPoolRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "GachaId", "CharacterId", "EquipId", "Grade", "Weight" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.GachaId, r.CharacterId, r.EquipId, r.Grade, r.Weight });
        ...
        /// </remarks>
        public List<GachaPoolRecord> Records => _records;
        private List<GachaPoolRecord> _records = new List<GachaPoolRecord>();
        ...
        /// </remarks>
        public List<GachaPoolRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<GachaPoolRecord> IEnumerable<GachaPoolRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, GachaPoolRecord> RecordsById => _recordsById;
        private Dictionary<int, GachaPoolRecord> _recordsById = new Dictionary<int, GachaPoolRecord>();
        ...
        public GachaPoolRecord FindById(int key)
            => _recordsById.TryGetValue(key, out GachaPoolRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out GachaPoolRecord record))
                throw new TabbitException($"There is no record in table `GachaPool` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<GachaPoolRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<GachaPoolRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, GachaPoolRecord Row) Current
        ...
        /// </remarks>
        public GachaPoolRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<GachaPoolRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new GachaPoolRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "GachaPool.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "GachaPool.GachaId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._gachaId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "GachaPool.CharacterId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "GachaPool.EquipId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._equipId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "GachaPool.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "GachaPool.Weight", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, GachaPoolRecord>(count);
