...
{
    [System.Serializable]
    public partial class OfferRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// shop kind
        /// </summary>
        public global::Sprout.Tables.ShopType Shop => _shop;
        ...
        internal global::Sprout.Tables.ShopType _shop;
        internal int _price;
        internal int _limit;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Shop\":"); ToStringHelper.ToString(Shop, sb);
            sb.Append(",\"Price\":"); ToStringHelper.ToString(Price, sb);
            sb.Append(",\"Limit\":"); ToStringHelper.ToString(Limit, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class OfferTable : IEnumerable<OfferRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Shop", "Price", "Limit" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Shop, r.Price, r.Limit });
        ...
        /// </remarks>
        public List<OfferRecord> Records => _records;
        private List<OfferRecord> _records = new List<OfferRecord>();
        ...
        /// </remarks>
        public List<OfferRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<OfferRecord> IEnumerable<OfferRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, OfferRecord> RecordsById => _recordsById;
        private Dictionary<int, OfferRecord> _recordsById = new Dictionary<int, OfferRecord>();
        ...
        /// </remarks>
        public OfferRecord FindById(int key)
            => _recordsById.TryGetValue(key, out OfferRecord record) ? record : null;
        ...
        /// </remarks>
        public OfferRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out OfferRecord record))
                throw new TabbitException($"There is no record in table `Offer` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<OfferRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<OfferRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, OfferRecord Row) Current
        ...
        /// </remarks>
        public OfferRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<OfferRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Offer.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Offer.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Offer.Shop", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._shop = (global::Sprout.Tables.ShopType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Offer.Price", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Offer.Limit", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, OfferRecord>(count);
