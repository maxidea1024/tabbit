...
{
    [System.Serializable]
    public partial class DialogueLineRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// line order
        /// </summary>
        public int LineOrder => _lineOrder;

        /// <summary>
        /// speaker
        /// </summary>
        public global::Sprout.Tables.DialogueSpeaker Speaker => _speaker;
        ...
        #region Storage
        internal int _id;
        internal int _dialogueId;
        internal int _lineOrder;
        internal global::Sprout.Tables.DialogueSpeaker _speaker;
        internal string _portrait = "";
        internal string _lineKey = "";
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"DialogueId\":"); ToStringHelper.ToString(DialogueId, sb);
            sb.Append(",\"LineOrder\":"); ToStringHelper.ToString(LineOrder, sb);
            sb.Append(",\"Speaker\":"); ToStringHelper.ToString(Speaker, sb);
            sb.Append(",\"Portrait\":"); ToStringHelper.ToString(Portrait, sb);
            sb.Append(",\"LineKey\":"); ToStringHelper.ToString(LineKey, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class DialogueLineTable : IEnumerable<DialogueLineRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "DialogueId", "LineOrder", "Speaker", "Portrait", "LineKey" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.DialogueId, r.LineOrder, r.Speaker, r.Portrait, r.LineKey });
        ...
        /// </remarks>
        public List<DialogueLineRecord> Records => _records;
        private List<DialogueLineRecord> _records = new List<DialogueLineRecord>();
        ...
        /// </remarks>
        public List<DialogueLineRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DialogueLineRecord> IEnumerable<DialogueLineRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DialogueLineRecord> RecordsById => _recordsById;
        private Dictionary<int, DialogueLineRecord> _recordsById = new Dictionary<int, DialogueLineRecord>();
        ...
        /// </remarks>
        public DialogueLineRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DialogueLineRecord record) ? record : null;
        ...
        /// </remarks>
        public DialogueLineRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out DialogueLineRecord record))
                throw new TabbitException($"There is no record in table `DialogueLine` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DialogueLineRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DialogueLineRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DialogueLineRecord Row) Current
        ...
        /// </remarks>
        public DialogueLineRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DialogueLineRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new DialogueLineRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "DialogueLine.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "DialogueLine.DialogueId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._dialogueId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "DialogueLine.LineOrder", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._lineOrder = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "DialogueLine.Speaker", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._speaker = (global::Sprout.Tables.DialogueSpeaker)value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "DialogueLine.Portrait", TcbTable.KindScalar, false, TcbTable.ElementString);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._portrait = value;
                            } while (--n > 0);
                        }
                        break;

                    case 6:
                        TcbTable.CheckColumn(column, "DialogueLine.LineKey", TcbTable.KindScalar, false, TcbTable.ElementString);
            ...
            var recordsById = new Dictionary<int, DialogueLineRecord>(count);
