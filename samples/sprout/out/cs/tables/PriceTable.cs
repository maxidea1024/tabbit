...
namespace Sprout.Tables
{
    ...
    public partial class PriceRecord
    {
        ...
        /// currency
        /// </summary>
        public global::Sprout.Tables.CurrencyType Currency => _currency;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.CurrencyType _currency;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Currency\":"); ToStringHelper.ToString(Currency, sb);
            sb.Append(",\"Amount\":"); ToStringHelper.ToString(Amount, sb);
            sb.Append(",\"Discount\":"); ToStringHelper.ToString(Discount, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class PriceTable : IEnumerable<PriceRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Currency", "Amount", "Discount" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Currency, r.Amount, r.Discount });
        ...
        /// </remarks>
        public List<PriceRecord> Records => _records;
        private List<PriceRecord> _records = new List<PriceRecord>();
        ...
        /// </remarks>
        public List<PriceRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PriceRecord> IEnumerable<PriceRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, PriceRecord> RecordsById => _recordsById;
        private Dictionary<int, PriceRecord> _recordsById = new Dictionary<int, PriceRecord>();
        ...
        /// </remarks>
        public PriceRecord FindById(int key)
            => _recordsById.TryGetValue(key, out PriceRecord record) ? record : null;
        ...
        /// </remarks>
        public PriceRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out PriceRecord record))
                throw new TabbitException($"There is no record in table `Price` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<PriceRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PriceRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PriceRecord Row) Current
        ...
        /// </remarks>
        public PriceRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Price.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Price.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Price.Currency", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Price.Currency");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._currency = (global::Sprout.Tables.CurrencyType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Price.Amount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Price.Amount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Price.Discount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Price.Discount");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, PriceRecord>(count);
