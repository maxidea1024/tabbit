...
{
    [System.Serializable]
    public partial class PowerScoreRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class PowerScoreTable : IEnumerable<PowerScoreRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Stat", "Weight" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Stat, r.Weight });
        ...
        /// </remarks>
        public List<PowerScoreRecord> Records => _records;
        private List<PowerScoreRecord> _records = new List<PowerScoreRecord>();
        ...
        /// </remarks>
        public List<PowerScoreRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PowerScoreRecord> IEnumerable<PowerScoreRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, PowerScoreRecord> RecordsById => _recordsById;
        private Dictionary<int, PowerScoreRecord> _recordsById = new Dictionary<int, PowerScoreRecord>();
        ...
        /// </remarks>
        public PowerScoreRecord FindById(int key)
            => _recordsById.TryGetValue(key, out PowerScoreRecord record) ? record : null;
        ...
        /// </remarks>
        public PowerScoreRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out PowerScoreRecord record))
                throw new TabbitException($"There is no record in table `PowerScore` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<PowerScoreRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PowerScoreRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PowerScoreRecord Row) Current
        ...
        /// </remarks>
        public PowerScoreRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<PowerScoreRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new PowerScoreRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "PowerScore.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "PowerScore.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "PowerScore.Weight", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, PowerScoreRecord>(count);
