...
{
    [System.Serializable]
    public partial class PassiveRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int UnlockStep => _unlockStep;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"UnlockStep\":"); ToStringHelper.ToString(UnlockStep, sb);
    ...
    [System.Serializable]
    public partial class PassiveTable : IEnumerable<PassiveRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "CharacterId", "UnlockStep", "Stat", "Bonus" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.CharacterId, r.UnlockStep, r.Stat, r.Bonus });
        ...
        /// </remarks>
        public List<PassiveRecord> Records => _records;
        private List<PassiveRecord> _records = new List<PassiveRecord>();
        ...
        /// </remarks>
        public List<PassiveRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PassiveRecord> IEnumerable<PassiveRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, PassiveRecord> RecordsById => _recordsById;
        private Dictionary<int, PassiveRecord> _recordsById = new Dictionary<int, PassiveRecord>();
        ...
        /// </remarks>
        public PassiveRecord FindById(int key)
            => _recordsById.TryGetValue(key, out PassiveRecord record) ? record : null;
        ...
        /// </remarks>
        public PassiveRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out PassiveRecord record))
                throw new TabbitException($"There is no record in table `Passive` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<PassiveRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PassiveRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PassiveRecord Row) Current
        ...
        /// </remarks>
        public PassiveRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<PassiveRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new PassiveRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Passive.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Passive.CharacterId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Passive.UnlockStep", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._unlockStep = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "Passive.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Passive.Bonus", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, PassiveRecord>(count);
