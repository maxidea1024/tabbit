...
namespace Sprout.Tables
{
    ...
    public partial class RewardTable : IEnumerable<RewardRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "LootGroupId", "ItemIds", "ItemCounts" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.LootGroupId, r.ItemIds, r.ItemCounts });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Reward.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Reward.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Reward.LootGroupId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Reward.ItemIds", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            record._itemIds = new int[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._itemIds[j] = cursor.NextI32();
                            }
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "Reward.ItemCounts", TcbTable.KindArray, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            int elementCount;
                            elementCount = cursor.NextLength();
                            record._itemCounts = new int[elementCount];
                            for (int j = 0; j < elementCount; ++j)
                            {
                                record._itemCounts[j] = cursor.NextI32();
                            }
                        }
                        break;
