...
{
    [System.Serializable]
    public partial class SkillLevelRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class SkillLevelTable : IEnumerable<SkillLevelRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "SkillId", "Level", "Power", "Cost" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.SkillId, r.Level, r.Power, r.Cost });
        ...
        /// </remarks>
        public List<SkillLevelRecord> Records => _records;
        private List<SkillLevelRecord> _records = new List<SkillLevelRecord>();
        ...
        /// </remarks>
        public List<SkillLevelRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<SkillLevelRecord> IEnumerable<SkillLevelRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, SkillLevelRecord> RecordsById => _recordsById;
        private Dictionary<int, SkillLevelRecord> _recordsById = new Dictionary<int, SkillLevelRecord>();
        ...
        /// </remarks>
        public SkillLevelRecord FindById(int key)
            => _recordsById.TryGetValue(key, out SkillLevelRecord record) ? record : null;
        ...
        /// </remarks>
        public SkillLevelRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out SkillLevelRecord record))
                throw new TabbitException($"There is no record in table `SkillLevel` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<SkillLevelRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<SkillLevelRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, SkillLevelRecord Row) Current
        ...
        /// </remarks>
        public SkillLevelRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<SkillLevelRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new SkillLevelRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "SkillLevel.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SkillLevel.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "SkillLevel.SkillId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SkillLevel.SkillId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._skillId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "SkillLevel.Level", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SkillLevel.Level");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "SkillLevel.Power", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SkillLevel.Power");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "SkillLevel.Cost", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "SkillLevel.Cost");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsById = new Dictionary<int, SkillLevelRecord>(count);
