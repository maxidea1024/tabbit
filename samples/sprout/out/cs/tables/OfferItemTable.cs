...
{
    [System.Serializable]
    public partial class OfferItemRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class OfferItemTable : IEnumerable<OfferItemRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "OfferId", "ItemId", "Count" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.OfferId, r.ItemId, r.Count });
        ...
        /// </remarks>
        public List<OfferItemRecord> Records => _records;
        private List<OfferItemRecord> _records = new List<OfferItemRecord>();
        ...
        /// </remarks>
        public List<OfferItemRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<OfferItemRecord> IEnumerable<OfferItemRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, OfferItemRecord> RecordsById => _recordsById;
        private Dictionary<int, OfferItemRecord> _recordsById = new Dictionary<int, OfferItemRecord>();
        ...
        /// </remarks>
        public OfferItemRecord FindById(int key)
            => _recordsById.TryGetValue(key, out OfferItemRecord record) ? record : null;
        ...
        /// </remarks>
        public OfferItemRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out OfferItemRecord record))
                throw new TabbitException($"There is no record in table `OfferItem` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<OfferItemRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<OfferItemRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, OfferItemRecord Row) Current
        ...
        /// </remarks>
        public OfferItemRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<OfferItemRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new OfferItemRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "OfferItem.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfferItem.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "OfferItem.OfferId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfferItem.OfferId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "OfferItem.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfferItem.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "OfferItem.Count", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfferItem.Count");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, OfferItemRecord>(count);
