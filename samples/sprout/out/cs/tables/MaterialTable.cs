...
namespace Sprout.Tables
{
    ...
    [System.Serializable]
    public partial class MaterialTable : IEnumerable<MaterialRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "ItemId", "Tier", "Element" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.ItemId, r.Tier, r.Element });
        ...
        /// </remarks>
        public List<MaterialRecord> Records => _records;
        private List<MaterialRecord> _records = new List<MaterialRecord>();
        ...
        /// </remarks>
        public List<MaterialRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<MaterialRecord> IEnumerable<MaterialRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, MaterialRecord> RecordsById => _recordsById;
        private Dictionary<int, MaterialRecord> _recordsById = new Dictionary<int, MaterialRecord>();
        ...
        public MaterialRecord FindById(int key)
            => _recordsById.TryGetValue(key, out MaterialRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out MaterialRecord record))
                throw new TabbitException($"There is no record in table `Material` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<MaterialRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<MaterialRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, MaterialRecord Row) Current
        ...
        /// </remarks>
        public MaterialRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<MaterialRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Material.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Material.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Material.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Material.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Material.Tier", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Material.Tier");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Material.Element", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Material.Element");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, MaterialRecord>(count);
