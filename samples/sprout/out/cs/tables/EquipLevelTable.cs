...
{
    [System.Serializable]
    public partial class EquipLevelRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int StatScale => _statScale;
    ...
    [System.Serializable]
    public partial class EquipLevelTable : IEnumerable<EquipLevelRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Grade", "Level", "StatScale", "Cost" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Grade, r.Level, r.StatScale, r.Cost });
        ...
        /// </remarks>
        public List<EquipLevelRecord> Records => _records;
        private List<EquipLevelRecord> _records = new List<EquipLevelRecord>();
        ...
        /// </remarks>
        public List<EquipLevelRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipLevelRecord> IEnumerable<EquipLevelRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipLevelRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipLevelRecord> _recordsById = new Dictionary<int, EquipLevelRecord>();
        ...
        public EquipLevelRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipLevelRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out EquipLevelRecord record))
                throw new TabbitException($"There is no record in table `EquipLevel` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipLevelRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipLevelRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipLevelRecord Row) Current
        ...
        /// </remarks>
        public EquipLevelRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipLevelRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipLevelRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "EquipLevel.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "EquipLevel.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "EquipLevel.Level", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "EquipLevel.StatScale", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._statScale = value;
                            } while (--n > 0);
                        }
                        break;

                    case 5:
                        TcbTable.CheckColumn(column, "EquipLevel.Cost", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, EquipLevelRecord>(count);
