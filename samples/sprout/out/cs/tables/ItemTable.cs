...
namespace Sprout.Tables
{
    ...
    public partial class ItemRecord
    {
        ...
        /// item kind
        /// </summary>
        public global::Sprout.Tables.ItemType Type => _type;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"SellPrice\":"); ToStringHelper.ToString(SellPrice, sb);
    ...
    public partial class ItemTable : IEnumerable<ItemRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Type", "Grade", "Icon", "StackLimit", "SellPrice", "Tradable" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Type, r.Grade, r.Icon, r.StackLimit, r.SellPrice, r.Tradable });
        ...
        public Dictionary<int, ItemRecord> RecordsById => _recordsById;
        private Dictionary<int, ItemRecord> _recordsById = new Dictionary<int, ItemRecord>();
        ...
        public ItemRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ItemRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out ItemRecord record))
                throw new TabbitException($"There is no record in table `Item` that corresponds to field `Id` value {key}");
        ...
        /// </remarks>
        public ItemRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Item.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Item.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Item.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.Type");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.ItemType)value;
                            } while (--n > 0);
                        }
                        break;
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "Item.StackLimit", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.StackLimit");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 7:
                        TcbTable.CheckColumn(column, "Item.SellPrice", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.SellPrice");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._sellPrice = value;
                            } while (--n > 0);
                        }
                        break;

                    case 8:
                        TcbTable.CheckColumn(column, "Item.Tradable", TcbTable.KindScalar, false, TcbTable.ElementBool);
                        cursor = new TcbColumnCursor(reader, column, count, "Item.Tradable");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsById = new Dictionary<int, ItemRecord>(count);
