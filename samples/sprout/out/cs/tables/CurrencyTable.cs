...
namespace Sprout.Tables
{
    ...
    public partial class CurrencyRecord
    {
        ...
        /// currency kind
        /// </summary>
        public global::Sprout.Tables.CurrencyType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.CurrencyType _type;
    ...
    public partial class CurrencyTable : IEnumerable<CurrencyRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "NameKey", "Icon", "Cap" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.NameKey, r.Icon, r.Cap });
        ...
        public Dictionary<int, CurrencyRecord> RecordsById => _recordsById;
        private Dictionary<int, CurrencyRecord> _recordsById = new Dictionary<int, CurrencyRecord>();
        ...
        public CurrencyRecord FindById(int key)
            => _recordsById.TryGetValue(key, out CurrencyRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out CurrencyRecord record))
                throw new TabbitException($"There is no record in table `Currency` that corresponds to field `Id` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, CurrencyRecord Row) Current
        ...
        /// </remarks>
        public CurrencyRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Currency.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Currency.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.CurrencyType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Currency.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Currency.Cap", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Currency.Cap");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            record._cap = cursor.NextI64();
                        }
                        break;
            ...
            var recordsById = new Dictionary<int, CurrencyRecord>(count);
