...
{
    [System.Serializable]
    public partial class UnlockRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// unlock kind
        /// </summary>
        public global::Sprout.Tables.UnlockType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.UnlockType _type;
        internal int _conditionId;
        internal string _messageKey = "";
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"MessageKey\":"); ToStringHelper.ToString(MessageKey, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class UnlockTable : IEnumerable<UnlockRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "ConditionId", "MessageKey" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.ConditionId, r.MessageKey });
        ...
        /// </remarks>
        public List<UnlockRecord> Records => _records;
        private List<UnlockRecord> _records = new List<UnlockRecord>();
        ...
        /// </remarks>
        public List<UnlockRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<UnlockRecord> IEnumerable<UnlockRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, UnlockRecord> RecordsById => _recordsById;
        private Dictionary<int, UnlockRecord> _recordsById = new Dictionary<int, UnlockRecord>();
        ...
        /// </remarks>
        public UnlockRecord FindById(int key)
            => _recordsById.TryGetValue(key, out UnlockRecord record) ? record : null;
        ...
        /// </remarks>
        public UnlockRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out UnlockRecord record))
                throw new TabbitException($"There is no record in table `Unlock` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<UnlockRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<UnlockRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, UnlockRecord Row) Current
        ...
        /// </remarks>
        public UnlockRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<UnlockRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new UnlockRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Unlock.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Unlock.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Unlock.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Unlock.Type");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.UnlockType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Unlock.ConditionId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Unlock.ConditionId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Unlock.MessageKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Unlock.MessageKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, UnlockRecord>(count);
