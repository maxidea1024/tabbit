...
{
    [System.Serializable]
    public partial class StageMonsterRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class StageMonsterTable : IEnumerable<StageMonsterRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<StageMonsterRecord> Records => _records;
        private List<StageMonsterRecord> _records = new List<StageMonsterRecord>();
        ...
        /// </remarks>
        public List<StageMonsterRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<StageMonsterRecord> IEnumerable<StageMonsterRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, StageMonsterRecord> RecordsById => _recordsById;
        private Dictionary<int, StageMonsterRecord> _recordsById = new Dictionary<int, StageMonsterRecord>();
        ...
        /// </remarks>
        public StageMonsterRecord FindById(int key)
            => _recordsById.TryGetValue(key, out StageMonsterRecord record) ? record : null;
        ...
        /// </remarks>
        public StageMonsterRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out StageMonsterRecord record))
        ...
        {
            private readonly List<StageMonsterRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<StageMonsterRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, StageMonsterRecord Row) Current
        ...
        /// </remarks>
        public StageMonsterRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<StageMonsterRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new StageMonsterRecord());
            ...
            var recordsById = new Dictionary<int, StageMonsterRecord>(count);
