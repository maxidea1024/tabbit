...
{
    [System.Serializable]
    public partial class ConsumableRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class ConsumableTable : IEnumerable<ConsumableRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "ItemId", "BuffId", "Cooldown" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.ItemId, r.BuffId, r.Cooldown });
        ...
        /// </remarks>
        public List<ConsumableRecord> Records => _records;
        private List<ConsumableRecord> _records = new List<ConsumableRecord>();
        ...
        /// </remarks>
        public List<ConsumableRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ConsumableRecord> IEnumerable<ConsumableRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, ConsumableRecord> RecordsById => _recordsById;
        private Dictionary<int, ConsumableRecord> _recordsById = new Dictionary<int, ConsumableRecord>();
        ...
        /// </remarks>
        public ConsumableRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ConsumableRecord record) ? record : null;
        ...
        /// </remarks>
        public ConsumableRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out ConsumableRecord record))
                throw new TabbitException($"There is no record in table `Consumable` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<ConsumableRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ConsumableRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ConsumableRecord Row) Current
        ...
        /// </remarks>
        public ConsumableRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ConsumableRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ConsumableRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Consumable.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Consumable.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Consumable.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Consumable.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Consumable.BuffId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Consumable.BuffId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Consumable.Cooldown", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Consumable.Cooldown");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, ConsumableRecord>(count);
