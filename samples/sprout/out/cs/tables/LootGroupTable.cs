...
{
    [System.Serializable]
    public partial class LootGroupRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Draws\":"); ToStringHelper.ToString(Draws, sb);
            sb.Append(",\"AllowDuplicate\":"); ToStringHelper.ToString(AllowDuplicate, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class LootGroupTable : IEnumerable<LootGroupRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Draws", "AllowDuplicate" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Draws, r.AllowDuplicate });
        ...
        /// </remarks>
        public List<LootGroupRecord> Records => _records;
        private List<LootGroupRecord> _records = new List<LootGroupRecord>();
        ...
        /// </remarks>
        public List<LootGroupRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<LootGroupRecord> IEnumerable<LootGroupRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, LootGroupRecord> RecordsById => _recordsById;
        private Dictionary<int, LootGroupRecord> _recordsById = new Dictionary<int, LootGroupRecord>();
        ...
        /// </remarks>
        public LootGroupRecord FindById(int key)
            => _recordsById.TryGetValue(key, out LootGroupRecord record) ? record : null;
        ...
        /// </remarks>
        public LootGroupRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out LootGroupRecord record))
                throw new TabbitException($"There is no record in table `LootGroup` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<LootGroupRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<LootGroupRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, LootGroupRecord Row) Current
        ...
        /// </remarks>
        public LootGroupRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<LootGroupRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new LootGroupRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "LootGroup.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "LootGroup.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "LootGroup.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "LootGroup.NameKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "LootGroup.Draws", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "LootGroup.Draws");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "LootGroup.AllowDuplicate", TcbTable.KindScalar, false, TcbTable.ElementBool);
                        cursor = new TcbColumnCursor(reader, column, count, "LootGroup.AllowDuplicate");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                            record._allowDuplicate = cursor.NextBool();
                        }
                        break;
            ...
            var recordsById = new Dictionary<int, LootGroupRecord>(count);
