...
{
    [System.Serializable]
    public partial class DailyQuestRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public int ResetHour => _resetHour;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"ResetHour\":"); ToStringHelper.ToString(ResetHour, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class DailyQuestTable : IEnumerable<DailyQuestRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "QuestId", "Points", "ResetHour" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.QuestId, r.Points, r.ResetHour });
        ...
        /// </remarks>
        public List<DailyQuestRecord> Records => _records;
        private List<DailyQuestRecord> _records = new List<DailyQuestRecord>();
        ...
        /// </remarks>
        public List<DailyQuestRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<DailyQuestRecord> IEnumerable<DailyQuestRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, DailyQuestRecord> RecordsById => _recordsById;
        private Dictionary<int, DailyQuestRecord> _recordsById = new Dictionary<int, DailyQuestRecord>();
        ...
        public DailyQuestRecord FindById(int key)
            => _recordsById.TryGetValue(key, out DailyQuestRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out DailyQuestRecord record))
                throw new TabbitException($"There is no record in table `DailyQuest` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<DailyQuestRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<DailyQuestRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, DailyQuestRecord Row) Current
        ...
        /// </remarks>
        public DailyQuestRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<DailyQuestRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new DailyQuestRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "DailyQuest.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "DailyQuest.QuestId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "DailyQuest.Points", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "DailyQuest.ResetHour", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, DailyQuestRecord>(count);
