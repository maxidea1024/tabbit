...
namespace Sprout.Tables
{
    ...
    public partial class ConditionRecord
    {
        ...
        /// condition kind
        /// </summary>
        public global::Sprout.Tables.ConditionType Type => _type;
        ...
        #region Storage
        internal int _id;
        internal global::Sprout.Tables.ConditionType _type;
        internal int _value;
    ...
    [System.Serializable]
    public partial class ConditionTable : IEnumerable<ConditionRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Type", "Value", "TargetId", "DescKey" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Type, r.Value, r.TargetId, r.DescKey });
        ...
        /// </remarks>
        public List<ConditionRecord> Records => _records;
        private List<ConditionRecord> _records = new List<ConditionRecord>();
        ...
        /// </remarks>
        public List<ConditionRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ConditionRecord> IEnumerable<ConditionRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, ConditionRecord> RecordsById => _recordsById;
        private Dictionary<int, ConditionRecord> _recordsById = new Dictionary<int, ConditionRecord>();
        ...
        public ConditionRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ConditionRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out ConditionRecord record))
                throw new TabbitException($"There is no record in table `Condition` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<ConditionRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ConditionRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ConditionRecord Row) Current
        ...
        /// </remarks>
        public ConditionRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ConditionRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Condition.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Condition.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Condition.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Condition.Type");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.ConditionType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "Condition.Value", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Condition.Value");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Condition.TargetId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Condition.TargetId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "Condition.DescKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Condition.DescKey");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, ConditionRecord>(count);
