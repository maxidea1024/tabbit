...
namespace Sprout.Tables
{
    ...
    public partial class StageRewardTable : IEnumerable<StageRewardRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "StageId", "Type", "ItemId", "Count", "Chance" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.StageId, r.Type, r.ItemId, r.Count, r.Chance });
        ...
        public Dictionary<int, StageRewardRecord> RecordsById => _recordsById;
        private Dictionary<int, StageRewardRecord> _recordsById = new Dictionary<int, StageRewardRecord>();
        ...
        public StageRewardRecord FindById(int key)
            => _recordsById.TryGetValue(key, out StageRewardRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out StageRewardRecord record))
                throw new TabbitException($"There is no record in table `StageReward` that corresponds to field `Id` value {key}");
        ...
        public struct EntryEnumerator
        {
            ...
            public (int Key, StageRewardRecord Row) Current
        ...
        /// </remarks>
        public StageRewardRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "StageReward.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StageReward.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "StageReward.StageId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "StageReward.Type", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StageReward.Type");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._type = (global::Sprout.Tables.RewardType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "StageReward.ItemId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StageReward.ItemId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "StageReward.Count", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StageReward.Count");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "StageReward.Chance", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StageReward.Chance");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, StageRewardRecord>(count);
