...
{
    [System.Serializable]
    public partial class StageWaveRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class StageWaveTable : IEnumerable<StageWaveRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<StageWaveRecord> Records => _records;
        private List<StageWaveRecord> _records = new List<StageWaveRecord>();
        ...
        /// </remarks>
        public List<StageWaveRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<StageWaveRecord> IEnumerable<StageWaveRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, StageWaveRecord> RecordsById => _recordsById;
        private Dictionary<int, StageWaveRecord> _recordsById = new Dictionary<int, StageWaveRecord>();
        ...
        /// </remarks>
        public StageWaveRecord FindById(int key)
            => _recordsById.TryGetValue(key, out StageWaveRecord record) ? record : null;
        ...
        /// </remarks>
        public StageWaveRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out StageWaveRecord record))
        ...
        {
            private readonly List<StageWaveRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<StageWaveRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, StageWaveRecord Row) Current
        ...
        /// </remarks>
        public StageWaveRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<StageWaveRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new StageWaveRecord());
            ...
            var recordsById = new Dictionary<int, StageWaveRecord>(count);
