...
{
    [System.Serializable]
    public partial class StatBaseRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class StatBaseTable : IEnumerable<StatBaseRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Role", "Stat", "BaseValue" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Role, r.Stat, r.BaseValue });
        ...
        /// </remarks>
        public List<StatBaseRecord> Records => _records;
        private List<StatBaseRecord> _records = new List<StatBaseRecord>();
        ...
        /// </remarks>
        public List<StatBaseRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<StatBaseRecord> IEnumerable<StatBaseRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, StatBaseRecord> RecordsById => _recordsById;
        private Dictionary<int, StatBaseRecord> _recordsById = new Dictionary<int, StatBaseRecord>();
        ...
        /// </remarks>
        public StatBaseRecord FindById(int key)
            => _recordsById.TryGetValue(key, out StatBaseRecord record) ? record : null;
        ...
        /// </remarks>
        public StatBaseRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out StatBaseRecord record))
                throw new TabbitException($"There is no record in table `StatBase` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<StatBaseRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<StatBaseRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, StatBaseRecord Row) Current
        ...
        /// </remarks>
        public StatBaseRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<StatBaseRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new StatBaseRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "StatBase.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StatBase.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "StatBase.Role", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StatBase.Role");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "StatBase.Stat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StatBase.Stat");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "StatBase.BaseValue", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "StatBase.BaseValue");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, StatBaseRecord>(count);
