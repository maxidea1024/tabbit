...
namespace Sprout.Tables
{
    ...
    public partial class WorldRecord
    {
        ...
        /// theme colour
        /// </summary>
        public string ThemeColour => _themeColour;
        #endregion

        #region Storage
        internal int _id;
        internal string _nameKey = "";
        internal string _map = "";
        internal string _themeColour = "";
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Map\":"); ToStringHelper.ToString(Map, sb);
            sb.Append(",\"ThemeColour\":"); ToStringHelper.ToString(ThemeColour, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class WorldTable : IEnumerable<WorldRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "NameKey", "Map", "ThemeColour" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.NameKey, r.Map, r.ThemeColour });
        ...
        /// </remarks>
        public List<WorldRecord> Records => _records;
        private List<WorldRecord> _records = new List<WorldRecord>();
        ...
        /// </remarks>
        public List<WorldRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<WorldRecord> IEnumerable<WorldRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, WorldRecord> RecordsById => _recordsById;
        private Dictionary<int, WorldRecord> _recordsById = new Dictionary<int, WorldRecord>();
        ...
        /// </remarks>
        public WorldRecord FindById(int key)
            => _recordsById.TryGetValue(key, out WorldRecord record) ? record : null;
        ...
        /// </remarks>
        public WorldRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out WorldRecord record))
                throw new TabbitException($"There is no record in table `World` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<WorldRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<WorldRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, WorldRecord Row) Current
        ...
        /// </remarks>
        public WorldRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<WorldRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "World.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "World.NameKey", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "World.Map", TcbTable.KindScalar, false, TcbTable.ElementString);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "World.ThemeColour", TcbTable.KindScalar, false, TcbTable.ElementString);
            ...
            var recordsById = new Dictionary<int, WorldRecord>(count);
