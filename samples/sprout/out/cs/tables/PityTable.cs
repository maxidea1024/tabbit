...
{
    [System.Serializable]
    public partial class PityRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// resets on hit
        /// </summary>
        public bool ResetOnHit => _resetOnHit;
        #endregion
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"ResetOnHit\":"); ToStringHelper.ToString(ResetOnHit, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class PityTable : IEnumerable<PityRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Threshold", "Grade", "ResetOnHit" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Threshold, r.Grade, r.ResetOnHit });
        ...
        /// </remarks>
        public List<PityRecord> Records => _records;
        private List<PityRecord> _records = new List<PityRecord>();
        ...
        /// </remarks>
        public List<PityRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<PityRecord> IEnumerable<PityRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, PityRecord> RecordsById => _recordsById;
        private Dictionary<int, PityRecord> _recordsById = new Dictionary<int, PityRecord>();
        ...
        /// </remarks>
        public PityRecord FindById(int key)
            => _recordsById.TryGetValue(key, out PityRecord record) ? record : null;
        ...
        /// </remarks>
        public PityRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out PityRecord record))
                throw new TabbitException($"There is no record in table `Pity` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<PityRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<PityRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, PityRecord Row) Current
        ...
        /// </remarks>
        public PityRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<PityRecord>(count);
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Pity.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Pity.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Pity.Threshold", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Pity.Threshold");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "Pity.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Pity.Grade");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "Pity.ResetOnHit", TcbTable.KindScalar, false, TcbTable.ElementBool);
                        cursor = new TcbColumnCursor(reader, column, count, "Pity.ResetOnHit");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
            ...
            var recordsById = new Dictionary<int, PityRecord>(count);
