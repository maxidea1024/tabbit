...
{
    [System.Serializable]
    public partial class QuestStepRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// step order
        /// </summary>
        public int StepOrder => _stepOrder;
        ...
        #region Storage
        internal int _id;
        internal int _questId;
        internal int _stepOrder;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"QuestId\":"); ToStringHelper.ToString(QuestId, sb);
            sb.Append(",\"StepOrder\":"); ToStringHelper.ToString(StepOrder, sb);
            sb.Append(",\"ConditionId\":"); ToStringHelper.ToString(ConditionId, sb);
            sb.Append(",\"TargetCount\":"); ToStringHelper.ToString(TargetCount, sb);
    ...
    [System.Serializable]
    public partial class QuestStepTable : IEnumerable<QuestStepRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "QuestId", "StepOrder", "ConditionId", "TargetCount", "DialogueId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.QuestId, r.StepOrder, r.ConditionId, r.TargetCount, r.DialogueId });
        ...
        /// </remarks>
        public List<QuestStepRecord> Records => _records;
        private List<QuestStepRecord> _records = new List<QuestStepRecord>();
        ...
        /// </remarks>
        public List<QuestStepRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<QuestStepRecord> IEnumerable<QuestStepRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, QuestStepRecord> RecordsById => _recordsById;
        private Dictionary<int, QuestStepRecord> _recordsById = new Dictionary<int, QuestStepRecord>();
        ...
        /// </remarks>
        public QuestStepRecord FindById(int key)
            => _recordsById.TryGetValue(key, out QuestStepRecord record) ? record : null;
        ...
        /// </remarks>
        public QuestStepRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out QuestStepRecord record))
                throw new TabbitException($"There is no record in table `QuestStep` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<QuestStepRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<QuestStepRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, QuestStepRecord Row) Current
        ...
        /// </remarks>
        public QuestStepRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<QuestStepRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new QuestStepRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "QuestStep.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "QuestStep.QuestId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._questId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "QuestStep.StepOrder", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._stepOrder = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "QuestStep.ConditionId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "QuestStep.TargetCount", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._targetCount = value;
                            } while (--n > 0);
                        }
                        break;

                    case 6:
                        TcbTable.CheckColumn(column, "QuestStep.DialogueId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, QuestStepRecord>(count);
