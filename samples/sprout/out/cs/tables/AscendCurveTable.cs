...
{
    [System.Serializable]
    public partial class AscendCurveRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"Scale\":"); ToStringHelper.ToString(Scale, sb);
            sb.Append("}");
            return sb.ToString();
        }
        #endregion
    ...
    [System.Serializable]
    public partial class AscendCurveTable : IEnumerable<AscendCurveRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Grade", "Step", "Scale" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Grade, r.Step, r.Scale });
        ...
        /// </remarks>
        public List<AscendCurveRecord> Records => _records;
        private List<AscendCurveRecord> _records = new List<AscendCurveRecord>();
        ...
        /// </remarks>
        public List<AscendCurveRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<AscendCurveRecord> IEnumerable<AscendCurveRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, AscendCurveRecord> RecordsById => _recordsById;
        private Dictionary<int, AscendCurveRecord> _recordsById = new Dictionary<int, AscendCurveRecord>();
        ...
        /// </remarks>
        public AscendCurveRecord FindById(int key)
            => _recordsById.TryGetValue(key, out AscendCurveRecord record) ? record : null;
        ...
        /// </remarks>
        public AscendCurveRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out AscendCurveRecord record))
                throw new TabbitException($"There is no record in table `AscendCurve` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<AscendCurveRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<AscendCurveRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, AscendCurveRecord Row) Current
        ...
        /// </remarks>
        public AscendCurveRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<AscendCurveRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new AscendCurveRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "AscendCurve.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "AscendCurve.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "AscendCurve.Step", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "AscendCurve.Scale", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
            ...
            var recordsById = new Dictionary<int, AscendCurveRecord>(count);
