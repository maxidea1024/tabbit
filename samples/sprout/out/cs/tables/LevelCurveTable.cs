...
namespace Sprout.Tables
{
    ...
    public partial class LevelCurveTable : IEnumerable<LevelCurveRecord>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "TierName", "CurveStat", "Tick", "BaseValue", "StepValue", "EndValue", "CapValue", "Revision" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.TierName, r.CurveStat, r.Tick, r.BaseValue, r.StepValue, r.EndValue, r.CapValue, r.Revision });
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "LevelCurve.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "LevelCurve.TierName", TcbTable.KindScalar, false, TcbTable.ElementString);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._tierName = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "LevelCurve.CurveStat", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._curveStat = (global::Sprout.Tables.StatType)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "LevelCurve.Tick", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "LevelCurve.BaseValue", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "LevelCurve.StepValue", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._stepValue = value;
                            } while (--n > 0);
                        }
                        break;

                    case 7:
                        TcbTable.CheckColumn(column, "LevelCurve.EndValue", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 8:
                        TcbTable.CheckColumn(column, "LevelCurve.CapValue", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 9:
                        TcbTable.CheckColumn(column, "LevelCurve.Revision", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
