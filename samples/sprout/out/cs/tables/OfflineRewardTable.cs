...
{
    [System.Serializable]
    public partial class OfflineRewardRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// </summary>
        public long GoldPerHour => _goldPerHour;

        /// <summary>
        /// experience per hour
        /// </summary>
        public long ExpPerHour => _expPerHour;
        ...
        internal long _goldPerHour;
        internal long _expPerHour;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"AccountLevel\":"); ToStringHelper.ToString(AccountLevel, sb);
            sb.Append(",\"GoldPerHour\":"); ToStringHelper.ToString(GoldPerHour, sb);
            sb.Append(",\"ExpPerHour\":"); ToStringHelper.ToString(ExpPerHour, sb);
    ...
    [System.Serializable]
    public partial class OfflineRewardTable : IEnumerable<OfflineRewardRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "AccountLevel", "GoldPerHour", "ExpPerHour", "LootGroupId" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.AccountLevel, r.GoldPerHour, r.ExpPerHour, r.LootGroupId });
        ...
        /// </remarks>
        public List<OfflineRewardRecord> Records => _records;
        private List<OfflineRewardRecord> _records = new List<OfflineRewardRecord>();
        ...
        /// </remarks>
        public List<OfflineRewardRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<OfflineRewardRecord> IEnumerable<OfflineRewardRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, OfflineRewardRecord> RecordsById => _recordsById;
        private Dictionary<int, OfflineRewardRecord> _recordsById = new Dictionary<int, OfflineRewardRecord>();
        ...
        /// </remarks>
        public OfflineRewardRecord FindById(int key)
            => _recordsById.TryGetValue(key, out OfflineRewardRecord record) ? record : null;
        ...
        /// </remarks>
        public OfflineRewardRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out OfflineRewardRecord record))
                throw new TabbitException($"There is no record in table `OfflineReward` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<OfflineRewardRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<OfflineRewardRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, OfflineRewardRecord Row) Current
        ...
        /// </remarks>
        public OfflineRewardRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<OfflineRewardRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new OfflineRewardRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "OfflineReward.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfflineReward.Id");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "OfflineReward.AccountLevel", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfflineReward.AccountLevel");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._accountLevel = value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "OfflineReward.GoldPerHour", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfflineReward.GoldPerHour");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 4:
                        TcbTable.CheckColumn(column, "OfflineReward.ExpPerHour", TcbTable.KindScalar, false, TcbTable.ElementI64, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfflineReward.ExpPerHour");
                        for (int i = 0; i < count; i++)
                        {
                            var record = records[i];
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "OfflineReward.LootGroupId", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "OfflineReward.LootGroupId");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            var recordsById = new Dictionary<int, OfflineRewardRecord>(count);
