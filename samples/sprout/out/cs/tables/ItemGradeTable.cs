...
{
    [System.Serializable]
    public partial class ItemGradeRecord
    {
        #region Values
        /// <summary>
        /// primary index
    ...
    [System.Serializable]
    public partial class ItemGradeTable : IEnumerable<ItemGradeRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        ...
        /// </remarks>
        public List<ItemGradeRecord> Records => _records;
        private List<ItemGradeRecord> _records = new List<ItemGradeRecord>();
        ...
        /// </remarks>
        public List<ItemGradeRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<ItemGradeRecord> IEnumerable<ItemGradeRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, ItemGradeRecord> RecordsById => _recordsById;
        private Dictionary<int, ItemGradeRecord> _recordsById = new Dictionary<int, ItemGradeRecord>();
        ...
        /// </remarks>
        public ItemGradeRecord FindById(int key)
            => _recordsById.TryGetValue(key, out ItemGradeRecord record) ? record : null;
        ...
        /// </remarks>
        public ItemGradeRecord GetByIdOrThrow(int key)
        {
            if (!_recordsById.TryGetValue(key, out ItemGradeRecord record))
        ...
        {
            private readonly List<ItemGradeRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<ItemGradeRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, ItemGradeRecord Row) Current
        ...
        /// </remarks>
        public ItemGradeRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<ItemGradeRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new ItemGradeRecord());
            ...
            var recordsById = new Dictionary<int, ItemGradeRecord>(count);
