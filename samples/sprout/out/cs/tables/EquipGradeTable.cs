...
{
    [System.Serializable]
    public partial class EquipGradeRecord
    {
        #region Values
        /// <summary>
        /// primary index
        ...
        /// option slots
        /// </summary>
        public int OptionSlots => _optionSlots;
        ...
        public override string ToString()
        {
            ...
            sb.Append(",\"OptionSlots\":"); ToStringHelper.ToString(OptionSlots, sb);
    ...
    [System.Serializable]
    public partial class EquipGradeTable : IEnumerable<EquipGradeRecord>
    {
        /// <summary>
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Id", "Grade", "OptionSlots", "Frame" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Id, r.Grade, r.OptionSlots, r.Frame });
        ...
        /// </remarks>
        public List<EquipGradeRecord> Records => _records;
        private List<EquipGradeRecord> _records = new List<EquipGradeRecord>();
        ...
        /// </remarks>
        public List<EquipGradeRecord>.Enumerator GetEnumerator() => _records.GetEnumerator();

        IEnumerator<EquipGradeRecord> IEnumerable<EquipGradeRecord>.GetEnumerator() => _records.GetEnumerator();

        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            => _records.GetEnumerator();

        #region Indexing by 'Id'
        public Dictionary<int, EquipGradeRecord> RecordsById => _recordsById;
        private Dictionary<int, EquipGradeRecord> _recordsById = new Dictionary<int, EquipGradeRecord>();
        ...
        public EquipGradeRecord FindById(int key)
            => _recordsById.TryGetValue(key, out EquipGradeRecord record) ? record : null;
        ...
        {
            if (!_recordsById.TryGetValue(key, out EquipGradeRecord record))
                throw new TabbitException($"There is no record in table `EquipGrade` that corresponds to field `Id` value {key}");
        ...
        {
            private readonly List<EquipGradeRecord> _rows;
            private int _at;

            internal EntryEnumerator(List<EquipGradeRecord> rows)
            {
                _rows = rows;
                _at = -1;
            }
            ...
            public (int Key, EquipGradeRecord Row) Current
        ...
        /// </remarks>
        public EquipGradeRecord this[int key] => GetByIdOrThrow(key);
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            var records = new List<EquipGradeRecord>(count);

            for (int i = 0; i < count; i++)
                records.Add(new EquipGradeRecord());
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "EquipGrade.Id", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "EquipGrade.Grade", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                    ...
                    case 3:
                        TcbTable.CheckColumn(column, "EquipGrade.OptionSlots", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        ...
                        for (int i = 0; i < count; )
                        {
                            ...
                            {
                                var record = records[i++];
                                record._optionSlots = value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "EquipGrade.Frame", TcbTable.KindScalar, false, TcbTable.ElementString);
            ...
            var recordsById = new Dictionary<int, EquipGradeRecord>(count);
