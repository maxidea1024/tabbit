...
module Sprout
  ...
  class MailRewardRecord
    attr_accessor :id, :title_key, :body_key, :reward_id, :expiry_days
  ...
  class MailRewardTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { MailRewardRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'MailReward.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'MailReward.TitleKey')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'MailReward.BodyKey')
          at = 0
          while at < count
            n, value = cursor.next_same_string(count - at)
            (at...(at + n)).each do |i|
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'MailReward.RewardId')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'MailReward.ExpiryDays')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
