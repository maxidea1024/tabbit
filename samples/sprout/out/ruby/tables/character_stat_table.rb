...
module Sprout
  ...
  class CharacterStatTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { CharacterStatRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.CharacterId')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.Level')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.RequiredExp')
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.Attack')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 6
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.Defense')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 7
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'CharacterStat.Health')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
