...
module Sprout
  ...
  class StageMonsterTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { StageMonsterRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.NameKey')
          at = 0
          while at < count
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Model')
          at = 0
          while at < count
            n, value = cursor.next_same_string(count - at)
            (at...(at + n)).each do |i|
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Element')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Attack')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 6
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Defense')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 7
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.Health')
        ...
        when 8
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'StageMonster.SkillIds')
          records.each do |record|
