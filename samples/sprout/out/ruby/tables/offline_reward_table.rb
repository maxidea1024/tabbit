...
module Sprout
  ...
  class OfflineRewardTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { OfflineRewardRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'OfflineReward.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'OfflineReward.AccountLevel')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'OfflineReward.GoldPerHour')
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'OfflineReward.ExpPerHour')
          records.each do |record|
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'OfflineReward.LootGroupId')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
