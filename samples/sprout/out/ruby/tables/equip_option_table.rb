...
module Sprout
  ...
  class EquipOptionRecord
    attr_accessor :id, :stat, :min_roll, :max_roll, :weight
  ...
  class EquipOptionTable
    ...
    def read(filename)
      ...
      records = Array.new(count) { EquipOptionRecord.new }
      ...
      columns.each do |column|
        ...
        when 1
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'EquipOption.Id')
          at = 0
          while at < count
        ...
        when 2
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'EquipOption.Stat')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 3
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'EquipOption.MinRoll')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 4
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'EquipOption.MaxRoll')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
        ...
        when 5
          ...
          cursor = Tabbit::ColumnCursor.new(reader, column, count, 'EquipOption.Weight')
          at = 0
          while at < count
            n, value = cursor.next_same_i32(count - at)
            (at...(at + n)).each do |i|
