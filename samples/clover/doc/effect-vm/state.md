...
같은 리플레이를 웹과 유니티에 먹여 마지막 상태의 해시를 비교합니다. 해시가 다르면 어느
...
|유니티|`Application.persistentDataPath` 의 JSON|

두 형식이 같은 스키마입니다. 그래서 웹에서 만든 세이브를 유니티가 읽을 수 있고, **그것도
대조의 하나입니다.**
