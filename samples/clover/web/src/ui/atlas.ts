...
export const ATLAS: Record<string, Slice> = {
  ...
  'button-sm': { w: 48, h: 36, pad: 14, left: 10, right: 10, top: 0, bottom: 0 },
  'button': { w: 56, h: 48, pad: 14, left: 12, right: 12, top: 0, bottom: 0 },
  'button-lg': { w: 64, h: 60, pad: 14, left: 14, right: 14, top: 0, bottom: 0 },
  'button-xl': { w: 72, h: 72, pad: 14, left: 16, right: 16, top: 0, bottom: 0 },
