 ...
 */
// 1280 화면에서 약 23%입니다. 블라인드의 규칙 문장과 2×2 자원 표가 함께 들어가는
// 세로 계기판이므로 264에서는 본문 폭이 먼저 무너집니다. 288은 12픽셀 글꼴 격자에
// 맞으면서도 오른쪽 판에 940픽셀을 남깁니다.
export const SIDE_PANEL = { x: 16, width: 288, gap: 14 } as const
