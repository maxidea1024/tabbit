...
// 3. 창을 닫았다 다시 열어도(새로 고침) 그 판이 남아 있는가
// 4. 버리면 그 탭이 없어지는가
//
...
import {
  clickPrimary, clickSpot, closeGuide, confirmYes, pass, peek, pickCards, pressPlay,
  pressRunPanel, pressTitle, settle, skipLogin, startNewRun,
} from './harness'
