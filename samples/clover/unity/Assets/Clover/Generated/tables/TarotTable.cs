...
namespace Clover.Data
{
    ...
    public partial class TarotTable : IEnumerable<TarotRecord>
    {
        ...
        /// <summary>Each row with the `TarotId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `TarotId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByTarotIdOrThrow` under the spelling the language uses for a
        ...
        /// `TarotId` is 0, not the first row - the rows in order are
