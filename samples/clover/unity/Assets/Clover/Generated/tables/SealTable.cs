...
namespace Clover.Data
{
    ...
    public partial class SealTable : IEnumerable<SealTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Seal", "Display" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Seal, r.Display });
        ...
        /// <summary>Whether the table holds a row with this `Seal`.</summary>
        public bool ContainsSeal(global::Clover.Data.SealKind key) => _recordsBySeal.ContainsKey(key);
        #endregion // Indexing by `Seal`

        /// <summary>Each row with the `Seal` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Seal` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetBySealOrThrow` under the spelling the language uses for a
        ...
        /// `Seal` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Seal.Seal", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Seal.Seal");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Seal.Display", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Seal.Display");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
