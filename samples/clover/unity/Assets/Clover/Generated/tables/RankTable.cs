...
namespace Clover.Data
{
    ...
    public partial class RankTable : IEnumerable<RankTable.Record>
    {
        ...
        /// <summary>Each row with the `Rank` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Rank` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByRankOrThrow` under the spelling the language uses for a
        ...
        /// `Rank` is 0, not the first row - the rows in order are
