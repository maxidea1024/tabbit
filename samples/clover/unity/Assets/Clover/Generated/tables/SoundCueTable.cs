...
namespace Clover.Data
{
    ...
    public partial class SoundCueTable : IEnumerable<SoundCueRecord>
    {
        ...
        /// <summary>Each row with the `CueId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `CueId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByCueIdOrThrow` under the spelling the language uses for a
        ...
        /// `CueId` is 0, not the first row - the rows in order are
