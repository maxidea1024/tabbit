...
namespace Clover.Data
{
    ...
    public partial class BoosterPackTable : IEnumerable<BoosterPackTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "PackId", "Kind", "Size", "Cost", "Cards", "Picks" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.PackId, r.Kind, r.Size, r.Cost, r.Cards, r.Picks });
        ...
        /// <summary>Whether the table holds a row with this `PackId`.</summary>
        public bool ContainsPackId(string key) => _recordsByPackId.ContainsKey(key);
        #endregion // Indexing by `PackId`

        /// <summary>Each row with the `PackId` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `PackId` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByPackIdOrThrow` under the spelling the language uses for a
        ...
        /// `PackId` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "BoosterPack.PackId", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.PackId");
                        for (int i = 0; i < count; )
                        {
                            ...
                            do
                            {
                                ...
                                record._packId = value;
                            } while (--n > 0);
                        }
                        break;

                    case 2:
                        TcbTable.CheckColumn(column, "BoosterPack.Kind", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.Kind");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._kind = (global::Clover.Data.PackKind)value;
                            } while (--n > 0);
                        }
                        break;

                    case 3:
                        TcbTable.CheckColumn(column, "BoosterPack.Size", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.Size");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                            ...
                            {
                                var record = records[i++];
                                record._size = (global::Clover.Data.PackSize)value;
                            } while (--n > 0);
                        }
                        break;

                    case 4:
                        TcbTable.CheckColumn(column, "BoosterPack.Cost", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.Cost");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 5:
                        TcbTable.CheckColumn(column, "BoosterPack.Cards", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.Cards");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
                    ...
                    case 6:
                        TcbTable.CheckColumn(column, "BoosterPack.Picks", TcbTable.KindScalar, false, TcbTable.ElementI32, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "BoosterPack.Picks");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            _records = records;
            _recordsByPackId = recordsByPackId;
