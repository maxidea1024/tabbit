...
namespace Clover.Data
{
    ...
    public partial class EnhancementTable : IEnumerable<EnhancementTable.Record>
    {
        ...
        /// Field names.
        /// </summary>
        public static readonly string[] FieldNames = { "Enhancement", "Display" };
        ...
        public List<object[]> BuildObjectValueMap()
        {
            ...
            foreach (var r in _records)
                result.Add(new object[] { r.Enhancement, r.Display });
        ...
        /// <summary>Whether the table holds a row with this `Enhancement`.</summary>
        public bool ContainsEnhancement(global::Clover.Data.EnhancementKind key) => _recordsByEnhancement.ContainsKey(key);
        #endregion // Indexing by `Enhancement`

        /// <summary>Each row with the `Enhancement` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Enhancement` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByEnhancementOrThrow` under the spelling the language uses for a
        ...
        /// `Enhancement` is 0, not the first row - the rows in order are
        ...
        public Task ReadAsync(TcbReader reader)
        {
            ...
            foreach (var column in columns)
            {
                ...
                {
                    case 1:
                        TcbTable.CheckColumn(column, "Enhancement.Enhancement", TcbTable.KindScalar, false, TcbTable.ElementVarint);
                        cursor = new TcbColumnCursor(reader, column, count, "Enhancement.Enhancement");
                        for (int i = 0; i < count; )
                        {
                    ...
                    case 2:
                        TcbTable.CheckColumn(column, "Enhancement.Display", TcbTable.KindScalar, false, TcbTable.ElementString);
                        cursor = new TcbColumnCursor(reader, column, count, "Enhancement.Display");
                        for (int i = 0; i < count; )
                        {
                            // One call per run of equal values, not one per row - over a
                            // run-length encoded column this is most of the decode.
            ...
            _records = records;
            _recordsByEnhancement = recordsByEnhancement;
