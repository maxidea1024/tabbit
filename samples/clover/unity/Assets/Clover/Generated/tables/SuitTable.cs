...
namespace Clover.Data
{
    ...
    public partial class SuitTable : IEnumerable<SuitTable.Record>
    {
        ...
        /// <summary>Each row with the `Suit` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Suit` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetBySuitOrThrow` under the spelling the language uses for a
        ...
        /// `Suit` is 0, not the first row - the rows in order are
