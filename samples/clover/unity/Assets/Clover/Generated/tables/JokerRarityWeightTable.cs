...
namespace Clover.Data
{
    ...
    public partial class JokerRarityWeightTable : IEnumerable<JokerRarityWeightRecord>
    {
        ...
        /// <summary>Each row with the `Rarity` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Rarity` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByRarityOrThrow` under the spelling the language uses for a
        ...
        /// `Rarity` is 0, not the first row - the rows in order are
