...
namespace Clover.Data
{
    ...
    public partial class AnteTable : IEnumerable<AnteTable.Record>
    {
        ...
        /// <summary>Each row with the `Ante` it is keyed by.</summary>
        /// <remarks>
        ...
        /// `Ante` here, something else in the next table.
        ///
        ...
        /// </summary>
        /// <remarks>
        /// `GetByAnteOrThrow` under the spelling the language uses for a
        ...
        /// `Ante` is 0, not the first row - the rows in order are
