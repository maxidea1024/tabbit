...
[워크북 읽기](streaming-workbook-reader.md)의 실측이 62 MiB 워크북 하나에서 live 4.2 GB ·
...
|로케일 변종|`Option("Locale")`로 실행을 나눠 돕니다|`_BC` 파일의 모델 표현은 [테이블의 행 벌](table-row-sets.md)로 정해졌습니다. 컨텍스트가 그 축을 직접 내는 것은 아직입니다|
