...
|**실사용이 없습니다**|출시 전 소규모 프로젝트의 상수 세트는 **0개**입니다. 상수 세트를 선언하는 것은 픽스처 워크북 3개(`core` · `conformance` · `conformance-skew`)뿐이고, 그중 둘은 **「상수 파일이 컴파일되는지」를 확인하려고 만든 것**입니다([conformance README](../../test/fixtures/tools/conformance/README.md))|
