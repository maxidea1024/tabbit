...
|멀티 로우 그룹 — `rewards[].itemId`|위 두 규칙과 같습니다. 타입 칸에 적는 것은 **원소의 타입**입니다 — 배열임은 이름의 `[]`에 이미 적혀 있으므로 타입에 다시 적지 않습니다|
...
`character[0]["Id"]`([NamedRangeColumnPath](../../../src/Cooking/Layouts/NamedRangeColumnPath.cs))와 기존
