...
모든 언어가 내는 원소별 답은 [원소가 없을 수 있는 배열](../types/nullable-array-elements.md)에 있습니다.
...
([그 셋](../types/nullable-array-elements.md#1-문제--원소의-없음을-적을-자리)).
...
[그 이유](../types/nullable-array-elements.md#연번-컬럼-그룹--컬럼의-는-원소의-답). 4절의 컬럼이 그
경우입니다.
...
일은 그 차이가 **어느 자리의 없음인지**를 나타내는 것입니다: 로우 3은 원소 0이 없고, 그것이
...
|무엇|왜|
|--|--|
|레코드 멤버의 원소별 presence|레코드 배열이 표현하는 없음은 [원소 개수](../types/variable-length-record-arrays.md)이고, 그것은 비트맵이 아니라 길이입니다|
