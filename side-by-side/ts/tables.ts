...
export class Tables {
  ...
  public async readAll(basePath: string, fileExtension: string = '.json'): Promise<void> {
    ...
    await package_.read(path.join(basePath, `Package${fileExtension}`))
  ...
  public readAllSync(basePath: string, fileExtension: string = '.json'): void {
    ...
    const package_ = new PackageTable()
    package_.readSync(path.join(basePath, `Package${fileExtension}`))
  ...
  public readAllBinarySync(basePath: string, fileExtension: string = '.tcb'): void {
    ...
    const package_ = new PackageTable()
    package_.readBinarySync(path.join(basePath, `Package${fileExtension}`))
