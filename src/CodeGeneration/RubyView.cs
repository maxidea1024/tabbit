...
internal sealed class RubyTableView
{
    ...
    /// <summary>
    /// The columns of a data file, which is what the read's `case` dispatches on.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public required IReadOnlyList<RubyColumnView> Columns { get; set; }
}
...
internal sealed class RubyFieldView
{
    ...
    /// <summary>
    /// That class's name, which carries the table's - every generated class sits in one
    /// module. Empty for an ordinary field.
    /// </summary>
    public required string RecordTypeName { get; set; }

    /// <summary>That class's `attr_accessor` list, already symbols. Empty for an ordinary field.</summary>
    public required string RecordAccessorNames { get; set; }
    ...
    /// </summary>
    public IReadOnlyList<RubyRecordTypeView> RecordTypes { get; set; }
        = System.Array.Empty<RubyRecordTypeView>();

    /// <summary>The attributes of that class. Empty for an ordinary field.</summary>
    public required IReadOnlyList<RubyRecordMemberView> Members { get; set; }
    ...
    /// <summary>The attribute the presence flag lands in, without its `@`.</summary>
...
internal sealed class RubyRecordMemberView
{
    public required IReadOnlyList<string> Comment { get; set; }
...
///
/// Innermost first, and here that is required rather than tidy - a constructor naming the level
...
internal sealed class RubyRecordTypeView
{
    ...
    /// <summary>Its `attr_accessor` symbols.</summary>
    public required string AccessorNames { get; set; }
}

/// <summary>
/// One column of a data file, as the read's `case` sees it.
/// </summary>
internal sealed class RubyColumnView
{
    ...
    /// key per element. spec/references/references-in-records.md.
    /// </remarks>
    ...
    /// builds the array when the element count comes from the row.
    /// </summary>
...
/// </remarks>
internal sealed class RubyRecordReferenceView
{
