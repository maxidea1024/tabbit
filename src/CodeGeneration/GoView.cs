...
internal sealed class GoFieldView
{
    ...
    /// <summary>
    /// How the builder reaches the entry it reads from: the row's field, or the element it was
    /// handed.
    /// </summary>
    /// <remarks>
    /// One name for both shapes, so the body of the switch is written once. The array's builder
    /// is a function taking an element, and the scalar's is a method on the row.
    /// </remarks>
