    ...
    where TRecipe : class, IOutputRecipe
{
    ...
    private static string Marked(string contents, string path)
    {
        ...
        // Two readers of this header are not people, and each wants the claim its own way:
        //
        //   Go     - `staticcheck` and `golangci-lint` skip a file whose header matches
        //            `^// Code generated .* DO NOT EDIT\.$` before the package clause.
        //   C#     - Roslyn analysers and formatters skip a file opening with an
        //            `<auto-generated>` block, which is what every C# file this tool emits
        //            already carries. A runtime file without it would be the one generated
        //            file a consumer's analysers complained about.
        //
        // The sweep finds its phrase inside both, because that match ignores case.
        string[] claim = extension switch
        {
            ".go" => [GeneratedFileMarker.GoBanner],
            ".cs" => ["<auto-generated>", GeneratedFileMarker.Banner, "</auto-generated>"],
            _ => [GeneratedFileMarker.Banner],
        };
