    ...
    where TRecipe : class, IOutputRecipe
{
    ...
    private static string Marked(string contents, string path)
    {
        ...
        // One reader of this header is not a person: Roslyn analysers and formatters skip
        // a file opening with an `<auto-generated>` block, which is what every C# file this
        // tool emits already carries. A runtime file without it would be the one generated
        // file a consumer's analysers complained about. What goes inside the block is the
        // same sentence every other target writes.
        string[] claim = extension == ".cs"
            ? ["<auto-generated>", GeneratedFileMarker.Banner, "</auto-generated>"]
